...
const questions = [
  'How do I get started with Biobase?',
  'How do I run Biobase locally?',
...
function PromptInput({
  ...
  const setQuery = useSetQuery()
  // If the user has already typed something when they select Biobase AI, we want to
  ...
  return (
    <CommandInput
      ...
      placeholder={
        isLoading || isResponding ? 'Waiting on an answer...' : 'Ask Biobase AI a question...'
      }
      value={inputValue}
  ...
  return (
    <div className="p-6 flex flex-col items-center gap-2 mt-4">
      ...
      <p className="text-sm text-foreground text-center">
        Sorry, looks like Biobase AI is having a hard time!
      </p>
