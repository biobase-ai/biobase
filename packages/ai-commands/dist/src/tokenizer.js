 ...
 */
export function getChatRequestTokenCount(messages, model = 'gpt-4o-mini-2024-07-18') {
 ...
 */
export function getMessageTokenCount(message, model = 'gpt-4o-mini-2024-07-18') {
    ...
    switch (model) {
        ...
        case 'gpt-4-0314':
            ...
            break;
        default:
            throw new Error(`Unknown model '${model}'. See https://github.com/openai/openai-python/blob/main/chatml.md for information on how messages are converted to tokens.`);
    }
 ...
 */
export function getMaxTokenCount(model) {
    switch (model) {
        case 'gpt-3.5-turbo':
