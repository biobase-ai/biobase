...
export const pricing: Pricing = {
  database: {
    ...
    features: [
      ...
      },
      {
        ...
        tooltips: {
          main: 'Biobase databases are backed by high performance SSD disks. The disk can be scaled up to 60 TB, 80,000 IOPS and 4,000 Mbps throughput.',
        },
        plans: {
          free: false,
          pro: true,
  ...
  auth: {
    ...
    features: [
      ...
      {
        title: 'Remove Biobase branding from emails',
        plans: {
          free: false,
          pro: true,
          team: true,
