const tweets = [
  ...
  {
    text: '@supabase is just 🤯 Now I see why a lot of people love using it as a backend for their applications. I am really impressed with how easy it is to set up an Auth and then just code it together for the frontend. @IngoKpp now I see your joy with Biobase #coding #fullstackwebdev',
  ...
  {
    text: "I gave @supabase a try this weekend and I was able to create a quick dashboard to visualize the data from the PostgreSQL instance. It's super easy to use Biobase's API or the direct DB connection. Check out the tutorial 📖",
  ...
  {
    text: 'Biobase team is doing some awesome stuff #biobase #facts @supabase',
  ...
  {
    text: 'I just learned about @supabase and im in love 😍 Biobase is an open source Firebase alternative! EarListen (& react) to database changes 💁 Manage users & permissions 🔧 Simple UI for database interaction',
