...
export interface paths {
  '/partners/flyio/callback': {
    /** Redirects to Biobase dashboard after completing Fly sso */
  ...
  '/partners/vercel/callback': {
    /** Redirects to Biobase dashboard after completing Vercel sso flow */
  ...
  '/platform/integrations/github/connections': {
    ...
    /** Connects a GitHub project to a biobase project */
  ...
  '/platform/integrations/github/connections/{connection_id}': {
    ...
    /** Updates a GitHub connection for a biobase project */
  ...
  '/platform/integrations/vercel/connections': {
    /** Connects a Vercel project to a biobase project */
  ...
  '/platform/integrations/vercel/connections/{connection_id}': {
    ...
    /** Updates a Vercel connection for a biobase project */
  ...
  '/platform/integrations/vercel/connections/{connection_id}/sync-envs': {
    /** Syncs biobase project envs with given connection id */
...
export interface components {
  schemas: {
    ...
    CreateProjectBody: {
      ...
      custom_biobase_internal_requests?: components['schemas']['CustomBiobaseInternalRequests']
    ...
    OrganizationExtensionStatus: {
      /** @description Biobase project instance compute size */
      compute: string
      /** @description Unique ID representing the fly extension */
      id: string
      /**
       * @description Biobase project status
      ...
      status:
        ...
        | 'RESIZING'
      /**
       * @description Biobase organization id
    ...
    ResourceProvisioningResponse: {
      /** @description Biobase envs config */
      ...
      fly_app_name: string
      /**
       * @description Biobase project id
    ...
    ResourceWithServicesStatusResponse: {
      ...
      /** @description Unique ID representing the fly extension */
      id: string
      /** @description Biobase project services health status */
    ...
    SystemCreateProjectBody: {
      anon_key: string
      api_key_biobase: string
      /** @description Database password */
      db_pass: string
      db_pass_biobase: string
      jwt_secret: string
    ...
    V1CreateProjectBodyDto: {
       ...
       * @example https://github.com/biobase-ai/biobase/tree/master/examples/slack-clone/nextjs-slack-clone
       */
      template_url?: string
    }
    V1DatabaseResponse: {
...
export interface operations {
  ...
  VercelConnectionsController_syncVercelConnectionEnvironments: {
    ...
    responses: {
      ...
      /** @description Failed to sync biobase project envs with given connection id */
      500: {
        content: never
      }
    }
