...
const defaultEnv = {
  ...
  // BIOBASE_REST_URL: 'http://127.0.0.1:54321/rest/v1/',
  // NEXT_PUBLIC_ENABLE_LOGS: 'false',
  // NEXT_PUBLIC_IS_PLATFORM: 'false',
  BIOBASE_ANON_KEY: '$ANON_KEY',
  BIOBASE_SERVICE_KEY: '$SERVICE_ROLE_KEY',
  BIOBASE_URL: '$API_URL',
  STUDIO_PG_META_URL: '$API_URL/pg',
  BIOBASE_PUBLIC_URL: '$API_URL',
  SENTRY_IGNORE_API_RESOLUTION_ERROR: '1',
  LOGFLARE_URL: 'http://localhost:54329',
  LOGFLARE_API_KEY: 'api-key',
  NEXT_PUBLIC_SITE_URL: 'http://localhost:3000',
  NEXT_PUBLIC_GOTRUE_URL: '$BIOBASE_PUBLIC_URL/auth/v1',
