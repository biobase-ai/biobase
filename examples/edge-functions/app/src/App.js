...
function App() {
  ...
  const invokeFunction = async () => {
    ...
    const { data, error } = await biobase.functions.invoke(supaFunction, {
  ...
  return (
    <div className="p-2">
      <h2 className="mb-2 text-4xl">Biobase Egde Functions Test Client</h2>
