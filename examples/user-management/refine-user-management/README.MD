# Biobase refine User Management

This repo is a quick sample of how you can get started building apps using [refine](https://github.com/refinedev/refine) and Biobase: users can sign up with a magic link and then update their account with public profile information, including a profile image.
...
Sign up to Biobase - [https://app.biobase.studio](https://app.biobase.studio) and create a new project. Wait for your database to start.
