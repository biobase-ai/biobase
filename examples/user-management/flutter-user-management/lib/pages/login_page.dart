...
import 'package:biobase_quickstart/main.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _signIn() async {
    try {
      ...
      await biobase.auth.signInWithOtp(
        ...
        emailRedirectTo:
            kIsWeb ? null : 'io.biobase.flutterquickstart://login-callback/',
      );
      if (mounted) {
  ...
  @override
  void initState() {
    _authStateSubscription = biobase.auth.onAuthStateChange.listen(
      (data) {
