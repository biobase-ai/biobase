...
const externalSite = 'https://biobase-ai.github.io/wrappers'
...
const getContent = async (params: Params) => {
  ...
  if (!federatedPage) {
    isExternal = false
    editLink = `biobase/biobase/apps/docs/content/guides/database/extensions/wrappers${params.slug?.length ? `/${params.slug.join('/')}` : ''}.mdx`
