...
const TerraformReferencePage = async () => {
  ...
  const isFallback = !schema.provider_schemas['registry.terraform.iobiobase-ai/biobase'].resource_schemas
      ...
      {isFallback && (
        <div className="bg-amber-100 dark:bg-amber-900 rounded p-4 mb-6">
          <p className="text-amber-900 dark:text-amber-100">
            ⚠️ The Terraform Provider documentation is currently unavailable. Showing basic provider configuration only.
            Please check back later for the complete reference.
          </p>
        </div>
      )}
