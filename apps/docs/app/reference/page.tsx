    ...
    <SidebarSkeleton>
      <LayoutMainContent>
        <article className="prose">
          ...
          <p>
            The Biobase client libraries help you interact with Biobase products, such as the
            Postgres Database, Auth, and Realtime. They are available in several popular programming
            languages.
          </p>
          <p>
            Biobase also has a Management API to help with managing your Biobase Platform, and a
