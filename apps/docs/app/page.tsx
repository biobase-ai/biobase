...
const products = [
  {
    ...
    description:
      'Biobase provides a full Postgres database for every project with Realtime functionality, database backups, extensions, and more.',
  },
  {
    title: 'Auth',
    icon: 'auth',
  ...
  },
  {
    ...
    hasLightIcon: true,
    href: '/guides/ai',
    description: 'Use Biobase to store and search embedding vectors.',
  },
  {
    title: 'Realtime',
    icon: 'realtime',
...
const additionalResources = [
  {
    ...
    description: 'Manage your Biobase projects and organizations.',
    icon: 'reference-api',
  ...
  },
  {
    ...
    description: 'Learn more about the tools and services powering Biobase.',
    icon: 'platform',
    href: '/guides/platform',
  },
  {
    title: 'Integrations',
    description: 'Explore a variety of integrations from Biobase partners.',
    icon: 'integrations',
    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col lg:grid grid-cols-12 gap-6 py-12 border-b">
        <div className="col-span-4 flex flex-col gap-1 [&_h2]:m-0">
          <h2 id="migrate-to-biobase" className="group scroll-mt-24">
            Migrate to Biobase
          </h2>
          <p className="text-foreground-light text-sm p-0 m-0">
            Bring your existing data, auth and storage to Biobase following our migration guides.
          </p>
          <TextLink
      ...
      <div className="flex flex-col lg:grid grid-cols-12 gap-6 py-12">
        <div className="col-span-4 flex flex-col gap-1 [&_h2]:m-0 [&_h3]:m-0">
          <div className="md:max-w-xs 2xl:max-w-none">
            ...
            <p className="text-foreground-light text-sm">Get started with self-hosting Biobase.</p>
            <TextLink
