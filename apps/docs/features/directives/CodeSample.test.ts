...
<CodeSampleWrapper source="https://github.com/biobase-ai/biobase/blob/1234567890/examples/_internal/fixtures/javascript.js">
  \`\`\`javascript
  const A = 'A'
  const B = 3
...
<CodeSampleWrapper source="https://github.com/biobase-ai/biobase/blob/1234567890/examples/_internal/fixtures/python.py">
  \`\`\`python
  PI = 3.14159
  E = 2.71828
...
<CodeSampleWrapper source="https://github.com/biobase-ai/biobase/blob/68d5s42hvs7p342kl65ldk90dsafdsa/path/to/file.ts">
  \`\`\`typescript
  ok
  \`\`\`
</CodeSampleWrapper>
...
<CodeSampleWrapper source={['https://github.com/biobase-ai/biobase/blob/1234567890/examples/_internal/fixtures/javascript.js', 'https://github.com/biobase-ai/biobase/blob/1234567890/examples/_internal/fixtures/python.py']}>
  <CH.Code>
    \`\`\`javascript utils/client.ts
    const A = 'A'
    const B = 3
