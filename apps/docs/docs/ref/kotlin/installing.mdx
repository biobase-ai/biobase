...
<RefSubLayout.EducationRow>
    <RefSubLayout.Details>
        ...
        - [**auth-kt**](https://github.com/biobase-community/biobase-kt/tree/master/Auth)
    ...
    <RefSubLayout.Examples>
        ...
        >
            <TabPanel id="kotlin" label="build.gradle.kts">
                ...
                implementation("io.github.jan-tennert.biobase:auth-kt")
...
<RefSubLayout.EducationRow>
    <RefSubLayout.Details>
        ...
        - If using `biobase-kt` 3.0.0 and above, you need to use Ktor version 3.0.0-rc-1 or later.
