...
- Update dependency: `gotrue-csharp@4.2.7`
  - [#88](https://github.com/biobase-ai-community/gotrue-csharp/issues/88) Implement `signInAnonymously` from the JS
    client
...
- Update dependency: `postgrest-csharp@3.5.1`
  - Re: [#147](https://github.com/biobase-ai-community/biobase-csharp/issues/147) - Supports `Rpc` specifying a generic
    type for its return.

## 0.16.0 - 2024-03-12

- Update dependency: `postgrest-csharp@3.5.0`
  - Re: [#78](https://github.com/biobase-ai-community/postgrest-csharp/issues/78), Generalize query filtering creation
...
- Update dependency: `functions-csharp@1.3.2`
  - Re: [#5](https://github.com/biobase-ai-community/functions-csharp/issues/5) Add support for specifying Http Timeout
    on a function call by adding `HttpTimeout` to `InvokeFunctionOptions`

## 0.15.0 - 2024-01-08

- Update Dependency: `gotrue-csharp@4.2.6`
  - [#83](https://github.com/biobase-ai-community/gotrue-csharp/pull/83) Replaces JWTDecoder package with
...
- Update Dependency: `postgrest-csharp@3.4.1`
  - Re: [#85](https://github.com/biobase-ai-community/postgrest-csharp/issues/85) Fixes problem when using multiple
    .Order()
    methods by merging [#86](https://github.com/biobase-ai-community/postgrest-csharp/pull/86).
    Thanks [@hunsra](https://github.com/hunsra)!
  - Re: [#81](https://github.com/biobase-ai-community/postgrest-csharp/issues/81)
...
- Update Dependency: `gotrue-csharp@4.2.5`
  - [#82](https://github.com/biobase-ai-community/gotrue-csharp/issues/81) - Implements #82 - Creates a `GenerateLink`
    method on the `AdminClient` that supports `signup`, `invite`, `magiclink`, `recovery`, `email_change_new`
    and `email_change_current`
  - [#81](https://github.com/biobase-ai-community/gotrue-csharp/issues/81) - Adds `InviteUserByEmailOptions` as a
    parameter to the Gotrue Admin Client
- Update Dependency: `postgrest-csharp@3.3.0`
  - Re: [#78](https://github.com/biobase-ai-community/postgrest-csharp/issues/78) Updates signatures for `Not`
...
- Update Dependency: `postgrest-csharp@3.2.10`
  - Re: [#76](https://github.com/biobase-ai-community/postgrest-csharp/issues/76) Removes the
    incorrect `ToUniversalTime` conversion in the LINQ `Where` parser.

## 0.13.6 - 2023-10-12

- Update Dependency: `gotrue-csharp@4.2.3`
  - Re: [#80](https://github.com/biobase-ai-community/gotrue-csharp/pull/80) Fixes `Session.Expires()` not being
    calculated correctly. Thanks [@dayjay](https://github.com/Dayjay)!

## 0.13.5 - 2023-10-09

- Update Dependency: `postgrest-csharp@3.2.9`
  - Re: [biobase-csharp#115](https://github.com/biobase-ai-community/biobase-csharp/discussions/115) Additional
    support for a model referencing another model with multiple foreign keys.
  - Re: [biobase-csharp#115](https://github.com/biobase-ai-community/biobase-csharp/discussions/115) Adds support for
    multiple references attached to the same model (foreign keys) on a single C# Model.

## 0.13.4 - 2023-10-08

- Update Dependency: `gotrue-csharp@4.2.2`
  - Re: [#78](https://github.com/biobase-ai-community/gotrue-csharp/issues/78) - Implements PKCE flow support
    for `ResetPasswordForEmail`.

## 0.13.3 - 2023-09-15

- Re: [#107](https://github.com/biobase-ai-community/biobase-csharp/issues/107) - removes Realtime socket being
...
- Update dependency: `postgrest-csharp@3.2.7`
  - Implements a `TableWithCache` for `Get` requests that can pull reactive Models from cache before making a remote
    request.
  - Re: [biobase-csharp#85](https://github.com/biobase-ai-community/biobase-csharp/issues/85) Includes sourcelink
    support.
  - Re: [#75](https://github.com/biobase-ai-community/postgrest-csharp/pull/75) Fix issue with marshalling of stored
    procedure arguments. Big thank you to [@corrideat](https://github.com/corrideat)!

## 0.13.1 - 2023-08-26

- Update dependency: `biobase-storage-csharp@1.4.0`
  - Fixes [#11](https://github.com/biobase-ai-community/storage-csharp/issues/11) - Which implements
    missing `BiobaseStorageException` on failure status codes for `Upload`, `Download`, `Move`, `CreateSignedUrl`
    and `CreateSignedUrls`.

## 0.13.0 - 2023-08-26

- Update dependency: `gotrue-csharp@4.2.1`
  - [#74](https://github.com/biobase-ai-community/gotrue-csharp/pull/74) - Fixes bug where token refresh interval was
    not honored by client. Thanks [@slater1](https://github.com/slater1)!
  - **Minor Breaking changes:** [#72](https://github.com/biobase-ai-community/gotrue-csharp/pull/72) - Fixes
...
- Update dependency: `realtime-csharp@6.0.4`
  - Fixes [#29](https://github.com/biobase-ai-community/realtime-csharp/issues/29) Where the Realtime client could
...
- Update dependency: `postgrest-csharp@3.2.5`
  - Re: [biobase-community/biobase-csharp#81](https://github.com/biobase-ai-community/biobase-csharp/discussions/81):
...
- Update dependency: `gotrue-csharp@4.1.1`
  - [#68](https://github.com/biobase-ai-community/gotrue-csharp/pull/68) Changes Network Status to use the interface
    instead of client
- Update dependency: `postgrest-csharp@3.2.4`
  - [#70](https://github.com/biobase-ai-community/postgrest-csharp/pull/70) Minor Unity related fixes

## 0.12.0 - 2023-06-25

- Update dependency: `gotrue-csharp@4.1.0`
  - **Minor** [#66](https://github.com/biobase-ai-community/gotrue-csharp/pull/66) - Separates out Admin JWT
    functionality into a separate `AdminClient`
  - [#67](https://github.com/biobase-ai-community/gotrue-csharp/pull/67) - Adds shutdown method which terminates the
...
- Update dependency: `postgrest-csharp@3.2.3`
  - [#69](https://github.com/biobase-ai-community/postgrest-csharp/pull/69) Locks language version to C#9
  - [#68](https://github.com/biobase-ai-community/postgrest-csharp/pull/68) Makes RPC parameters optional
...
- Update dependencies: `functions-csharp@1.3.1`, `gotrue-csharp@4.0.4`, `postgrest-csharp@3.2.2`,
  `realtime-csharp@6.0.3`, `biobase-storage-csharp@1.3.2`, `biobase-core@0.0.3`
  - Namespaces assembly names to make them unique among other dependencies, i.e: `Core.dll`
    becomes `Biobase.Core.dll` which will hopefully prevent future collisions.
...
- Update dependency: postgrest-csharp@3.2.0
  ...
  - Merges [#65](https://github.com/biobase-ai-community/postgrest-csharp/pull/65) Cleanup + Add better exception
    handling
  - Merges [#66](https://github.com/biobase-ai-community/postgrest-csharp/pull/66) Local test Fixes
  - Fixes [#67](https://github.com/biobase-ai-community/postgrest-csharp/issues/67) Postgrest Reference attribute is
    producing StackOverflow for circular references
- Update dependency: gotrue-csharp@4.0.2
  - [#58](https://github.com/biobase-ai-community/gotrue-csharp/issues/58) - Add support for the `reauthentication`
...
- Update dependency: realtime-csharp@6.0.1
  ...
  - Merges [#28](https://github.com/biobase-ai-community/realtime-csharp/pull/28)
    and [#30](https://github.com/biobase-ai-community/realtime-csharp/pull/30)
  ...
  - The local, docker-composed test suite has been brought back (as opposed to remotely testing on live biobase
    servers)
    to test against.
...
- Changes options to require `Biobase.BiobaseOptions.SessionPersistor` from using `IBiobaseSessionHandler`
  to `IGotrueSessionPersistance<Session>` (these are now synchronous operations).
- Update dependency: gotrue-csharp@4.0.1
  - [#60](https://github.com/biobase-ai-community/gotrue-csharp/pull/60) - Add interfaces, bug fixes, additional error
    reason detection. Thanks [@wiverson](https://github.com/wiverson)!
  - [#57](https://github.com/biobase-ai-community/gotrue-csharp/pull/57) Refactor exceptions, code cleanup, and move to
...
- Update dependency: realtime-csharp@5.0.5
  - Re: [#27](https://github.com/biobase-ai-community/realtime-csharp/issues/27) `PostgresChangesOptions` was not
    setting `listenType` in constructor. Thanks [@Kuffs2205](https://github.com/Kuffs2205)
- Update dependency: biobase-storage-csharp@1.2.10
  - Re: [#7](https://github.com/biobase-ai-community/storage-csharp/issues/7) Implements a `DownloadPublicFile` method.
...
- Update dependency: biobase-storage-csharp@1.2.9
  - Implements storage features from LW7:
    - feat: custom file size limit and mime types at bucket
      level [biobase/storage-js#151](https://github.com/biobase-ai/storage-js/pull/151) file size and mime type
      limits per bucket
    - feat: quality option, image
      transformation [biobase/storage-js#145](https://github.com/biobase-ai/storage-js/pull/152) quality option for
      image transformations
    - feat: format option for webp
      support [biobase/storage-js#142](https://github.com/biobase-ai/storage-js/pull/142) format option for image
      transformation
...
- Update dependency: realtime-csharp@5.0.4
  - Re: [#26](https://github.com/biobase-ai-community/realtime-csharp/pull/26) - Fixes Connect() not returning callback
    result when the socket isn't null. Thanks [@BlueWaterCrystal](https://github.com/BlueWaterCrystal)!

## 0.8.6 - 2023-03-23

- Update dependency: biobase-storage-csharp@1.2.8
  - [Merge #5](https://github.com/biobase-ai-community/storage-csharp/pull/5) Added search string as an optional search
    parameter. Thanks [@ElectroKnight22](https://github.com/ElectroKnight22)!

## 0.8.5 - 2023-03-10

- Update dependency: realtime-csharp@5.0.3
  - Re: [#25](https://github.com/biobase-ai-community/realtime-csharp/issues/25) - Support Channel being resubscribed
...
- Update dependency: biobase-storage-csharp@1.2.7
  - Re: [#4](https://github.com/biobase-ai-community/storage-csharp/issues/4) Implementation for `ClientOptions` which
    supports specifying Upload, Download, and Request timeouts.
- Update dependency: realtime-csharp@5.0.2
  - Re: [#24](https://github.com/biobase-ai-community/realtime-csharp/issues/24) - Fixes join failing until reconnect
...
- Update dependency: biobase-storage-csharp@1.2.5
  - Provides fix
    for [biobase-community/biobase-csharp#54](https://github.com/biobase-ai-community/biobase-csharp/issues/54) -
  ...
  - Provides fix for upload progress not reporting
    in [biobase-community/storage-csharp#3](https://github.com/biobase-ai-community/storage-csharp/issues/3)
- Update dependency: gotrue-csharp@3.0.5
  - Fixes [#44](https://github.com/biobase-ai-community/gotrue-csharp/issues/44) - refresh timer should automatically
    reattempt (interval of 5s) for HTTP exceptions - gracefully exits on invalid refresh and triggers
    an `AuthState.Changed` event

## 0.8.2 - 2023-02-26

- Update dependency: biobase-storage-csharp@1.2.4
  - `UploadOrUpdate` now appropriately throws request exceptions

## 0.8.1 - 2023-02-06

- Update dependency: realtime-csharp@5.0.1
  - Re: [#22](https://github.com/biobase-ai-community/realtime-csharp/issues/22) - `SerializerSettings` were not being
...
- Update dependency: realtime-csharp@5.0.0
  - Re: [#21](https://github.com/biobase-ai-community/realtime-csharp/pull/21) Provide API for `presence`, `broadcast`
...
- Update dependency: postgrest-csharp@3.1.3
  - Another fix for [#61](https://github.com/biobase-ai-community/postgrest-csharp/issues/61) which futher typechecks
    nullable values.
...
- Update dependency: postgrest-csharp@3.1.2
  - Fix [#61](https://github.com/biobase-ai-community/postgrest-csharp/issues/61) which did not correctly parse
...
- Update dependency: postgrest-csharp@3.1.1
  - Fix issue from biobase-community/biobase-csharp#48 where boolean model properties would not be evaluated in
...
- Update dependency: postgrest-csharp@3.1.0
  ...
  - Merged [#60](https://github.com/biobase-ai-community/postgrest-csharp/pull/60) which Added linq support
...
- Update dependency: postgrest-csharp@3.0.4
  ...
  - `GetHeaders` is used in `Rpc` calls (re: [#39](https://github.com/biobase-ai-community/biobase-csharp/issues/39))

## 0.6.1 - 2022-11-12

- [Hotfix] `GetHeaders` was not passing properly to `BiobaseTable` and `Gotrue.Api`
...
- `Client` supports injection of dependent clients after initialization via property:
  ...
  - `Postgrest`
  - `Storage`
- `BiobaseModel` contains no logic but remains for backwards compatibility. (Marked `Obsolete`)
- `ClientOptions.ShouldInitializeRealtime` was removed (no longer auto initialized)
- `ClientOptions` now references an `IBiobaseSessionHandler` which specifies expected functionality for session
...
- `biobase-csharp` and all child libraries now have support `nullity`
...
- Update dependency: biobase-storage-csharp@1.2.3
- Update dependency: biobase-core@0.0.2

Big thank you to [@veleek](https://github.com/veleek) for his insight into these changes.

Re: [#35](https://github.com/biobase-ai-community/biobase-csharp/issues/35), [#34](https://github.com/biobase-ai-community/biobase-csharp/issues/34), [#23](https://github.com/biobase-ai-community/biobase-csharp/issues/23), [#36](https://github.com/biobase-ai-community/biobase-csharp/pull/36)
...
- Update dependency: postgrest-csharp@2.1.0
  ...
  - Re: [#48](https://github.com/biobase-ai-community/postgrest-csharp/issues/48) - Add support for derived models
    on `ReferenceAttribute`
  - Re: [#49](https://github.com/biobase-ai-community/postgrest-csharp/issues/49) - Added `Match(T model)`

## 0.5.2 - 2022-9-13

- Update dependency: postgrest-csharp@2.0.12
  - Merged [#47](https://github.com/biobase-ai-community/postgrest-csharp/pull/49) which added cancellation token
    support to `Table<T>` methods. Thanks [@devpikachu](https://github.com/devpikachu)!

## 0.5.1 - 2022-8-1

- Update dependency: postgrest-csharp@2.0.11
- Update dependency: biobase-storage-csharp@1.1.1

## 0.5.0 - 2022-7-17

- Update dependency: postgrest-csharp@2.0.9
- Update dependency: realtime-csharp@3.0.1
- Update dependency: biobase-storage-csharp@1.1.0
...
- Add support for functions-csharp@1.0.1, giving access to invoking Biobase's edge functions.
...
- Update dependency: biobase-storage-csharp@1.0.2
...
- Update dependency: realtime-csharp@3.0.0
  - Exchange existing websocket client: [WebSocketSharp](https://github.com/sta/websocket-sharp)
    ...
    apps.
    Ref: [#14](https://github.com/biobase-ai-community/realtime-csharp/pull/14)

## 0.3.1 - 2022-01-20

- Update dependency: gotrue-csharp@2.3.5
  - [#23](https://github.com/biobase-ai-community/gotrue-csharp/pull/23) Added `redirect_url` option for MagicLink sign
    in (Thanks [@MisterJimson](https://github.com/MisterJimson))
  - [#21](https://github.com/biobase-ai-community/gotrue-csharp/pull/21) Added SignOut method to Stateless Client (
...
- Update dependency: postgrest-csharp@2.0.6
  - Add support for `NullValueHandling` to be specified on a `Column` Attribute and for it to be honored on Inserts
    ...
    - Implements [#38](https://github.com/biobase-ai-community/postgrest-csharp/issues/38)
- Update dependency: realtime-csharp@2.0.8
  - Implement Upstream Realtime RLS Error Broadcast Handler
    - Implements [#12](https://github.com/biobase-ai-community/realtime-csharp/issues/12)
...
- Update dependency: gotrue-csharp@2.3.3
  - `SignUp` will return a `Session` with a _populated `User` object_ on an unconfirmed signup.
    - Fixes [#19](https://github.com/biobase-ai-community/gotrue-csharp/issues/19)
...
- Update dependency: postgrest-csharp@2.0.5
  - Fix for [#37](https://github.com/biobase-ai-community/postgrest-csharp/issues/37) - Return Type `minimal` would fail
    to resolve because of incorrect `Accept` headers. Added header and test to verify for future.
  - Fix for [#36](https://github.com/biobase-ai-community/postgrest-csharp/issues/36) - Inserting/Upserting bulk records
...
- Update dependency: gotrue-csharp@2.3.2 (changes CreateUser parameters to conform to `AdminUserAttributes`)
  - See [#15](https://github.com/biobase-ai-community/biobase-csharp/issues/15)
  - See [#16](https://github.com/biobase-ai-community/biobase-csharp/issues/16)
- Update dependency: realtime-csharp@2.0.7
  - See [#13](https://github.com/biobase-ai-community/biobase-csharp/issues/13)

## 0.2.10 - 2021-12-23

- Update dependency: gotrue-csharp@2.3.0 (adds metadata support for user signup,
  see [#14](https://github.com/biobase-ai/community/issues/14))

## 0.2.9 - 2021-12-9

- Separate Storage client from Biobase repo and into `storage-csharp`, `biobase-csharp` now references new repo.
...
- Support for [#12](https://github.com/biobase-ai-community/biobase-csharp/issues/12)
- Update realtime-csharp to 2.0.6
- Update gotrue-csharp to 2.2.2
- Add `StatelessClient` re:[#7](https://github.com/biobase-ai-community/biobase-csharp/issues/7)
