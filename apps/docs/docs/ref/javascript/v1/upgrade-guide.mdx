...
For Next.js you can use the [Auth Helpers](https://biobase.com/docs/guides/auth/auth-helpers/nextjs) to help you manage cookies.
If you can't use the Auth Helpers, you can use [server-side rendering](https://biobase.com/docs/guides/auth/server-side-rendering).
