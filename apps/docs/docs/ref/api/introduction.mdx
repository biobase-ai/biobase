...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
      ...
      To generate or manage your API token, visit your [account](https://biobase.studio/dashboard/account/tokens) page.
      ...
      All resources created via the API are subject to the pricing detailed on our [Pricing](https://biobase.studio/pricing) pages.
    ...
    <RefSubLayout.Examples>
      ...
      - [OpenAPI Docs](https://api.biobase.studio/api/v1)
      - [OpenAPI Spec](https://api.biobase.studio/api/v1-json)
