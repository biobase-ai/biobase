...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    The Biobase Auth Server (GoTrue) is a JSON Web Token (JWT)-based API for managing users and issuing access tokens.
  ...
  <RefSubLayout.Examples>
    ...
    - [JavaScript](https://github.com/biobase-ai/gotrue-js)
    - [Dart](https://github.com/biobase-ai/gotrue-dart)

    ### Additional links

    - [Source code](https://github.com/biobase-ai/gotrue)
    - [Known bugs and issues](https://github.com/biobase-ai/gotrue/issues)
