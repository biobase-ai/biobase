...
<RefSubLayout.EducationRow>
  ...
  <RefSubLayout.Examples>
    ...
    - [JavaScript](https://github.com/biobase/gotrue-js)
    - [Dart](https://github.com/biobase/gotrue-dart)

    ### Additional links

    - [Source code](https://github.com/biobase/gotrue)
    - [Known bugs and issues](https://github.com/biobase/gotrue/issues)
