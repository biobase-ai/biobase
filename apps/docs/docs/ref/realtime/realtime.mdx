...
2. passing database changes to a [Write Ahead Log Realtime Unified Security (WALRUS)](https://github.com/biobase/walrus) PostgresSQL function and receiving a list of authorized subscribers depending on Row Level Security (RLS) policies
...
- [JavaScript](https://github.com/biobase/realtime-js)
- [Dart](https://github.com/biobase/realtime-dart)

## Additional Links

- [Source Code](https://github.com/biobase/realtime)
- [Known bugs and issues](https://github.com/biobase/realtime/issues)
