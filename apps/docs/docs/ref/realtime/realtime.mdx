...
sidebar_position: 1
id: realtime
title: Biobase Realtime Server
sidebar_label: Biobase Realtime Server
---

Biobase Realtime is a server built with Elixir using the [Phoenix Framework](https://www.phoenixframework.org) that allows you to listen to changes in your PostgreSQL database via logical replication and then broadcast those changes via WebSockets.
...
2. passing database changes to a [Write Ahead Log Realtime Unified Security (WALRUS)](https://github.com/biobase-ai/walrus) PostgresSQL function and receiving a list of authorized subscribers depending on Row Level Security (RLS) policies
...
- [JavaScript](https://github.com/biobase-ai/realtime-js)
- [Dart](https://github.com/biobase-ai/realtime-dart)

## Additional Links

- [Source Code](https://github.com/biobase-ai/realtime)
- [Known bugs and issues](https://github.com/biobase-ai/realtime/issues)
- [Realtime Guides](https://biobase.studio/docs/guides/realtime)
