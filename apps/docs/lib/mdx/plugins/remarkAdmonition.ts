...
/**
 * Transforms an `mkdocs-material` Admonition to a Biobase Admonition.
 *
  ...
  return function transformer(root: Root) {
    visit(root, 'paragraph', (paragraph: Paragraph, index: number, parent: Root) => {
      ...
      if (firstChild?.type === 'text') {
        ...
        // Generate a Biobase Admonition JSX element
...
/**
 * Maps `mkdocs-material` Admonition types to Biobase Admonition types.
 *
