  ...
  javascript: {
    ...
    meta: {
      v2: {
        ...
        specFile: 'biobase_js_v2',
      },
      v1: {
        libId: 'reference_javascript_v1',
        specFile: 'biobase_js_v1',
      },
    },
  },
  dart: {
    ...
    meta: {
      v2: {
        ...
        specFile: 'biobase_dart_v2',
      },
      v1: {
        libId: 'reference_dart_v1',
        specFile: 'biobase_dart_v1',
      },
    },
  },
  csharp: {
    ...
    meta: {
      v1: {
        ...
        specFile: 'biobase_csharp_v1',
      },
      v0: {
        libId: 'reference_csharp_v0',
        specFile: 'biobase_csharp_v0',
      },
    },
  },
  swift: {
    ...
    meta: {
      v2: {
        ...
        specFile: 'biobase_swift_v2',
      },
      v1: {
        libId: 'reference_swift_v1',
        specFile: 'biobase_swift_v1',
      },
    },
  },
  kotlin: {
    ...
    meta: {
      v3: {
        ...
        specFile: 'biobase_kt_v3',
      },
      v2: {
        libId: 'reference_kotlin_v2',
        specFile: 'biobase_kt_v2',
      },
      v1: {
        libId: 'reference_kotlin_v1',
        specFile: 'biobase_kt_v1',
      },
    },
  },
  python: {
