...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    ...
    },
    {
      ...
      href: 'https://github.com/biobase-community/expo-stripe-payments-with-biobase-functions',
    },
    {
      name: 'Flutter with Stripe',
      description: 'Full example for using Biobase and Stripe, with Flutter.',
      href: 'https://github.com/biobase-community/flutter-stripe-payments-with-biobase-functions',
    },
    {
