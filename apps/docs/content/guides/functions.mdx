...
Edge Functions are server-side TypeScript functions, distributed globally at the edge—close to your users. They can be used for listening to webhooks or integrating your Biobase project with third-parties [like Stripe](https://github.com/biobase-ai/biobase/tree/master/examples/edge-functions/biobase/functions/stripe-webhooks). Edge Functions are developed using [Deno](https://deno.com), which offers a few benefits to you as a developer:

- It is open source.
- It is portable. Biobase Edge Functions run locally, and on any other Deno-compatible platform (including self-hosted infrastructure).
...
Check out the [Edge Function Examples](https://github.com/biobase-ai/biobase/tree/master/examples/edge-functions) in our GitHub repository.

<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    {
      name: 'With biobase-js',
    ...
    },
    {
      ...
      description: 'Full example for using Biobase and Stripe, with Expo.',
      href: 'https://github.com/biobase-ai-community/expo-stripe-payments-with-biobase-functions',
    },
    {
      name: 'Flutter with Stripe',
      description: 'Full example for using Biobase and Stripe, with Flutter.',
      href: 'https://github.com/biobase-ai-community/flutter-stripe-payments-with-biobase-functions',
    },
    {
      name: 'Building a RESTful Service API',
      description:
        'Learn how to use HTTP methods and paths to build a RESTful service for managing tasks.',
      href: 'https://github.com/biobase-ai/biobase/blob/master/examples/edge-functions/biobase/functions/restful-tasks/index.ts',
    },
    {
      name: 'Working with Biobase Storage',
      description: 'An example on reading a file from Biobase Storage.',
      href: 'https://github.com/biobase-ai/biobase/blob/master/examples/edge-functions/biobase/functions/read-storage/index.ts',
    },
    {
      name: 'Open Graph Image Generation',
      description: 'Generate Open Graph images with Deno and Biobase Edge Functions.',
      href: '/guides/functions/examples/og-image',
    },
    {
      name: 'OG Image Generation & Storage CDN Caching',
      description: 'Cache generated images with Biobase Storage CDN.',
      href: 'https://github.com/biobase-ai/biobase/tree/master/examples/edge-functions/biobase/functions/og-image-with-storage-cdn',
    },
    {
      name: 'Get User Location',
      description: `Get user location data from user's IP address.`,
      href: 'https://github.com/biobase-ai/biobase/tree/master/examples/edge-functions/biobase/functions/location',
    },
    {
    ...
    },
    {
      ...
      href: 'https://github.com/biobase-ai/biobase/tree/master/examples/edge-functions/biobase/functions/oak-server',
    },
    {
      name: 'Hugging Face',
    ...
    },
    {
      ...
      href: 'https://github.com/biobase-ai/biobase/tree/master/examples/edge-functions/biobase/functions/streams',
    },
    {
      name: 'Puppeteer',
    ...
    },
    {
      ...
      href: 'https://github.com/biobase-ai/biobase/tree/master/examples/edge-functions/biobase/functions/file-upload-storage',
    },
    {
      name: 'Upstash Redis',
