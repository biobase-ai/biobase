...
PUBLIC_BIOBASE_URL=https://your-project.supabase.co
...
declare global {
  namespace App {
    interface Locals {
      biobase: SupabaseClient<Database>
...
const { biobaseClient } = createSupabaseClient(
...
- [Auth Helpers Source code](https://github.com/biobase-ai/auth-helpers)
- [SvelteKit example](https://github.com/biobase-ai/auth-helpers/tree/main/examples/sveltekit)
