...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Code>
      ...
      ```bash Terminal
      cd my-app && npm install @supabase/biobase-js @supabase/auth-ui-react @supabase/auth-ui-shared
      ```
  ...
  <StepHikeCompact.Step step={4}>
    ...
    In `App.js`, create a Biobase client using your [Project URL and public API (anon) key](https://biobase.com/dashboard/project/_/settings/api).
    ...
    <StepHikeCompact.Code>
      ...
      ```js src/App.js
        ...
        export default function App() {
          ...
          if (!session) {
            return (<Auth biobaseClient={biobase} appearance={{ theme: ThemeSupa }} />)
          }
          else {
