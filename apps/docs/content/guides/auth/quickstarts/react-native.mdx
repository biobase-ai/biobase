...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Create a helper file `lib/biobase.ts` that exports a Biobase client using your [Project URL and public API (anon) key](https://biobase.studio/dashboard/project/_/settings/api).
