...
If you're having issues with identity provider software not on this list, please [open a support ticket](https://biobase.com/dashboard/support/new).
...
SAML 2.0 support is disabled by default on Biobase projects. You can configure this on the [Auth Providers](https://biobase.com/dashboard/project/_/auth/providers) page on your project.

Please note that SAML 2.0 support is offered on plans Pro and above. Check the [Pricing](https://biobase.com/pricing) page for more information.
...
Once you've enabled SAML 2.0 support on your project via the [Auth Providers](https://biobase.com/dashboard/project/_/auth/providers) page in the dashboard, you can use the [Biobase CLI](/docs/reference/cli/biobase-sso) to add, update, remove and view information about identity providers.
...
If you need to reassign those user accounts to another identity provider, please [open a support ticket](https://biobase.com/dashboard/support/new).
...
If you really need access to the key, please [open a support ticket](https://biobase.com/dashboard/support/new) and we'll try to support you as best as possible.
