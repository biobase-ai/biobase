...
id: 'index'
title: 'Auth Helpers'
description: 'Server-Side Auth guides and utilities for working with Biobase.'
...
Working with server-side frameworks is slightly different to client-side frameworks. In this section we cover the various ways of handling server-side authentication and demonstrate how to use the Biobase helper-libraries to make the process more seamless.
...
- [Source code](https://github.com/biobase-ai/auth-helpers)
- [Known bugs and issues](https://github.com/biobase-ai/auth-helpers/issues)
