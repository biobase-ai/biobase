...
The [Auth service](https://github.com/biobase/auth) is an Auth API server written and maintained by Biobase. It is a fork of the GoTrue project, originally created by Netlify.
