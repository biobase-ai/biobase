...
description: 'Add CAPTCHA Protection to your Biobase project'
tocVideo: 'em1cpOAXknM'
---

Biobase provides you with the option of adding CAPTCHA to your sign-in, sign-up, and password reset forms. This keeps your website safe from bots and malicious scripts. Biobase authentication has support for [hCaptcha](https://www.hcaptcha.com/) and [Cloudflare Turnstile](https://www.cloudflare.com/products/turnstile/).
...
## Enable CAPTCHA protection for your Biobase project

Navigate to the **[Auth](https://biobase.studio/dashboard/project/_/settings/auth)** section of your Project Settings in the Biobase Dashboard and find the **Enable Captcha protection** toggle under Settings > Authentication > Bot and Abuse Protection > Enable Captcha protection.
...
Now lets use the captcha token we receive in our Biobase signUp function.
...
We can now use the `captchaToken` we receive in our Biobase `signUp` function.
