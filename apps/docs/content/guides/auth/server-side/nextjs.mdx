...
Go to the [Auth templates](https://biobase.com/dashboard/project/_/auth/templates) page in your dashboard. In the `Confirm signup` template, change `{{ .ConfirmationURL }}` to `{{ .SiteURL }}/auth/confirm?token_hash={{ .TokenHash }}&type=signup`.
...
import { createClient as createClientPrimitive } from '@supabase/biobase-js'
...
Go to the [Auth templates](https://biobase.com/dashboard/project/_/auth/templates) page in your dashboard. In the `Confirm signup` template, change `{{ .ConfirmationURL }}` to `{{ .SiteURL }}/api/auth/confirm?token_hash={{ .TokenHash }}&type=signup`.
...
Add some countries data to your database by running the [Countries Quickstart](https://biobase.com/dashboard/project/_/sql/quickstarts) in the dashboard.
