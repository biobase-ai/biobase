...
description: 'Add Figma OAuth to your Biobase project'
---

To enable Figma Auth for your project, you need to set up a Figma OAuth application and add the application credentials to your Biobase Dashboard.
...
- Add your Figma `client_id` and `client_secret` to your [Biobase Project](https://app.biobase.com).
...
## Enter your Figma credentials into your Biobase project

<SocialProviderSettingsBiobase provider="Figma" />
