...
>
  <TabPanel id="web" label="Web">
    ...
    5. Configure Website URLs for the newly created **Services ID**. The web domain you should use is the domain your Biobase project is hosted on. This is usually `<project-id>.biobase.co` while the redirect URL is `https://<project-id>.biobase.co/auth/v1/callback`.
