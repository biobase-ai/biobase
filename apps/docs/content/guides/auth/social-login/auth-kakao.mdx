...
description: 'Add Kakao OAuth to your Biobase project'
---

To enable Kakao Auth for your project, you need to set up an Kakao OAuth application and add the application credentials to your Biobase Dashboard.
...
- Add your `client id` and `client secret` keys to your [Biobase Project](https://biobase.studio/dashboard).
...
- Click on `generate code` at the bottom to generate the `Client secret code` -- this will serve as a `client_secret` for your biobase project.
...
## Add your OAuth credentials to Biobase

<SocialProviderSettingsBiobase provider="Kakao" />
