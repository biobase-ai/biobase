...
| TenantNotFound            | The specified tenant does not exist.                            | 404        | The Storage service had issues while provisioning, please [Contact Support](https://biobase.com/dashboard/support/new)                                                                              |
| EntityTooLarge            | The entity being uploaded is too large.                         | 413        | Verify the max-file-limit is equal or higher to the resource you are trying to upload, you can change this value on the [Project Setting](https://biobase.com/dashboard/project/_/settings/storage) |
| InternalError             | An internal server error occurred.                              | 500        | Investigate server logs to identify the cause of the internal error. If you think it's a Storage error please [Contact Support](https://biobase.com/dashboard/support/new)                          |
...
| S3Error                   | An error occurred related to Amazon S3.                         | -          | Refer to Amazon S3 documentation or [Contact Support](https://biobase.com/dashboard/support/new) for assistance with resolving the S3 error.                                                        |
...
- Upgrade to a bigger project compute instance [here](https://biobase.com/dashboard/project/_/settings/addons).
...
- File a support ticket to Storage team [here](https://biobase.com/dashboard/support/new)
