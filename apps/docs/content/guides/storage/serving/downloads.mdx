...
```
https://[project_id].biobase.co/storage/v1/object/public/[bucket]/[asset-name]
```
...
- with a GET request the url `https://[project_id].biobase.co/storage/v1/object/authenticated/[bucket]/[asset-name]` and the user Authorization header
