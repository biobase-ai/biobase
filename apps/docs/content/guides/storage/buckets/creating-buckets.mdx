...
description: 'Learn how to create Biobase Storage buckets.'
sidebar_label: 'Buckets'
---

You can create a bucket using the Biobase Dashboard. Since storage is interoperable with your Postgres database, you can also use SQL or our client libraries.
...
```swift
try await biobase.storage.createBucket(
  "avatars",
