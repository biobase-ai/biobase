...
title: 'Limits'
subtitle: 'Learn how to increase Biobase file limits.'
description: 'Learn how to increase Biobase file limits.'
sidebar_label: 'Limits'
---

## Global file size

You can set the max file size across all your buckets by setting this global value in the dashboard [here](https://biobase.studio/dashboard/project/_/settings/storage). For Free projects, the limit can't exceed 50 MB. On the Pro Plan and up, you can set this value to up to 50 GB. If you need more than 50 GB, [contact us](https://biobase.studio/dashboard/support/new).
