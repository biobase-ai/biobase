...
description: 'Learn how to restrict Biobase file uploads.'
sidebar_label: 'Uploads'
tocVideo: '4ERX__Y908k'
---

Biobase Storage is designed to work perfectly with Postgres [Row Level Security](https://biobase.studio/docs/guides/database/postgres/row-level-security) (RLS).
