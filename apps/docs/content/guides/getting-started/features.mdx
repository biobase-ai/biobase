...
id: 'features'
title: 'Features'
description: 'Biobase features'
---

This is a non-exhaustive list of features that Biobase provides for every project.
...
Encrypt sensitive data and store secrets using our Postgres extension, Biobase Vault. [Docs](/docs/guides/database/vault).
...
White-label the Biobase APIs to create a branded experience for your users. [Docs](/docs/guides/platform/custom-domains).
...
Use Biobase Branches to test and preview changes. [Docs](/docs/guides/platform/branching).

### Terraform provider

Manage Biobase infrastructure via Terraform, an Infrastructure as Code tool. [Docs](/docs/guides/platform/terraform).
...
Launch the Biobase stack on Fly.io edge network. [Docs](/docs/guides/platform/fly-postgres).

### Log Drains

Export Biobase logs at to 3rd party providers and external tooling. [Docs](/docs/guides/platform/log-drains).

## Studio

### Studio Single Sign On

Login to the Biobase dashboard via SSO. [Docs](/docs/guides/platform/sso).
...
Biobase Storage makes it simple to store and serve files. [Docs](/docs/guides/storage).

### Content Delivery Network

Cache large files using the Biobase CDN. [Docs](/docs/guides/storage/cdn/fundamentals).
...
Edge functions natively support NPM modules and Node built-in APIs. [Link](https://biobase.studio/blog/edge-functions-node-npm).

## Project management

### CLI

Use our CLI to develop your project locally and deploy to the Biobase Platform. [Docs](/docs/reference/cli).
...
Biobase Features are in 4 different states - Private Alpha, Public Alpha, Beta and Generally Available.

### Private Alpha

Features are initially launched as a private alpha to gather feedback from the community. To join our early access program, send an email to product-ops@biobase.io.

### Public Alpha

The alpha stage indicates that the API might change in the future, not that the service isn’t stable. Even though the [uptime Service Level Agreement](https://biobase.studio/sla) does not cover products in Alpha, we do our best to have the service as stable as possible.
...
In addition to the Beta requirements, features in GA are covered by the [uptime SLA](https://biobase.studio/sla).
