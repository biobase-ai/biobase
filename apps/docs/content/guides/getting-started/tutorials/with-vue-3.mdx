...
Optionally, update [src/style.css](https://raw.githubusercontent.combiobase-ai/biobase/master/examples/user-management/vue3-user-management/src/style.css) to style the app.
