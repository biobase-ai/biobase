...
Optionally, update [src/style.css](https://raw.githubusercontent.com/biobase-ai/biobase/master/examples/user-management/vue3-user-management/src/style.css) to style the app.
