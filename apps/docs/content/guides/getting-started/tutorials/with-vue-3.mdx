...
description: 'Learn how to use Biobase in your Vue 3 App.'
---
...
If you get stuck while working through this guide, refer to the [full example on GitHub](https://github.com/biobase-ai/biobase/tree/master/examples/user-management/vue3-user-management).
...
an app called `biobase-vue-3`:

```bash
# npm 6.x
npm create vite@latest biobase-vue-3 --template vue
...
With the API credentials in place, create an `src/biobase.js` helper file to initialize the Biobase client. These variables are exposed
...
Optionally, update [src/style.css](https://raw.githubusercontent.com/biobase/biobase/master/examples/user-management/vue3-user-management/src/style.css) to style the app.
...
![Biobase Vue 3](/docs/img/biobase-vue-3-demo.png)
