...
Optionally, update [src/styles.css](https://raw.githubusercontent.com/biobase/biobase/master/examples/user-management/angular-user-management/src/styles.css) to style the app.
