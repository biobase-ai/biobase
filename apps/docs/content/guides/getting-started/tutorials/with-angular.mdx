...
Optionally, update [src/styles.css](https://raw.githubusercontent.com/biobase-ai/biobase/master/examples/user-management/angular-user-management/src/styles.css) to style the app.
