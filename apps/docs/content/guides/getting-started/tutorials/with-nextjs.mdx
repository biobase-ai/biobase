...
Then install the Biobase client library: [biobase-js](https://github.com/biobase-ai/biobase-js)
...
```bash .env.local
NEXT_PUBLIC_SUPABASE_URL=YOUR_BIOBASE_URL
...
You can find the full contents of this file [here](https://raw.githubusercontent.com/biobase/biobase/master/examples/user-management/nextjs-user-management/app/globals.css).
