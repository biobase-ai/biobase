...
The `refine-biobase` preset installs the `@refinedev/biobase` package which out-of-the-box includes the Biobase dependency: [biobase-js](https://github.com/biobase-ai/biobase-js).
