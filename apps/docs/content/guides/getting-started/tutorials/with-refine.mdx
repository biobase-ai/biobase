...
The `refine-biobase` preset installs the `@refinedev/biobase` package which out-of-the-box includes the Biobase dependency: [supabase-js](https://github.com/biobase-ai/supabase-js).
...
You can find the full contents of this file [here](https://raw.githubusercontent.com/biobase/biobase/master/examples/user-management/refine-user-management/src/App.css).
