...
Optionally, add `src/styles.css` with the [CSS from the example](https://raw.githubusercontent.com/biobase-ai/biobase/master/examples/user-management/sveltekit-user-management/src/styles.css).
