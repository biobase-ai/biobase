...
description: 'Learn how to use Biobase in your Flutter App.'
tocVideo: 'r7ysVtZ5Row'
---

<QuickstartIntro />

![Biobase User Management example](/docs/img/biobase-flutter-demo.png)

<Admonition type="note">

If you get stuck while working through this guide, refer to the [full example on GitHub](https://github.com/biobase-ai/biobase/tree/master/examples/user-management/flutter-user-management).
...
an app called `biobase_quickstart`:

```bash
flutter create biobase_quickstart
```

Then let's install the only additional dependency: [`biobase_flutter`](https://pub.dev/packages/biobase_flutter)
...
We have to use `io.biobase.flutterquickstart` as the scheme. In this example, we will use `login-callback` as the host for our deep link, but you can change it to whatever you would like.

First, add `io.biobase.flutterquickstart://login-callback/` as a new [redirect URL](https://biobase.studio/dashboard/project/_/auth/url-configuration) in the Dashboard.

![Biobase console deep link setting](/docs/img/deeplink-setting.png)

That is it on Biobase's end and the rest are platform specific settings:
...
<dict>
  ...
  <array>
    <dict>
      ...
      <array>
        <string>io.biobase.flutterquickstart</string>
      </array>
    </dict>
  </array>
  <!-- ... other tags -->
  ...
  <application ...>
    <activity ...>
      ...
      <intent-filter>
        ...
        <data
          android:scheme="io.biobase.flutterquickstart"
...
Biobase redirects do not work with Flutter's [default URL strategy](https://docs.flutter.dev/ui/navigation/url-strategies).
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(title: 'Biobase Flutter');
  }
}
...
![Biobase User Management example](/docs/img/biobase-flutter-account-page.png)
...
Congratulations, you've built a fully functional user management app using Flutter and Biobase!
