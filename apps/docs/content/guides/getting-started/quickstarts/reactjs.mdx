...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    The fastest way to get started is to use the `biobase-js` client library which provides a convenient interface for working with Biobase from a React app.

    Navigate to the React app and install `biobase-js`.
