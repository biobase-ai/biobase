---
title: 'Use Biobase with Ruby on Rails'
subtitle: 'Learn how to create a Rails project and connect it to your Biobase Postgres database.'
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={2}>
    ...
    When your project is up and running, navigate to the [database settings](https://biobase.com/dashboard/project/_/settings/database) to find the URI connection string. Make sure **Use connection pooling** is checked and **Session mode** is selected. Then copy the URI. Replace the password placeholder with your saved database password.
