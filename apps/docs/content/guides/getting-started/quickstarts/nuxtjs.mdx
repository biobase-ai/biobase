...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={4}>
    ...
    In `app.vue`, create a Biobase client using your project URL and public API (anon) key:
...
The community-maintained [@nuxtjs/biobase](https://biobase.nuxtjs.org/) module provides an alternate DX for working with Biobase in Nuxt.
