...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    <StepHikeCompact.Details title="Create a Biobase project">
      ...
      When your project is up and running, go to the [Table Editor](https://biobase.com/dashboard/project/_/editor), create a new table and insert some data.

      Alternatively, you can run the following snippet in your project's [SQL Editor](https://biobase.com/dashboard/project/_/sql/new). This will create a `notes` table with some sample data.
