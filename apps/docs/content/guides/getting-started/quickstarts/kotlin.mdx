...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    The latest biobase-kt version can be found [here](https://github.com/biobase-ai-community/biobase-kt/releases) and Ktor version can be found [here](https://ktor.io/docs/welcome.html).
  ...
  <StepHikeCompact.Step step={5}>
    ...
    <StepHikeCompact.Code>
      ...
      val biobase = createSupabaseClient(
          biobaseUrl = "https://xyzcompany.supabase.co",
