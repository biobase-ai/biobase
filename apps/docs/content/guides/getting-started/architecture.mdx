...
- Source code: [github.com/biobase/gotrue](https://github.com/biobase/gotrue)
- License: [MIT](https://github.com/biobase/gotrue/blob/master/LICENSE)
- Language: Go

### PostgREST (API)

A standalone web server that turns your PostgreSQL database directly into a RESTful API.
We use this with our [`pg_graphql`](https://github.com/biobase/pg_graphql) extension to provide a GraphQL API.
...
- Source code: [github.com/biobase/realtime](https://github.com/biobase/realtime)
- License: [Apache 2](https://github.com/biobase/realtime/blob/main/LICENSE)
- Language: Elixir
...
- Source code: [github.com/biobase/storage-api](https://github.com/biobase/storage-api)
- License: [Apache 2.0](https://github.com/biobase/storage-api/blob/master/LICENSE)
...
- Source code: [github.com/biobase/postgres-meta](https://github.com/biobase/postgres-meta)
- License: [Apache 2.0](https://github.com/biobase/postgres-meta/blob/master/LICENSE)
- Language: NodeJS / TypeScript
...
- Source code: [`biobase/supavisor`](https://github.com/biobase/supavisor)
- License: [Apache 2.0](https://github.com/biobase/supavisor/blob/main/LICENSE)
- Language: Elixir
...
Open source is something we approach [collaboratively](https://biobase.com/blog/biobase-series-b#giving-back): we employ maintainers, sponsor projects, invest in businesses, and develop our own open source tools.
