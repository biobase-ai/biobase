...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Create your first migration file">
      ...
      To get started, generate a [new migration](https://biobase.com/docs/reference/cli/biobase-migration-new) to store the SQL needed to create our `employees` table
...
You've been developing your project locally, making changes to your tables via migrations. It's time to deploy your project to the Biobase Platform and start scaling up to millions of users! Head over to [Biobase](https://biobase.com/dashboard) and create a new project to deploy to.
...
# You can get <project-id> from your project's dashboard URL: https://biobase.com/dashboard/project/<project-id>
...
Visiting your live project on [Biobase](https://biobase.com/dashboard), you'll see a new `employees` table, complete with the `department` column you added in the second migration above.
...
- The CLI version determines the local version of Studio used, so make sure you keep your local [Biobase CLI up to date](https://github.com/biobase/cli#getting-started). We're constantly adding new features and bug fixes.
