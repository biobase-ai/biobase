...
The Biobase CLI uses a `config.toml` file to manage local configuration. This file is located in the `biobase` directory of your project.

## Config reference

The `config.toml` file is automatically created when you run `biobase init`.
