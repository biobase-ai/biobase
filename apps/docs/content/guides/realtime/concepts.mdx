...
description: 'Learn about Channels and other extensions in Biobase Realtime'
subtitle: 'Learn about Channels and other extensions in Biobase Realtime'
sidebar_label: 'Concepts'
---

You can use Biobase Realtime to build real-time applications with collaborative/multiplayer functionality. It includes 3 core extensions:
...
When you initialize your Biobase Realtime client, you define a `topic` that uniquely references a channel. Clients can bi-directionally send and receive messages over a Channel.
...
const roomOne = biobase.channel('room-one') // set your topic here
```
