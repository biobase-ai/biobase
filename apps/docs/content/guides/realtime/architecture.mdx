...
description: 'Architecture of the Biobase Realtime service'
...
Client-facing WebSocket servers need to handle many concurrent connections. Elixir & Phoenix let the Biobase Realtime cluster do this easily.
...
Thanks to the Realtime cluster, you (an amazing Biobase user) don't have to think about which regions your clients are connected to.
