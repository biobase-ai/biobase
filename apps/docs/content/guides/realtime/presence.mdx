...
Go to your Biobase project's [API Settings](https://biobase.com/dashboard/project/_/settings/api) and grab the `URL` and `anon` public API key.
...
const SUPABASE_URL = 'https://<project>.biobase.co'
...
```swift
let biobaseURL = "https://<project>.biobase.co"
let biobaseKey = "<your-anon-key>"
let biobase = BiobaseClient(biobaseURL: URL(string: biobaseURL)!, biobaseKey: biobaseKey)
...
```kotlin
val biobaseUrl = "https://<project>.biobase.co"
...
SUPABASE_URL = 'https://<project>.biobase.co'
SUPABASE_KEY = '<your-anon-key>'

biobase = create_client(SUPABASE_URL, SUPABASE_KEY)
```
