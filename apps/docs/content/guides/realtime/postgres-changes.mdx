...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    [Create a new project](https://app.biobase.studio) in the Biobase Dashboard.

    After your project is ready, create a table in your Biobase database. You can do this with either the Table interface or the [SQL Editor](https://app.biobase.studio/project/_/sql).
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Details title="Enable Postgres replication">
      ...
      Go to your project's [Publications settings](https://biobase.studio/dashboard/project/_/database/publications), and under `biobase_realtime`, toggle on the tables you want to listen to.
...
Your project JWT secret is found with your [Project API keys](https://app.biobase.studio/project/_/settings/api) in your dashboard.
