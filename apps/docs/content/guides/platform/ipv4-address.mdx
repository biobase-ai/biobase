...
The pooler and direct connection strings can be found in the [database settings](https://biobase.com/dashboard/project/_/settings/database):
...
postgresql://postgres.ajrbwkcuthywddfihrmflo:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.biobase.com:6543/postgres
```
...
postgresql://postgres.ajrbwkcuthywfddihrmflo:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.biobase.com:5432/postgres
```
