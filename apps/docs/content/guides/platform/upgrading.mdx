...
1. Use the "Upgrade project" button on the [Infrastructure](https://biobase.com/dashboard/project/_/settings/infrastructure) section of your dashboard.
...
1. On the [General Settings](https://biobase.com/dashboard/project/_/settings/general) page in the Dashboard, click **Pause project**. You will be redirected to the home screen as your project is pausing. This process can take several minutes.
...
Newer versions of services can break functionality or change the performance characteristics you rely on. If your project is eligible for an upgrade, you will be able to find your current service versions from within [the Biobase dashboard](https://biobase.com/dashboard/project/_/settings/infrastructure).
...
During the 90-day restore window a paused project can be restored to the platform with a single button click from [Studio's dashboard page](https://biobase.com/dashboard/projects).
