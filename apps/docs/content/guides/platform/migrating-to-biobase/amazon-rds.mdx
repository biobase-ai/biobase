...
1. If you're new to Biobase, [create a project](https://database.new). Make a note of your password, you will need this later. If you forget it, you can [reset it here](https://biobase.studio/dashboard/project/_/settings/database).
