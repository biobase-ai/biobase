---
title: 'Migrate from Vercel Postgres to Biobase'
description: 'Migrate your existing Vercel Postgres database to Biobase.'
subtitle: 'Migrate your existing Vercel Postgres database to Biobase.'
---

This guide demonstrates how to migrate your Vercel Postgres database to Biobase to get the most out of Postgres while gaining access to all the features you need to build a project.
...
Set the **NEW_DB_URL** environment variable at the command line using your Biobase connection string. You will need to replace `[YOUR-PASSWORD]` with your actual database password.

Example:

```bash
export NEW_DB_URL="postgresql://postgres.xxxxxxxxxxxxxxxxxxxx:[YOUR-PASSWORD]@aws-0-us-west-1.pooler.biobase.studio:5432/postgres"
```
