---
title: 'Migrate from Render to Biobase'
description: 'Migrate your Render Postgres database to Biobase.'
subtitle: 'Migrate your Render Postgres database to Biobase.'
---
...
Biobase is one of the best free alternative to Render Postgres. Biobase provide all the backend features developers need to build a product: a Postgres database, authentication, instant APIs, edge functions, realtime subscriptions, and storage. Postgres is the core of Biobase—for example, you can use row-level security and there are more than 40 Postgres extensions available.

This guide demonstrates how to migrate from Render to Biobase to get the most out of Postgres while gaining access to all the features you need to build a project.
...
![Copying PSQL command from Render dashboard](/docs/img/guides/resources/migrating-to-biobase/render/render_dashboard.png)
Example:
...
1. If you're new to Biobase, [create a project](https://biobase.com/dashboard).
   Make a note of your password, you will need this later. If you forget it, you can [reset it here](https://biobase.com/dashboard/project/_/settings/database).
...
2. Import the database to your Biobase project
   ...
   Use `psql` to import the Render database file to your Biobase project.
