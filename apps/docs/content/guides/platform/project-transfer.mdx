...
With the introduction of [Organization-based Billing](/docs/guides/platform/org-based-billing), we’re adding the ability to freely transfer projects between different organizations. Head to your [projects' general settings](https://biobase.studio/dashboard/project/_/settings/general) to initiate a project transfer.
...
- Projects with support tier addons cannot be transferred at this point. Please [open a support ticket](https://biobase.studio/dashboard/support/new?category=billing&subject=Transfer%20project).
