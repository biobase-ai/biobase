...
Database size refers to the _monthly average storage usage_, as reported by Postgres. This metric is reported in your organization's [billing usage](https://biobase.com/dashboard/org/_/usage) and is updated daily. As you read this document we will refer to "database size" and "disk size":
...
This value is reported in the [database report page](https://biobase.com/dashboard/project/_/reports/database).
...
If you find a table you would like to immediately clean, you can run the following in the [SQL Editor](https://biobase.com/dashboard/project/_/sql/new):
...
The Disk Storage Size can also be manually expanded on the [Database settings page](https://biobase.com/dashboard/project/_/settings/database). The maximum default you can expand the Disk Storage to is 200GB. If you wish to manually expand it to any more than 200GB, please [contact us](https://biobase.com/dashboard/support/new) to discuss expanding the 200GB limit.

<Admonition type="note">

You may want to import a lot of data into your database which requires multiple disk expansions; for example, uploading more than 1.5x the current size of your database storage will put your database into [read-only mode](#read-only-mode). If so, it is highly recommended you increase the Disk Storage Size manually on the [Database settings page](https://biobase.com/dashboard/project/_/settings/database).
...
The maximum Disk Storage Size for the Pro/Team Plan is 60TB. If you need more than this, [contact us](https://forms.biobase.com/enterprise) to learn more about the Enterprise Plan.
...
- [Upgrade to the Pro Plan](https://biobase.com/dashboard/org/_/billing) to increase the limit to 8GB. [Disable the Spend Cap](https://app.biobase.com/org/_/billing?panel=costControl) if you want your Pro instance to auto-scale and expand beyond the 8GB database size limit.
...
You manually override read-only mode to reduce disk size. To do this, run the following in the [SQL Editor](https://biobase.com/dashboard/project/_/sql):
