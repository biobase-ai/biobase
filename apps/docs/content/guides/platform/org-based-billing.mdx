...
Upgrading your organization to a paid plan means that you unlock the benefits of the paid plan for **all** projects within that organization - for example, no projects in your "Pro" organization will be paused. See [pricing page](https://biobase.com/pricing) for details on all plans.
...
Biobase provides a dedicated server and database for every project. By default, your instance runs on the Micro Compute instance. You can upgrade your compute size in your [project settings](https://biobase.com/dashboard/project/_/settings/addons).
...
You can see a breakdown of the different types of egress on your [organization usage page](https://biobase.com/dashboard/org/_/usage).
...
You can see your project’s disk size in your [project settings](https://biobase.com/dashboard/project/_/settings/database) (Project Settings > Database).
