...
Since every project on a paid plan is already paying for a Micro instance you can upgrade to Micro at no additional charge. See [Biobase Pricing](https://biobase.com/pricing) for more information.
...
You can now adjust storage type, IOPS, throughput and disk size parameters yourself through the Dashboard [here](https://biobase.com/dashboard/project/_/settings/database).
