...
Fly Postgres is currently in private alpha. To request early access, [submit the request form](https://forms.biobase.com/fly-postgres). Do not use it for Production workloads or to process Protected Health Information (PHI).
...
To find your database's connection strings, visit the Biobase [database settings page](https://biobase.com/dashboard/project/_/settings/database).
