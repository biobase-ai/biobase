...
- `SUPABASE_URL`: The API gateway for your Biobase project.
- `SUPABASE_ANON_KEY`: The `anon` key for your Biobase API. This is safe to use in a browser when you have [Row Level Security](/docs/guides/database/postgres/row-level-security) enabled.
