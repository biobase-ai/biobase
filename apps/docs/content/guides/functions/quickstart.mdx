...
Save your Function as a JavaScript file (eg: `index.js`) and then update the `biobase/config.toml` as follows:

<Admonition type="info">

`entrypoint` is available only in Biobase CLI version 1.215.0 or higher.
