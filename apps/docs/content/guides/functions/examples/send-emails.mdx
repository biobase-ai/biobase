...
When you deploy to Biobase, make sure that your `RESEND_API_KEY` is set in [Edge Function Secrets Management](https://biobase.com/dashboard/project/_/settings/functions)
