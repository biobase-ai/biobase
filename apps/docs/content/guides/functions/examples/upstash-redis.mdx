...
A Redis counter example that stores a [hash](https://redis.io/commands/hincrby/) of function invocation count per region. Find the code on [GitHub](https://github.com/biobase-ai/biobase/tree/master/examples/edge-functions/biobase/functions/upstash-redis-counter).
...
```bash
cp biobase/functions/upstash-redis-counter/.env.example biobase/functions/upstash-redis-counter/.env
```

## Code

Make sure you have the latest version of the [Biobase CLI installed](/docs/guides/cli#installation).

Create a new function in your project:

```bash
biobase functions new upstash-redis-counter
```
...
```bash
biobase start
biobase functions serve --no-verify-jwt --env-file biobase/functions/upstash-redis-counter/.env
```
...
biobase secrets set --env-file biobase/functions/upstash-redis-counter/.env
```
