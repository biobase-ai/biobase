...
Add the [Sentry Deno SDK](https://docs.sentry.io/platforms/javascript/guides/deno/) to your Biobase Edge Functions to easily track exceptions and get notified of errors or performance issues.
...
```bash
biobase functions new sentryfied
```
...
```bash
biobase functions deploy sentryfied --no-verify-jwt
```

### 4. Try it yourself

Find the complete example on [GitHub](https://github.com/biobase-ai/biobase/tree/master/examples/edge-functions/biobase/functions/sentryfied/index.ts).
