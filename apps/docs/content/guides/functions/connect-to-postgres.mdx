...
- Download the SSL certificate from [Database settings](https://biobase.com/dashboard/project/_/settings/database)

- In your [local .env file](https://biobase.com/docs/guides/functions/secrets), add these two variables:
