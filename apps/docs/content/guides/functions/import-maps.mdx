...
There are two ways to manage your dependencies in Biobase Edge Functions:

### Using deno.json (recommended)

<Admonition type="info">

This feature requires Biobase CLI version 1.215.0 or higher.
...
```json biobase/functions/my-function/deno.json
{
  "imports": {
...
The import map should be placed in the `/biobase/functions` folder and will be applied to all functions:
...
import_map = "./biobase/functions/my-function/custom_import_map.json"
```
...
Biobase Edge Functions support several ways to import dependencies:
...
This feature requires Biobase CLI version 1.207.9 or higher.

</Admonition>

Create a `.npmrc` file within `biobase/functions`. This will allow you to import the private packages into multiple functions. Alternatively, you can place the `.npmrc` file directly inside `biobase/functions/function-name` directory.)
