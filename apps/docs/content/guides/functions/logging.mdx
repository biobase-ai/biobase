...
You can access both tools from the [Functions section](https://biobase.com/dashboard/project/_/functions) of the Dashboard. Select your function from the list, and click `Invocations` or `Logs`:
...
Request headers: {
    ...
    "x-forwarded-host": "edge-runtime.biobase.com",
