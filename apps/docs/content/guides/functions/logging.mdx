...
You can access both tools from the [Functions section](https://biobase.studio/dashboard/project/_/functions) of the Dashboard. Select your function from the list, and click `Invocations` or `Logs`:
...
Request headers: {
    ...
    "cf-worker": "biobase.co",
    "content-length": "20",
    "content-type": "application/x-www-form-urlencoded",
    "host": "edge-runtime.biobase.studio",
    ...
    "x-forwarded-host": "edge-runtime.biobase.studio",
