...
- Check your function logs. Navigate to the [Functions section](https://biobase.com/dashboard/project/_/functions) in your dashboard, select your function from the list, and click `Logs`. Check for any errors or warnings that may indicate the cause of the problem.
...
- Navigate to the [Functions section](https://biobase.com/dashboard/project/_/functions) in your dashboard, select your function from the list, and click `Logs`.
