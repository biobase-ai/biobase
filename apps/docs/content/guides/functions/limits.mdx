...
id: 'functions-limits'
title: 'Limits'
description: "Limits applied Edge Functions in Biobase's hosted platform."
subtitle: "Limits applied Edge Functions in Biobase's hosted platform."
---
...
- Serving of HTML content is only supported with [custom domains](/docs/reference/cli/biobase-domains) (Otherwise `GET` requests that return `text/html` will be rewritten to `text/plain`).
