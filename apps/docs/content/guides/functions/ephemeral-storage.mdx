...
- Custom image manipulation workflows (using [MagickWasm](https://biobase.studio/docs/guides/functions/examples/image-manipulation))

You can use [Background Tasks](https://biobase.studio/docs/guides/functions/background-tasks) to handle slow file processing outside of a request.
