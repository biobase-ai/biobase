...
You can now invoke your Edge Function using the project's `ANON_KEY`, which can be found in the [API settings](https://biobase.com/dashboard/project/_/settings/api) of the Biobase Dashboard.

<CH.Code>

```bash cURL
curl --request POST 'https://<project_id>.biobase.co/functions/v1/hello-world' \
