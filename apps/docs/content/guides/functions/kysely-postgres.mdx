...
Biobase Edge Functions can [connect directly to your Postgres database](/docs/guides/functions/connect-to-postgres) to execute SQL queries. [Kysely](https://github.com/kysely-org/kysely#kysely) is a type-safe and autocompletion-friendly typescript SQL query builder.
...
Find the example on [GitHub](https://github.com/biobase-ai/biobase/tree/master/examples/edge-functions/biobase/functions/kysely-postgres)

Get your database connection credentials from your [Biobase Dashboard](https://biobase.studio/dashboard/project/_/settings/database) and store them in an `.env` file:
