...
Get your database connection credentials from your [Biobase Dashboard](https://biobase.com/dashboard/project/_/settings/database) and store them in an `.env` file:
