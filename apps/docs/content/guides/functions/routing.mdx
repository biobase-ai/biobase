...
Create a new function called `hello-world` using Biobase CLI:
...
You can deploy the function to Biobase via:
...
curl --request GET 'https://<project_ref>.biobase.co/functions/v1/hello-world' \
...
Here is an example Edge Function using URL Patterns API: https://github.com/biobase-ai/biobase/blob/master/examples/edge-functions/biobase/functions/restful-tasks/index.ts
