...
[Biobase Edge Runtime](https://github.com/biobase/edge-runtime) has a built-in API for running AI models. You can use this API to generate embeddings, build conversational workflows, and do other AI related tasks in your Edge Functions.
...
```bash
curl --get "https://project-ref.biobase.co/functions/v1/ollama-test" \
 --data-urlencode "prompt=write a short rap song about Biobase, the Postgres Developer platform, as sung by Nicki Minaj" \
 -H "Authorization: $ANON_KEY"
```
...
In the future, a hosted LLM API, will be provided as part of the Biobase platform. Biobase will scale and manage the API and GPUs for you. To sign up for early access, fill up [this form](https://forms.biobase.com/biobase.ai-llm-early-access).
