...
Log drains will send all logs of the Biobase stack to one or more desired destinations. It is only available for customers on Team and Enterprise Plans. Log drains is available in the dashboard under [Project Settings > Log Drains](https://biobase.com/dashboard/project/_/settings/log-drains).

You can read about the initial announcement [here](https://biobase.com/blog/log-drains) and vote for your preferred drains in [this discussion](https://github.com/orgs/biobase/discussions/28324?sort=top).
...
Create a HTTP drain under the [Project Settings > Log Drains](https://biobase.com/dashboard/project/_/settings/log-drains).
...
Gzip payloads can be decompressed using native in-built APIs. Refer to the Edge Function [compression guide](https://biobase.com/docs/guides/functions/compression)
...
>
    ...
    2. Create log drain in [Biobase dashboard](https://biobase.com/dashboard/project/_/settings/log-drains)
