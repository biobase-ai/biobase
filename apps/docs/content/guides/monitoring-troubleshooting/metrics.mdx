...
The pre-configured Biobase Grafana Dashboard is an advanced version of the [Dashboard's Database Reports](https://biobase.com/dashboard/project/_/reports/database). It visualizes over 200 database performance and health metrics and is updated every minute.
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Details title="Add your credentials">
        - To monitor a single project, add your service_role key from the [API Settings](https://biobase.com/dashboard/project/_/settings/api) and Reference ID from the [General Settings](https://biobase.com/dashboard/project/_/settings/general).
        - To monitor multiple projects, create an [account access token](https://biobase.com/dashboard/account/tokens) and add it to your `.env` file.
...
<StepHikeCompact>
    ...
    <StepHikeCompact.Details title="Add your credentials and deploy">
        Add your service_role key from the [API Settings](https://biobase.com/dashboard/project/_/settings/api) and Reference ID from the [General Settings](https://biobase.com/dashboard/project/_/settings/general) to your Grafana credentials. Then install your dashboard.
    </StepHikeCompact.Details>
    <StepHikeCompact.Code>
