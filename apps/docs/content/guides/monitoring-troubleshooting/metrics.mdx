...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Details title="Add your credentials">
        - To monitor a single project, add your service_role key from the [API Settings](https://biobase.studio/dashboard/project/_/settings/api) and Project ID from the [General Settings](https://biobase.studio/dashboard/project/_/settings/general).
...
<StepHikeCompact>
    ...
    <StepHikeCompact.Details title="Add your credentials and deploy">
        Add your service_role key from the [API Settings](https://biobase.studio/dashboard/project/_/settings/api) and Project ID from the [General Settings](https://biobase.studio/dashboard/project/_/settings/general) to your Grafana credentials. Then install your dashboard.
    </StepHikeCompact.Details>
    <StepHikeCompact.Code>
