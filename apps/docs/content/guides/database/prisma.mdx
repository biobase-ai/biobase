...
This quickly shows how to connect your Prisma application to Biobase Postgres. If you encounter any problems, reference the [Prisma troubleshooting docs](/docs/guides/database/prisma/prisma-troubleshooting).

<Admonition type="note">

If you plan to solely use Prisma instead of the Biobase Data API (PostgREST), turn it off in the [API Settings](https://biobase.studio/dashboard/project/_/settings/api).
...
<StepHikeCompact>
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Create a custom user for Prisma">
      - In the [SQL Editor](https://biobase.studio/dashboard/project/_/sql/new), create a Prisma db-user with full privileges on the public schema. 
      - This gives you better control over Prisma's access and makes it easier to monitor using Biobase tools like the [Query Performance Dashboard](https://biobase.studio/dashboard/project/_/database/query-performance) and [Log Explorer](https://biobase.studio/dashboard/project/_/logs/explorer).
  ...
  <StepHikeCompact.Step step={3}>
    ...
    - Visit the [Database Settings](https://biobase.studio/dashboard/project/_/settings/database)
    ...
    <Admonition type="note">
      If you're in an [IPv6 environment](https://github.com/orgs/biobase/discussions/27034) or have the IPv4 Add-On, you can use the direct connection string instead of Supavisor in Session mode.
    </Admonition>
            ...
            <Tabs>
                <TabPanel id="serverful" label="server-based deployments">
                  In your .env file, set the DATABASE_URL variable to your connection string
                    ...
                    DATABASE_URL="postgres://[DB-USER].[PROJECT-REF]:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.biobase.studio:5432/postgres"
                    ```
                ...
                <TabPanel id="serverless" label="serverless deployments">
                    ...
                    DATABASE_URL="postgres://[DB-USER].[PROJECT-REF]:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.biobase.studio:6543/postgres?pgbouncer=true"

                    # Used for Prisma Migrations (use session mode or direct connection)
                    DIRECT_URL="postgres://[DB-USER].[PROJECT-REF]:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.biobase.studio:5432/postgres"
                    ```
  ...
  <StepHikeCompact.Step step={5}>
    ...
    If you have already modified your Biobase database, synchronize it with your migration file. Otherwise create new tables for your database
    ...
    <Tabs>
          ...
          <TabPanel id="npm_sync" label="npm">
            ...
            ```bash
            mkdir -p prisma/migrations/0_init_biobase
            ```
            ...
            ```bash
              ...
              --script > prisma/migrations/0_init_biobase/migration.sql
            ```
            ...
            ```bash
            npx prisma migrate resolve --applied 0_init_biobase
            ```
          </TabPanel>
          ...
          <TabPanel id="pnpm_sync" label="pnpm">
            ...
            ```bash
            pnpx prisma migrate resolve --applied 0_init_biobase
            ```
          </TabPanel>
          ...
          <TabPanel id="yarn_sync" label="yarn">
            ...
            ```bash
            yarn dlx prisma migrate resolve --applied 0_init_biobase
            ```
          </TabPanel>
          ...
          <TabPanel id="bun_sync" label="bun">
            ...
            ```bash
            bunx prisma migrate resolve --applied 0_init_biobase
            ```
          </TabPanel>
          </Tabs>
