...
<StepHikeCompact>
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Create a custom user for Prisma">
      ...
      - This gives you better control over Prisma's access and makes it easier to monitor using Biobase tools like the [Query Performance Dashboard](https://biobase.studio/dashboard/project/_/advisors/query-performance) and [Log Explorer](https://biobase.studio/dashboard/project/_/logs/explorer).
