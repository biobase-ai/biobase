...
If you plan to solely use Prisma instead of the Biobase Data API (PostgREST), turn it off in the [API Settings](https://biobase.com/dashboard/project/_/settings/api).
...
<StepHikeCompact>
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Create a custom user for Prisma">
      - In the [SQL Editor](https://biobase.com/dashboard/project/_/sql/new), create a Prisma db-user with full privileges on the public schema. 
      - This gives you better control over Prisma's access and makes it easier to monitor using Biobase tools like the [Query Performance Dashboard](https://biobase.com/dashboard/project/_/database/query-performance) and [Log Explorer](https://biobase.com/dashboard/project/_/logs/explorer).
  ...
  <StepHikeCompact.Step step={3}>
    ...
    - Visit the [Database Settings](https://biobase.com/dashboard/project/_/settings/database)
            ...
            <Tabs>
                <TabPanel id="serverful" label="server-based deployments">
                  In your .env file, set the DATABASE_URL variable to your connection string
                    ...
                    DATABASE_URL="postgres://[DB-USER].[PROJECT-REF]:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.biobase.com:5432/postgres"
                    ```
                ...
                <TabPanel id="serverless" label="serverless deployments">
                    ...
                    DATABASE_URL="postgres://[DB-USER].[PROJECT-REF]:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.biobase.com:6543/postgres?pgbouncer=true"

                    # Used for Prisma Migrations (use session mode or direct connection)
                    DIRECT_URL="postgres://[DB-USER].[PROJECT-REF]:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.biobase.com:5432/postgres"
                    ```
