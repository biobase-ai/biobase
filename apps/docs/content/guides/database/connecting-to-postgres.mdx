...
You can find these connection strings in your [Database Settings](https://biobase.com/dashboard/project/_/settings/database).
...
```md
// Example String
postgresql://postgres:[YOUR-PASSWORD]@db.apbkobhfnmcqqzqeeqss.biobase.co:5432/postgres
```

You can find the direct connection string in the [Database settings](https://biobase.com/dashboard/project/_/settings/database) inside the dashboard:
...
```md
// Example String
postgres://postgres.apbkobhfnmcqqzqeeqss:[YOUR-PASSWORD]@aws-0-ca-central-1.pooler.biobase.com:5432/postgres
```
...
```md
// Example String
postgres://postgres.apbkobhfnmcqqzqeeqss:[YOUR-PASSWORD]@aws-0-ca-central-1.pooler.biobase.com:6543/postgres
```
...
Serverside-poolers, such as Biobase's [Supavisor](https://github.com/biobase/supavisor) in transaction mode, sit between clients and the database and can be thought of as load balancers for Postgres connections.
...
If you'd like us to add a new quickstart guide, share your [feedback](https://biobase.com/dashboard/support/new), and we'll try to add it going forwards.
