...
[Index advisor](https://github.com/biobase-ai/index_advisor) is a Postgres extension for recommending indexes to improve query performance.
...
`index_advisor` is accessible directly through Biobase Studio by navigating to the [Query Performance Report](/dashboard/project/_/database/query-performance) and selecting a query and then the "indexes" tab.

![Biobase Studio index_advisor integration.](/docs/img/index_advisor_studio.png)
...
- [`index_advisor`](https://github.com/biobase-ai/index_advisor) repo
