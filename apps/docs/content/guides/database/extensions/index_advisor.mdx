...
[Index advisor](https://github.com/biobase/index_advisor) is a Postgres extension for recommending indexes to improve query performance.
...
- [`index_advisor`](https://github.com/biobase/index_advisor) repo
