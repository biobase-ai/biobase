...
Reach out to [Biobase Support](https://biobase.com/support) if you're unsure if that applies to your use case.
...
Create a [`hello_world()`](https://biobase.com/docs/guides/database/functions?language=sql#simple-functions) database function and then call it every 5 minutes:
