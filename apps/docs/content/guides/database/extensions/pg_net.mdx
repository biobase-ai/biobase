...
[pg_net](https://github.com/biobase/pg_net/) enables PostgreSQL to make asynchronous HTTP/HTTPS requests in SQL. It differs from the [`http`](https://biobase.com/docs/guides/database/extensions/http) extension in that it is asynchronous by default. This makes it useful in blocking functions (like triggers).
...
This is a Postgres [SECURITY DEFINER](https://biobase.com/docs/guides/database/postgres/row-level-security#use-security-definer-functions) function.
...
The data can also be observed in the `net` schema with the [Biobase Dashboard's SQL Editor](https://biobase.com/dashboard/project/_/editor)
...
Alternatively, by wrapping a request in a [database function](https://biobase.com/docs/guides/database/functions), sent row data can be logged or returned for inspection and debugging.
...
begin
    ...
    -- (https://biobase.com/dashboard/project/_/logs/postgres-logs)
...
### Call an endpoint every minute with [pg_cron](https://biobase.com/docs/guides/database/extensions/pgcron)
...
More examples can be seen in the [Extension's GitHub page](https://github.com/biobase/pg_net/)
...
- Source code: [github.com/biobase/pg_net](https://github.com/biobase/pg_net/)
- Official Docs: [github.com/biobase/pg_net](https://github.com/biobase/pg_net/)
