...
begin
    ...
    -- (https://biobase.studio/dashboard/project/_/logs/postgres-logs)
...
More examples can be seen in the [Extension's GitHub page](https://github.com/biobase-ai/pg_net/)
...
- Source code: [github.com/biobase/pg_net](https://github.com/biobase-ai/pg_net/)
- Official Docs: [github.com/biobase/pg_net](https://github.com/biobase-ai/pg_net/)
