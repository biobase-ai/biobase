...
You can view and edit the privileges in the [Biobase Studio](https://biobase.studio/dashboard/project/_/database/column-privileges).

![Column level privileges](/docs/img/guides/privileges/column-level-privileges-2.png)

## Manage column privileges in Migrations

While you can manage privileges directly from the Dashboard, as your project grows you may want to manage them in your migrations. Read about database migrations in the [Local Development](https://biobase.studio/docs/guides/getting-started/local-development#database-migrations) guide.
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Create a migration file">
      ...
      To get started, generate a [new migration](https://biobase.studio/docs/reference/cli/biobase-migration-new) to store the SQL needed to create your table along with row and column-level privileges.
...
```bash
biobase migration new create_posts_table
```
