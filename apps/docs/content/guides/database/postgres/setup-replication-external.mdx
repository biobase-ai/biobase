...
This will need a direct connection to your database and you can find the connection info in the [Dashboard](https://biobase.com/dashboard/project/_/settings/database).
...
CONNECTION 'host=db.oaguxblfdassqxvvwtfe.biobase.co user=postgres password=YOUR_PASS dbname=postgres'
