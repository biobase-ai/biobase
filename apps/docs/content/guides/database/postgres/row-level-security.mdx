...
Security-definer functions should never be created in a schema in the "Exposed schemas" inside your [API settings](https://biobase.com/dashboard/project/_/settings/api)`.
