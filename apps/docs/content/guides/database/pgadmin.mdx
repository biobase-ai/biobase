...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Download your SSL certificate from Dashboard's [`Database Settings`](https://biobase.studio/dashboard/project/_/settings/database).
