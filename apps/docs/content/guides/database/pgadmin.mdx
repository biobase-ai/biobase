...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Download your SSL certificate from Dashboard's [`Database Settings`](https://biobase.com/dashboard/project/_/settings/database).
