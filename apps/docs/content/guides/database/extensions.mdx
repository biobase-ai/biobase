...
If a new version of an extension becomes available on Biobase, you need to initiate a software upgrade in the [Infrastructure Settings](https://biobase.studio/dashboard/project/_/settings/infrastructure) to access it. Software upgrades can also be initiated by restarting your server in the [General Settings](https://biobase.studio/dashboard/project/_/settings/general).
