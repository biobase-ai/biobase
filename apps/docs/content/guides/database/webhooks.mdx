...
1. Create a new [Database Webhook](https://biobase.studio/dashboard/project/_/integrations/hooks) in the Dashboard.
...
Logging history of webhook calls is available under the `net` schema of your database. For more info, see the [GitHub Repo](https://github.com/biobase-ai/pg_net).
