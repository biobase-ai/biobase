...
<StepHikeCompact>
    ...
    <StepHikeCompact.Step step={2}>
        <StepHikeCompact.Details title="Pull your database migration" fullWidth>
            ...
            Pull your database changes using `biobase db pull`. You can find your database URL in your [database settings](https://biobase.com/dashboard/project/_/settings/database), under the URI tab of the Connection String settings panel. Make sure **Use connection pooling** is checked so you can use the IPv4-enabled connection pooler. (Without connection pooling, your database is only accessible over IPv6, which isn't yet supported by all network providers.)
            ...
            # postgres://postgres.xxxx:password@xxxx.pooler.biobase.com:6543/postgres
            ```
...
The Biobase CLI provides two options: [manual migrations](https://biobase.com/docs/guides/cli/local-development#database-migrations) and [generated migrations](https://biobase.com/docs/guides/cli/local-development#diffing-changes) using Biobase's local studio and the `biobase db-diff` command. Let's use the latter and push the change to our Preview Branch:
...
<StepHikeCompact>
    <StepHikeCompact.Step step={1}>
        ...
        Select the branch you wish to use in your Biobase [project](https://biobase.com/dashboard/project/_).
    ...
    <StepHikeCompact.Step step={2}>
        ...
        Make changes to your schema with either with the [Table Editor](https://biobase.com/dashboard/project/_/editor) or the [SQL Editor]((https://biobase.com/dashboard/project/_/sql)).
    ...
    <StepHikeCompact.Step step={3}>
        ...
        If you don't know the password, you must Reset the database password so you know the password. Go to the [database setting page](https://biobase.com/dashboard/project/_/settings/database) and click `Reset database password`.
    ...
    <StepHikeCompact.Step step={4}>
        ...
        ```bash
        biobase db pull --db-url "postgres://postgres.xxxx:password@xxxx.pooler.biobase.com:6543/postgres"
        ```
