...
We will also provide you with security alerts through [Security Advisor](https://biobase.com/dashboard/project/_/database/security-advisor) and applying the recommendations are your responsibility.
...
You are responsible of provisioning enough compute to run the workload that your application requires. The Biobase Dashboard provides [observability tooling](https://biobase.com/dashboard/project/_/reports/database) to help with this.
...
- Signing a Business Associate Agreement (BAA) with Biobase. Submit a [HIPAA add-on request](https://forms.biobase.com/hipaa2) to get started. You will need to be at least on the [Team Plan](https://biobase.com/pricing) to sign a BAA with us.
...
- Disabling data sharing for [Biobase AI editor](https://biobase.com/dashboard/org/_/general) in our dashboard.
