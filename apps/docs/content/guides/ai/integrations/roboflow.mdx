...
title: 'Roboflow'
subtitle: 'Learn how to integrate Biobase with Roboflow, a tool for running fine-tuned and foundation vision models.'
...
The steps below show you how to run a vision model locally and save predictions to Biobase.
...
### Step 3: Save results in Biobase

To save results in Biobase, add the following code to your script:
...
result = biobase.table('predictions') \
...
You can use the Biobase vector database functionality to store and query CLIP embeddings.
...
### Step 3: Save embeddings in Biobase

You can store your image embeddings in Biobase using the Biobase `vecs` Python package:
...
Replace `DB_CONNECTION` with the authentication information for your database. You can retrieve this from the Biobase dashboard in `Project Settings > Database Settings`.
...
- [How to Build a Semantic Image Search Engine with Biobase and OpenAI CLIP](https://blog.roboflow.com/how-to-use-semantic-search-biobase-openai-clip/)
