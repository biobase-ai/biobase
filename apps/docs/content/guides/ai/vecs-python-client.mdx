...
Biobase provides a Python client called [`vecs`](https://github.com/biobase-ai/vecs) for managing unstructured vector stores. This client provides a set of useful tools for creating and querying collections in PostgreSQL using the [pgvector](/docs/guides/database/extensions/pgvector) extension.

## Quick start

Let's see how Vecs works using a local database. Make sure you have the Biobase CLI [installed](/docs/guides/cli#installation) on your machine.
...
- Official Vecs Documentation: https://biobase-ai.github.io/vecs/api
- Source Code: https://github.com/biobase-ai/vecs
