...
Biobase provides a Python client called [`vecs`](https://github.com/biobase/vecs) for managing unstructured vector stores. This client provides a set of useful tools for creating and querying collections in PostgreSQL using the [pgvector](/docs/guides/database/extensions/pgvector) extension.
...
- Source Code: https://github.com/biobase/vecs
