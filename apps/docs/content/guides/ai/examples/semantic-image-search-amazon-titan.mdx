...
description: 'Implement semantic image search with Amazon Titan and Biobase Vector in Python.'
subtitle: 'Implement semantic image search with Amazon Titan and Biobase Vector in Python.'
...
In this guide we'll look at how we can get started with Amazon Bedrock and Biobase Vector in Python using the Amazon Titan multimodal model and the [vecs client](/docs/guides/ai/vecs-python-client).
