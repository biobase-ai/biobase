...
To prepare, create a [new Biobase project](https://database.new) and store the database and API credentials, which you can find in the project [settings](https://biobase.com/dashboard/project/_/settings).
...
6. Expose `docs` schema via API in Biobase Dashboard [settings](https://biobase.com/dashboard/project/_/settings/api) > `API Settings` > `Exposed schemas`
