...
If you haven't already, [install the Biobase CLI](https://biobase.com/docs/guides/cli), then initialize Biobase in the root of your newly created poetry project:
...
def seed():
    ...
    biobase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)
