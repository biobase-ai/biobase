...
For data science or ephemeral workloads, the [Biobase Vecs](https://biobase.github.io/vecs/) client gets you started quickly. All you need is a connection string and vecs handles setting up your database to store and query vectors with associated metadata.
