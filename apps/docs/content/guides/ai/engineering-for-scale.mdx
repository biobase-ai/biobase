...
Vecs provides methods for querying collections, either using a [cosine similarity function](https://biobase.github.io/vecs/api/#basic) or with [metadata filtering](https://biobase.github.io/vecs/api/#metadata-filtering).
