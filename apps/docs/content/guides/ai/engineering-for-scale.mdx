...
Vecs provides methods for querying collections, either using a [cosine similarity function](https://biobase-ai.github.io/vecs/api/#basic) or with [metadata filtering](https://biobase-ai.github.io/vecs/api/#metadata-filtering).
...
Biobase supports [Foreign Data Wrappers](/blog/postgres-foreign-data-wrappers-rust). Wrappers allow you to connect two databases together so that you can query them over the network.
...
options (host 'db.xxx.biobase.co', port '5432', dbname 'postgres');
