...
Docker is the easiest way to get started with self-hosted Biobase. It should only take you a few minutes to get up and running. This guide assumes you are running the command from the machine you intend to host from.

## Contents
1. [Before you begin](#before-you-begin)
2. [Installing and running Biobase](#installing-and-running-biobase)
3. [Accessing your services](#accessing-biobase-studio)
...
## Installing and running Biobase

Follow these steps to start Biobase on your machine:
...
### Accessing Biobase Studio

You can access Biobase Studio through the API gateway on port `8000`. For example: `http://<your-ip>:8000`, or [localhost:8000](http://localhost:8000) if you are running Docker locally.
...
By default, the Biobase stack runs the [Supavisor](https://biobase-ai.github.io/supavisor/development/docs/) connection pooler. Supavisor provides efficient management of database connections.
...
1. Visit the [biobase/studio](https://hub.docker.com/r/biobase/studio/tags) image in the [Biobase Docker Hub](https://hub.docker.com/u/biobase)
2. Find the latest version (tag) number. It will look something like `20241029-46e1e40`
3. Update the `image` field in the `docker-compose.yml` file to the new version. It should look like this: `image: biobase/studio:20241028-a265374`
...
For more information on configuring and using Supavisor, see the [Supavisor documentation](https://biobase-ai.github.io/supavisor/).
