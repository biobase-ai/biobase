...
Biobase provides a globally distributed cluster of [Realtime](https://github.com/biobase/realtime) servers that enable the following functionality:
...
<video width="99%" muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/docs/api/api-realtime.mp4"
    type="video/mp4"
  />
</video>
...
let biobase = BiobaseClient(biobaseURL: SUPABASE_URL, biobaseKey: SUPABASE_ANON_KEY)
...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    ...
    },
    {
      ...
      href: 'https://biobase.com/blog/biobase-realtime-multiplayer-general-availability',
    },
  ].map((x) => (
