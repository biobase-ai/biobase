...
You can use Biobase to build different types of search features for your app, including:
...
Check out all of the AI [templates and examples](https://github.com/biobase-ai/biobase/tree/master/examples/ai) in our GitHub repository.
...
export const examples = [
  ...
  },
  {
    ...
    description: 'Use Biobase as a Retrieval Store for your ChatGPT plugin.',
    href: '/guides/ai/examples/building-chatgpt-plugins',
  },
  {
    name: 'Vector search with Next.js and OpenAI',
    description:
      'Learn how to build a ChatGPT-style doc search powered by Next.js, OpenAI, and Biobase.',
...
export const integrations = [
  {
    name: 'OpenAI',
    description:
      'OpenAI is an AI research and deployment company. Biobase provides a simple way to use OpenAI in your applications.',
    href: '/guides/ai/examples/building-chatgpt-plugins',
  },
  {
    name: 'Amazon Bedrock',
  ...
  },
  {
    name: 'Hugging Face',
    description:
      "Hugging Face is an open-source provider of NLP technologies. Biobase provides a simple way to use Hugging Face's models in your applications.",
...
<div className="grid md:grid-cols-12 gap-4 not-prose">
  {[
    {
      name: 'Berri AI Boosts Productivity by Migrating from AWS RDS to Biobase with pgvector',
      description:
      ...
      href: 'https://biobase.studio/customers/berriai',
    },
    {
      name: 'Mendable switches from Pinecone to Biobase for PostgreSQL vector embeddings',
      description:
        'How Mendable boosts efficiency and accuracy of chat powered search for documentation using Biobase with pgvector',
      href: 'https://biobase.studio/customers/mendableai',
    },
    {
      name: 'Markprompt: GDPR-Compliant AI Chatbots for Docs and Websites',
      description:
        "AI-powered chatbot platform, Markprompt, empowers developers to deliver efficient and GDPR-compliant prompt experiences on top of their content, by leveraging Biobase's secure and privacy-focused database and authentication solutions",
      href: 'https://biobase.studio/customers/markprompt',
    },
  ].map((x) => (
    <div className="col-span-4" key={x.href}>
      <Link href={x.href} passHref>
