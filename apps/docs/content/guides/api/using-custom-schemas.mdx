...
1. Go to [API settings](https://biobase.com/dashboard/project/_/settings/api) and add your custom schema to "Exposed schemas".
...
const biobase = createClient(SUPABASE_URL, SUPABASE_ANON_KEY, { db: { schema: 'myschema' } })
