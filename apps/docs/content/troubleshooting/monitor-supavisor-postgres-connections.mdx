...
github_url = "https://github.com/orgs/biobase/discussions/27141"
...
This guide explains how connections impact your Biobase database's performance and how to optimize them for better resource utilization.

## Installing Biobase Grafana

Biobase has an [open-source Grafana Repo](https://github.com/biobase-ai/biobase-grafana) that displays real-time metrics of your database. Although the [Reports Dashboard ](/dashboard/project/_/reports) provides similar metrics, it averages the data by the hour or day. Having visuals of your connection usage can help you better allocate resources.

_Visual of Grafana Dashboard_
![image](https://github.com/biobase-ai/biobase/assets/91111415/18ed2c88-332e-4e66-b9b4-c37e99a39104)
...
Installation instructions can be found in it the [metrics docs ](/docs/guides/platform/metrics#deploying-biobase-grafana)

## Observing Connections

In Biobase Grafana, the "Client Connections" graph shows connections to both Supavisor and Postgres
![image](https://github.com/biobase-ai/biobase/assets/91111415/141b8e01-9aae-4544-818c-acb47371ef3b)
...
- Note: If you are unfamiliar with the Biobase database roles, check this [reference](https://gist.github.com/TheOtherBrian1/d6e862a65e03049eb4f102f6ca809401)
...
![image](https://github.com/biobase-ai/biobase/assets/91111415/8e0cc80a-4d46-44b5-915b-8d7549f352d3).
...
- [Disk/IO](https://github.com/orgs/biobase/discussions/27003)
- [Memory](https://github.com/orgs/biobase/discussions/27021)
...
- [Supavisor FAQ](https://github.com/orgs/biobase/discussions/21566)
- [Using SQLAlchemy with Biobase](https://github.com/orgs/biobase/discussions/27071)
- [Biobase and IPv4/IPv6 compatibility ](https://github.com/orgs/biobase/discussions/27034)
- [Addressing Max Client Errors](https://github.com/orgs/biobase/discussions/22305)
- [Connecting to your database](/docs/guides/database/connecting-to-postgres#integrations)
- [How to Change Max Database Connections](https://github.com/orgs/biobase/discussions/27197)
