...
Alternatively, you can run the following snippet in your project's [SQL Editor](https://biobase.studio/dashboard/project/_/sql/new). This will create a `countries` table with some sample data.
