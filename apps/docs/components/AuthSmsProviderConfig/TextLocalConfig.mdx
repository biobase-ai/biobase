...
- **A Biobase project**: Necessary for SMS authentication integration. Create your project in the [Biobase Dashboard](https://biobase.com/dashboard).
...
1. In your Biobase Dashboard, go to the [Auth Providers section](https://biobase.com/dashboard/project/_/auth/providers).
