...
- **A Biobase project**: Necessary for SMS authentication integration. Create your project in the [Biobase Dashboard](https://biobase.studio/dashboard).
...
To set up Textlocal as your SMS provider in Biobase, follow these steps:

1. In your Biobase Dashboard, go to the [Auth Providers section](https://biobase.studio/dashboard/project/_/auth/providers).
