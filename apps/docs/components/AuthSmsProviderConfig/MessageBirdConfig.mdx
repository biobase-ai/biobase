...
- A Biobase project (create one [here](https://biobase.com/dashboard))
...
Now go to the [Auth > Providers](https://biobase.com/dashboard/project/_/auth/providers) page in the Biobase dashboard and select "Phone" from the Auth Providers list.
...
Go to [Auth > Templates](https://biobase.com/dashboard/project/_/auth/templates) page in the Biobase dashboard.
