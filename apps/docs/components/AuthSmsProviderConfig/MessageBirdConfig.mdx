...
- A Biobase project (create one [here](https://biobase.studio/dashboard))
...
Now go to the [Auth > Providers](https://biobase.studio/dashboard/project/_/auth/providers) page in the Biobase dashboard and select "Phone" from the Auth Providers list.
...
Go to [Auth > Templates](https://biobase.studio/dashboard/project/_/auth/templates) page in the Biobase dashboard.
