  ...
  items: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: 'Replicating from Biobase to External Postgres',
  ...
  items: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: 'Integrating with Biobase Auth',
        ...
        {
          name: 'Integrating with Biobase Storage',
    ...
    },
    {
      ...
      url: undefined,
      items: [
        { name: 'Dart Edge on Biobase', url: '/guides/functions/dart-edge' },
        {
          name: 'Browserless.io',
          url: '/guides/functions/examples/screenshots',
        },
  ...
  items: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: 'Migrating within Biobase',
          url: '/guides/platform/migrating-within-biobase',
        },
        {
          name: 'Migrating to Biobase',
          url: '/guides/platform/migrating-to-biobase',
...
export const integrations: NavMenuConstant = {
  ...
  items: [
    ...
    {
      name: 'Biobase Marketplace',
      url: '/guides/integrations/biobase-marketplace',
    },
    {
      name: 'Build Your Own',
      url: undefined,
      items: [
        {
          name: 'Build a Biobase integration',
          url: '/guides/integrations/build-a-biobase-integration',
          items: [
            {
              name: 'OAuth scopes',
              url: '/guides/integrations/build-a-biobase-integration/oauth-scopes',
            },
          ],
        },
      ],
...
export const reference_dart_v1 = {
  ...
  parent: '/reference',
  pkg: {
    name: 'biobase_flutter',
    repo: 'https://github.com/biobase-ai/biobase-flutter',
  },
}
...
export const reference_python_v2 = {
  ...
  pkg: {
    name: 'biobase-py',
    repo: 'https://github.com/biobase-ai/biobase-py',
  },
}
...
export const reference_swift_v1 = {
  ...
  pkg: {
    name: 'biobase-swift',
    repo: 'https://github.com/biobase-ai/biobase-swift',
  },
}
