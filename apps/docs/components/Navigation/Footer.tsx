      ...
      <div className="flex gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button type="text" asChild>
            <a
              href="https://github.com/biobase-ai/biobase"
              target="_blank"
              rel="noreferrer noopener"
            >
          ...
          <Button type="text" asChild>
            ...
            <a href="https://youtube.com/c/biobase" target="_blank" rel="noreferrer noopener">
              <svg
                width="16"
                height="17"
                viewBox="0 0 16 17"
          ...
          <Button type="text" asChild>
            <a href="https://twitter.com/biobase" target="_blank" rel="noreferrer noopener">
