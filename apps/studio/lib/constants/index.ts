...
export const LOCAL_STORAGE_KEYS = {
  ...
  SQL_EDITOR_INTELLISENSE: 'biobase_sql-editor-intellisense-enabled',
  SQL_EDITOR_SPLIT_SIZE: 'biobase_sql-editor-split-size',
  SQL_EDITOR_AI_PANEL_SPLIT_SIZE: 'biobase_sql-editor-ai-panel-split-size',
  ...
  SQL_EDITOR_AI_SCHEMA: (ref: string) => `biobase_sql-editor-ai-schema-enabled-${ref}`,
  SQL_EDITOR_AI_OPEN: 'biobase_sql-editor-ai-open',
  LOG_EXPLORER_SPLIT_SIZE: 'biobase_log-explorer-split-size',
  ...
  PROJECT_LINT_IGNORE_LIST: 'biobase-project-lint-ignore-list',
  QUERY_PERF_SHOW_BOTTOM_SECTION: 'biobase-query-perf-show-bottom-section',
  // Key to track account deletion requests
  ACCOUNT_DELETION_REQUEST: 'biobase-account-deletion-request',
  // Used for storing a user id when sending reports to Sentry. The id is hashed for anonymity.
  SENTRY_USER_ID: 'biobase-sentry-user-id',
  // Used for storing the last sign in method used by the user
  LAST_SIGN_IN_METHOD: 'biobase-last-sign-in-method',
  ...
  SHOW_AI_NOT_OPTIMIZED_WARNING: (ref: string) => `biobase-show-ai-not-optimized-${ref}`,
  ...
  EXPAND_NAVIGATION_PANEL: 'biobase-expand-navigation-panel',
  GITHUB_AUTHORIZATION_STATE: 'biobase-github-authorization-state',
  // Notice banner keys
  AUTH_SMTP_CHANGES_WARNING: 'auth-smtp-changes-warning-dismissed',

  AUTH_USERS_COLUMNS_CONFIGURATION: (ref: string) => `biobase-auth-users-columns-${ref}`,
  AUTH_EMAIL_WARNING_BANNER_ACKNOWLEDGE: (ref: string) =>
    `biobase-auth-email-warning-banner-${ref}`,
}
