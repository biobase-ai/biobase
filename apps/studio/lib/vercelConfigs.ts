...
under https://vercel.com/dashboard/biobase/integrations/console
...
insert into posts (slug, title, content, "authorId", "parentId") values ('threaded-comments-123', 'threaded-comments', 'Threaded comments, built on top of Biobase and Next.js. Visit GitHub to deploy your own: https://github.com/lawrencecchen/threaded-comments', '00000000-0000-0000-0000-000000000000'::uuid, 1);
...
commit;
alter publication biobase_realtime add table posts, sites, votes, profiles;
