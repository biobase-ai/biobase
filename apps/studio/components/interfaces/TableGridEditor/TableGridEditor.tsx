...
const TableGridEditor = ({
  ...
  /** [Joshen] We're going to need to refactor BiobaseGrid eventually to make the code here more readable
   * For context we previously built the BiobaseGrid as a reusable npm component, but eventually decided
