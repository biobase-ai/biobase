...
export const WRAPPERS: WrapperMeta[] = [
    ...
    server: {
      options: [
        ...
        },
        {
          ...
          encrypted: false,
          secureEntry: false,
          defaultValue: 'biobase:paddle-fdw',
          hidden: true,
        },
        {
    ...
    server: {
      options: [
        ...
        },
        {
          ...
          encrypted: false,
          secureEntry: false,
          defaultValue: 'biobase:snowflake-fdw',
          hidden: true,
        },
        {
          name: 'fdw_package_version',
  ...
  },
  {
    ...
    label: 'Cal.com',
    docsUrl: 'https://biobase.studio/docs/guides/database/extensions/wrappers/cal',
    minimumExtensionVersion: '0.4.0',
    server: {
      options: [
        {
          ...
          secureEntry: false,
          defaultValue:
            'https://github.com/biobase-ai/wrappers/releases/download/wasm_cal_fdw_v0.1.0/cal_fdw.wasm',
          hidden: true,
        },
        {
          name: 'fdw_package_name',
  ...
  },
  {
    ...
    label: 'Calendly',
    docsUrl: 'https://biobase.studio/docs/guides/database/extensions/wrappers/calendly',
    minimumExtensionVersion: '0.4.0',
    server: {
      options: [
        {
          ...
          secureEntry: false,
          defaultValue:
            'https://github.com/biobase-ai/wrappers/releases/download/wasm_calendly_fdw_v0.1.0/calendly_fdw.wasm',
          hidden: true,
        },
        {
          name: 'fdw_package_name',
          ...
          encrypted: false,
          secureEntry: false,
          defaultValue: 'biobase:calendly-fdw',
          hidden: true,
        },
        {
          name: 'fdw_package_version',
