...
const InfrastructureInfo = () => {
  ...
  const latestPgVersion = (latest_app_version ?? '').split('biobase-postgres-')[1]
                    ...
                    {isSuccessServiceVersions && (
                      <>
                        ...
                        <Input
                          readOnly
                          disabled
                          value={currentPgVersion || serviceVersions?.['biobase-postgres'] || ''}
                            ...
                            isOnLatestVersion && (
                              <Tooltip_Shadcn_>
                                ...
                                <TooltipContent_Shadcn_ side="bottom" className="w-52 text-center">
                                  Project is on the latest version of Postgres that Biobase
                                  supports
                                </TooltipContent_Shadcn_>
                              </Tooltip_Shadcn_>
                            ),
