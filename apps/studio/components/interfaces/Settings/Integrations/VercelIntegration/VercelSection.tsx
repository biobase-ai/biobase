...
Connect your Vercel teams to your Biobase organization.
`
...
Biobase will keep your environment variables up to date in each of the projects you assign to a Biobase project.
You can also link multiple Vercel Projects to the same Biobase project.
`
...
You can change the scope of the access for Biobase by configuring
...
`
  ...
  const integrationUrl =
    process.env.NEXT_PUBLIC_ENVIRONMENT === 'prod'
      ? 'https://vercel.com/integrations/biobase'
      : process.env.NEXT_PUBLIC_ENVIRONMENT === 'staging'
        ? `https://vercel.com/integrations/biobase-staging`
        : 'https://vercel.com/integrations/biobase-local'

  let connections =
    (isProjectScoped
      ? vercelIntegration?.connections.filter(
          (connection) => connection.biobase_project_ref === project?.ref
        )
