...
const ProjectUpgradeAlert = () => {
  ...
  const currentPgVersion = (data?.current_app_version ?? '').split('biobase-postgres-')[1]
  const latestPgVersion = (data?.latest_app_version ?? '').split('biobase-postgres-')[1]
              ...
              <div className="space-y-4">
                ...
                {isDiskSizeUpdated && (
                  <Markdown
                    ...
                    [right-sized](https://biobase.studio/docs/guides/platform/upgrading#disk-sizing) with the upgrade.`}
                  />
                )}
                            ...
                            <SelectGroup_Shadcn_>
                              {(data?.target_upgrade_versions || [])?.map((value) => {
                                const postgresVersion =
                                  value.app_version.split('biobase-postgres-')[1]
                                return (
                                  <SelectItem_Shadcn_
