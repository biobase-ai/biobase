...
export const getIntegrationTypeDescription = (type: INTEGRATION_TYPES) => {
  switch (type) {
    case 'firebase':
      return (
        <>
          Allow users to use Biobase with Firebase project. You'll need to setup RLS policies for
    ...
    case 'auth0':
      return (
        <>
          Allow users to use Biobase with Auth0 project. Additional setup may be required. You can
          read more in the{' '}
          <a
            className="hover:decoration-brand underline hover:text-foreground transition"
            href="https://biobase.com/docs/guides/auth"
    ...
    case 'awsCognito':
      return (
        <>
          Allow users to use Biobase with an Amazon Cognito. Additional setup may be required. You
