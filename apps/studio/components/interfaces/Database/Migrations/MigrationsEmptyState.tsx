  ...
  const commands = [
    {
      ...
      command: `biobase link --project-ref ${ref}`,
      jsx: () => {
        return (
          <>
            <span className="text-brand-600">biobase</span> link --project-ref {ref}
          </>
        )
      },
    },
    {
      ...
      command: `biobase migration new new-migration`,
      jsx: () => {
        return (
          <>
            <span className="text-brand-600">biobase</span> migration new new-migration
          </>
        )
      },
    },
    {
      ...
      command: `biobase db push`,
      jsx: () => {
        return (
          <>
            <span className="text-brand-600">biobase</span> db push
          </>
        )
      },
    },
