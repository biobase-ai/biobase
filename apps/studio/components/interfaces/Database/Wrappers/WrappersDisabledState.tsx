...
const WrappersDisabledState = () => {
  ...
  const vaultExtension = (data ?? []).find((ext) => ext.name === 'biobase_vault')
      ...
      >
        <div className="w-3/5 space-y-8">
          <div className="space-y-2">
            <h4 className="text-lg">Biobase Wrappers</h4>
            <p className="text-sm text-foreground-light">
              Biobase Wrappers is a framework for building Postgres Foreign Data Wrappers (FDW)
