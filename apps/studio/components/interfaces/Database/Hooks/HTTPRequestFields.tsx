...
interface HTTPRequestFieldsProps {
  type: 'http_request' | 'biobase_function'
  errors: any
      ...
      >
        <FormSectionContent loading={false} className="lg:!col-span-8">
          ...
          {type === 'http_request' ? (
            ...
            />
          ) : type === 'biobase_function' && edgeFunctions.length === 0 ? (
            ...
            <Listbox id="http_url" name="http_url" label="Select which edge function to trigger">
              {edgeFunctions.map((fn) => {
                ...
                const functionUrl = `https://${ref}.biobase.${restUrlTld}/functions/v1/${fn.slug}`
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center">
              <Button
                ...
                size="tiny"
                icon={<Plus />}
                className={clsx(type === 'biobase_function' && 'rounded-r-none px-3')}
                onClick={onAddHeader}
              >
                Add a new header
              </Button>
