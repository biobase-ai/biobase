...
>(({ closable = false, removeBorder = false, ...props }, ref) => {
  ...
  const commands: Commands[] = [
    {
      command: 'biobase functions new hello-world',
      description: ' creates a function stub at ./functions/hello-world/index.ts',
      jsx: () => {
        return (
          <>
            <span className="text-brand-600">biobase</span> functions new hello-world
          </>
        )
      },
    ...
    {
      command: `biobase functions deploy hello-world --project-ref ${projectRef}`,
      description: 'Deploys function at ./functions/hello-world/index.ts',
      jsx: () => {
        return (
          <>
            <span className="text-brand-600">biobase</span> functions deploy hello-world
