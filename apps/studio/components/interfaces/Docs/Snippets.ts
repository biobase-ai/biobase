...
`,
  ...
  subscribeAll: (listenerName: string, resourceId: string) => ({
    ...
    js: {
      language: 'js',
      code: `
const ${listenerName} = biobase.channel('custom-all-channel')
  .on(
    'postgres_changes',
  ...
  subscribeInserts: (listenerName: string, resourceId: string) => ({
    ...
    js: {
      language: 'js',
      code: `
const ${listenerName} = biobase.channel('custom-insert-channel')
  .on(
    'postgres_changes',
  ...
  subscribeUpdates: (listenerName: string, resourceId: string) => ({
    ...
    js: {
      language: 'js',
      code: `
const ${listenerName} = biobase.channel('custom-update-channel')
  .on(
    'postgres_changes',
  ...
  subscribeDeletes: (listenerName: string, resourceId: string) => ({
    ...
    js: {
      language: 'js',
      code: `
const ${listenerName} = biobase.channel('custom-delete-channel')
  .on(
    'postgres_changes',
  ...
  subscribeEq: (listenerName: string, resourceId: string, columnName: string, value: string) => ({
    ...
    js: {
      language: 'js',
      code: `
const ${listenerName} = biobase.channel('custom-filter-channel')
  .on(
    'postgres_changes',
...
`,
    ...
    js: {
      language: 'js',
      code: `
let { data, error } = await biobase.auth.signUp({
  email: 'someone@email.com',
  password: '${randomPassword}'
})
`,
...
`,
    ...
    js: {
      language: 'js',
      code: `
let { data, error } = await biobase.auth.signInWithPassword({
  email: 'someone@email.com',
  password: '${randomPassword}'
})
`,
...
`,
    ...
    js: {
      language: 'js',
      code: `
let { data, error } = await biobase.auth.signInWithOtp({
  email: 'someone@email.com'
})
`,
    },
...
`,
    ...
    js: {
      language: 'js',
      code: `
let { data, error } = await biobase.auth.verifyOtp({
  phone: '+13334445555',
  token: '123456',
  type: 'sms'
})
...
`,
    ...
    js: {
      language: 'js',
      code: `
let { data, error } = await biobase.auth.admin.inviteUserByEmail('someone@email.com')
`,
    },
  }),
...
`,
    ...
    js: {
      language: 'js',
      code: `
let { data, error } = await biobase.auth.signInWithOAuth({
  provider: 'github'
})
`,
    },
...
`,
    ...
    js: {
      language: 'js',
      code: `
let { data, error } = await biobase.auth.resetPasswordForEmail(email)
`,
    },
  }),
...
`,
    ...
    js: {
      language: 'js',
      code: `
let { error } = await biobase.auth.signOut()
`,
    },
  }),
}
