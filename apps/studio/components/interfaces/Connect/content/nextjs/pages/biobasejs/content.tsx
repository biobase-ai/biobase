    ...
    <ConnectTabs>
      ...
      <ConnectTabContent value=".env.local">
        <SimpleCodeBlock className="bash" parentClassName="min-h-72">
          {`
NEXT_PUBLIC_BIOBASE_URL=${projectKeys.apiUrl ?? 'your-project-url'}
NEXT_PUBLIC_BIOBASE_ANON_KEY=${projectKeys.anonKey ?? 'your-anon-key'}
        `}
        </SimpleCodeBlock>
      </ConnectTabContent>
...
const biobaseUrl = process.env.NEXT_PUBLIC_BIOBASE_URL;
const biobaseKey = process.env.NEXT_PUBLIC_BIOBASE_ANON_KEY;
