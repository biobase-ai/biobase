    ...
    <ScaffoldSection>
      ...
      <ScaffoldSectionContent>
        ...
        <ConfirmationModal
          visible={isOpen}
          size="large"
          title="Non-Disclosure Agreement to access Biobase's SOC2 Report"
        ...
        >
          <ol className="list-decimal list-inside text-sm text-foreground-light pl-30">
            ...
            <li>
              ...
              contained in the agreement between Biobase, Inc ("Biobase", "we", "our" or "us") and
              the Biobase customer that has authorized you to access our platform to obtain this
