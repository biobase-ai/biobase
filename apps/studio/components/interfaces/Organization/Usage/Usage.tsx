      ...
      {selectedProjectRef ? (
        <ScaffoldContainer className="mt-5">
          <Admonition
            ...
            description={`You are currently viewing usage for the "${selectedProject?.name || selectedProjectRef}" project. Biobase uses organization-level billing and quotas. For billing purposes, we sum up usage from
