    ...
    <Collapsible_Shadcn_ open={open} onOpenChange={setOpen} className={cn('mt-4', className)}>
      ...
      <CollapsibleContent_Shadcn_>
        <div className="space-y-2 py-4 text-sm text-foreground-light">
          <p>
            Biobase AI is a chatbot support tool powered by OpenAI. Biobase will share the query
            you submit and information about the databases you manage through Biobase with OpenAI,
            L.L.C. and its affiliates in order to provide the Biobase AI tool.
          </p>
          <p>
          ...
          <p>
            If you have your own individual account on Biobase, we will use any personal
            information collected through [Biobase AI] to provide you with the [Biobase AI] tool.
          ...
          <p>
            Biobase collects information about the queries you submit through Biobase AI and the
            responses you receive to assess the performance of the Biobase AI tool and improve our
