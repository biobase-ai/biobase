    ...
    <div className="flex flex-col h-full border-l border-control">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip_Shadcn_>
                    ...
                    <TooltipContent_Shadcn_ className="w-72" side="right">
                      Select specific schemas to send with your queries. Biobase AI can use this
            ...
            >
                ...
                <Alert_Shadcn_>
                  <AlertDescription_Shadcn_ className="flex flex-col gap-4">
                    <span>
                      ...
                      opting into sending anonymous data, Biobase AI can improve the answers it
                      shows you.
                    </span>
                    <Button
                      type="default"
              ...
              {isFirstUserMessage && includeSchemaMetadata && selectedSchemas.length === 0 && (
                <Alert_Shadcn_>
                  <AlertDescription_Shadcn_ className="flex flex-col gap-4">
                    <span>
                      We recommend including the schemas for better answers by Biobase AI.
                    </span>
                  </AlertDescription_Shadcn_>
                </Alert_Shadcn_>
              )}
      ...
      >
        <p className="text-sm text-foreground-light">
          By opting into sending anonymous data, Biobase AI can improve the answers it shows you.
