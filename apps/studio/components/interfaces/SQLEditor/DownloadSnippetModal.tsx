...
const DownloadSnippetModal = ({ id, ...props }: DownloadSnippetModalProps) => {
  ...
  const SNIPPETS = [
    ...
    },
    {
      ...
      description:
        'If your query consists of sample data, append the snippet to the end of `biobase/seed.sql`',
  ...
  return (
    <Modal
      ...
      showCloseButton
      size="xlarge"
      header={<p>Download snippet as local migration file via the Biobase CLI.</p>}
      {...props}
    >
        ...
        <Modal.Content className="w-full flex items-center justify-between pt-0">
          ...
          <div className="flex justify-between items-center gap-x-2">
            <Button asChild type="default" icon={<ExternalLink strokeWidth={1.5} />}>
              <Link
                href="https://biobase.studio/docs/guides/cli/local-development#database-migrations"
                target="_blank"
                rel="noreferrer"
              >
                About migrations
