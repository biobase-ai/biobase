        ...
        <Head>
          <title>
            {title
              ? `${title} | Biobase`
              : selectedTable
                ? `${selectedTable} | ${projectName} | ${organizationName} | Biobase`
                : projectName
                  ? `${projectName} | ${organizationName} | Biobase`
                  : organizationName
                    ? `${organizationName} | Biobase`
                    : 'Biobase'}
          </title>
 ...
 * But that will come later: https://biobase.slack.com/archives/C01D6TWFFFW/p1650427619665549
 *
