...
export const RESOURCE_WARNING_MESSAGES: Record<string, ResourceWarningMessage> = {
  is_readonly_mode_enabled: {
    ...
    docsUrl: 'https://biobase.studio/docs/guides/platform/database-size#disabling-read-only-mode',
  ...
  disk_io_exhaustion: {
    ...
    docsUrl: 'https://biobase.studio/docs/guides/platform/exhaust-disk-io',
  ...
  cpu_exhaustion: {
    ...
    docsUrl: 'https://biobase.studio/docs/guides/platform/exhaust-cpu',
    buttonText: 'Check usage',
    metric: 'cpu',
  },
  memory_and_swap_exhaustion: {
    ...
    docsUrl: 'https://biobase.studio/docs/guides/platform/exhaust-ram',
    buttonText: 'Check usage',
    metric: 'ram',
  },
  auth_rate_limit_exhaustion: {
    ...
    docsUrl: 'https://biobase.studio/docs/guides/platform/going-into-prod#auth-rate-limits',
  ...
  auth_restricted_email_sending: {
    ...
    docsUrl: 'https://github.com/orgs/biobase/discussions/29370',
