...
const WHITELIST_ERRORS = [
  ...
  'Project creation in the Biobase dashboard is disabled for this Vercel-managed organization.',
  'Your account, which is handled by the Fly Biobase extension, cannot access this endpoint.',
]
...
export async function createProject({
  ...
  const body: components['schemas']['CreateProjectBody'] = {
    ...
    ...(customBiobaseRequest !== undefined && {
      custom_biobase_internal_requests: customBiobaseRequest as any,
    }),
