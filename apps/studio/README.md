...
Project settings are managed outside of the Dashboard. If you use docker compose, you should manage the settings in your docker-compose file. If you're deploying Biobase to your own cloud, you should store your secrets and env vars in a vault or secrets manager.
...
npm run dev:secrets:pull # Biobase internal use: if you are working on the platform version of the Studio
