        ...
        <ScaffoldColumn className="mx-auto w-full max-w-md">
          <header>
            ...
            <Markdown
              ...
              content={`Choose the Biobase organization you wish to install in`}
            />
          </header>
          <CreateProject />
          <Alert withIcon variant="info" title="You can uninstall this Integration at any time.">
            <Markdown
              content={`You can remove this integration at any time via Vercel or the Biobase dashboard.`}
            />
          </Alert>
        </ScaffoldColumn>
      </ScaffoldContainer>
...
const CreateProject = () => {
        ...
        try {
          const { id: connectionId } = await createConnections({
            ...
            connection: {
              ...
              biobase_project_ref: newProjectRef,
              integration_id: '0',
              metadata: {
                ...projectDetails,
                biobaseConfig: {
  ...
  return (
    <div>
      <p className="mb-2">Biobase project details</p>
      <div className="py-2">
        <Input
          autoFocus
          id="projectName"
