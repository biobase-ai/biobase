    ...
    <>
      <ScaffoldContainer className="flex flex-col gap-6 grow py-8">
        <ScaffoldColumn className="mx-auto w-full max-w-md">
          ...
          <>
            <Markdown content={`Choose the Biobase organization you wish to install in`} />
            <OrganizationPicker
              integrationName="Vercel"
            ...
            {noOrganizations && (
              <Alert_Shadcn_ variant="warning">
                <AlertTriangle className="h-4 w-4" strokeWidth={2} />
                <AlertTitle_Shadcn_>
                  No Biobase Organizations to install Integration.
                </AlertTitle_Shadcn_>
      ...
      <ScaffoldContainer className="flex flex-col gap-6 py-3">
        <Alert_Shadcn_ variant="default">
          ...
          <AlertDescription_Shadcn_>
            Remove this integration at any time from Vercel or the Biobase dashboard.
          </AlertDescription_Shadcn_>
        </Alert_Shadcn_>
      </ScaffoldContainer>
    </>
