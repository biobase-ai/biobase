        ...
        {device_code ? (
          <>
            <h1 className="text-xl py-2">
              Your Biobase Account is being used to login on Biobase CLI.
            </h1>
            <p>Enter this verification code on Biobase CLI to authorize login.</p>
            ...
            <Admonition
              type="tip"
              title="Browser login flow requires Biobase CLI version 1.219.0 and above."
              className="mt-16"
            />
          </>
        ) : (
