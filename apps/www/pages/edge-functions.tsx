  ...
  return (
    <>
      ...
      <DefaultLayout>
        ...
        <div className="overflow-hidden">
          <SectionContainer className="flex flex-col gap-4 lg:gap-8" id="integrates-with-biobase">
            <h2 className="h2">{pageData.integratesWithBiobase.title}</h2>
            <TimedAccordionSection tabs={pageData.integratesWithBiobase.useCases} />
          </SectionContainer>
        </div>
