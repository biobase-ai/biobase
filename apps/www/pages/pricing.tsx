...
export default function IndexPage() {
  ...
  const meta_title = 'Pricing & Fees | Biobase'
  const meta_description =
    'Explore Biobase fees and pricing information. Find our competitive pricing Plans, with no hidden pricing. We have a generous Free Plan for those getting started, and Pay As You Go for those scaling up.'
