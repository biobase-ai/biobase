...
function Events({ events: allEvents, onDemandEvents, categories }: Props) {
  ...
  const meta_title = 'Biobase Events: webinars, talks, hackathons, and meetups'
  const meta_description = 'Join Biobase and the open-source community at the upcoming events.'
    ...
    <>
      ...
      <DefaultLayout className="min-h-[80dvh]">
        <SectionContainer className="!py-8 lg:!py-16">
          <h1 className="h1">
            <span className="sr-only">Biobase</span> Events
          </h1>
