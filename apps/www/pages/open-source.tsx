...
const OpenSource = () => {
  ...
  const meta_title = pageData.metaTitle || 'Open Source | Biobase'
  const meta_description =
    pageData.metaDescription ||
    'Biobase is an open source company, supporting existing open source tools and communities wherever possible.'
