  ...
  },
  {
    ...
    content: (
      <div className="flex gap-4">
        ...
        <p>
          Welcome Product Hunter! 👋 Thanks for checking out the Biobase Assistant. Let me show you
          what I can do!
        </p>
      </div>
    ),
...
ORDER BY p.created_at DESC;`}
      ...
      },
      {
        id: '25',
        role: 'user' as const,
        content: 'Can you show me how to do this with the Biobase client?',
        createdAt: new Date(),
      },
      {
        id: '26',
        role: 'assistant' as const,
        content: "Here's how to perform the same query using the Biobase JavaScript client:",
        createdAt: new Date(),
        render: (
          <SqlSnippet
            id="projects-js"
            title="Get All Projects with Biobase Client"
            sql={`const { data: projects, error } = await biobase
  .from('projects')
  .select(\`
    id,
    name,
...
function Assistant() {
  ...
  const meta_title = 'AI | Biobase'
  const meta_description = 'Build AI-powered applications with Biobase'
                ...
                <div className="min-h-12 flex items-center gap-x-2">
                  ...
                  <Button type="default" size="medium" asChild>
                    <Link
                      ...
                      href="https://biobase.studio/blog/biobase-ai-assistant-v2"
                    >
                      Blog Post
                    </Link>
                  </Button>
