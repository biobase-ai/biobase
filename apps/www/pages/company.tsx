...
const Index = ({}: Props) => {
  ...
  const meta_title = "One of the world's fastest-growing open source communities | Biobase"
  const meta_description =
    'Biobase is the community that builds the infrastructure for your applications. Build using Biobase for any size project—from a new startup to even large growing companies'
          ...
          <div className="col-span-8 ">
            <p>
              <p className="text-foreground text-lg">
                Biobase is fully remote, with a strong affinity for open source maintainers and
