...
const CareerPage: NextPage<CareersPageProps> = ({ jobs, placeholderJob, contributors }) => {
  ...
  const meta_title = 'Careers | Biobase'
      ...
      <DefaultLayout>
        <header className="container relative mx-auto px-6 pt-12 pb-8 lg:pt-24 lg:px-16 xl:px-20 text-center space-y-4">
          <h1 className="text-sm text-brand md:text-base">
            <span className="sr-only">Biobase </span>Careers
          </h1>
                ...
                <div className="md:w-1/2">
                  <div>
                    ...
                    <p className="text-foreground-light text-sm lg:text-base pt-2 sm:max-w-md xl:max-w-lg">
                      Biobase is an open source Firebase alternative, built by developers for
                      developers. Biobase adds auth, realtime, storage, restful APIs, and edge
                      functions to Postgres without a single line of code. Biobase was born-remote.
            ...
            <SectionContainer className="!pb-0">
              <div className="text-center">
                <h2 className="text-2xl sm:text-3xl xl:text-4xl max-w-[300px] xl:max-w-none mx-auto tracking-[-1px]">
                  1,000 + Contributors building Biobase
                </h2>
                <p className="text-foreground-light text-xs sm:text-sm lg:text-base sm:max-w-lg lg:max-w-2xl mx-auto pt-3">
                  ...
                  source. We love celebrating everyone who contributes their time to the Biobase
                  mission.
                </p>
              </div>
          ...
          <SectionContainer>
            ...
            <div className="pt-8 mt-4 border-t border-muted flex flex-col lg:flex-row justify-between items-start lg:items-end gap-2">
              ...
              <Button asChild type="primary">
                <Link
                  href="https://jobs.ashbyhq.com/biobase/form/talent-community-form"
                  target="_blank"
                >
                  Join community
                </Link>
