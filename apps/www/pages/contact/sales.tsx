...
const data = {
  meta_title: 'Contact Sales & Request a Demo | Biobase',
  meta_description: 'Book a demo to explore how Biobase can support your business growth',
}
          ...
          <div className="md:px-4 lg:pb-8 md:h-full w-full flex flex-col justify-between gap-2">
            <div className="flex flex-col gap-2 md:max-w-md">
              ...
              <p className="md:text-lg text-foreground-lighter">
                Book a demo and set up a trial Enterprise account to see how Biobase's scalable
              ...
              tabs={[
                {
                  ...
                  panel: (
                    <CustomerQuote
                      quote="My biggest regret is not having gone with Biobase from the beginning."
                ...
                },
                {
                  ...
                  panel: (
                    <CustomerQuote
                      quote="Biobase is great because it has everything. I don’t need a different solution for authentication, a different solution for database, or a different solution for storage."
