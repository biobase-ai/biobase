...
function Database() {
  ...
  const meta_description =
    'With biobase’s APIs and easy to use dashboard, it makes designing relational databases easy.'
    ...
    <>
      ...
      <DefaultLayout>
        ...
        <ProductHeader
          ...
          subheader={[
            'Every Biobase project is a dedicated PostgreSQL database, trusted by millions of developers.',
        ...
        <SectionContainer>
          <div className="grid grid-cols-12">
            <div className="col-span-12 mb-10 lg:col-span-3 lg:mb-0">
              ...
              <p className="p">Every Biobase project is a dedicated Postgres database.</p>
          ...
          <APISection
            ...
            text={[
              <p key={0}>
                ...
                product, while Biobase handles the CRUD.
              </p>,
            ]}
            footer={[
        ...
        <SectionContainer>
          <div className="grid grid-cols-12 lg:gap-16">
            <div className="col-span-12 mb-8 lg:col-span-6 xl:col-span-5">
              ...
              <p className="p">Biobase works natively with Postgres extensions.</p>
              <p className="p">
              ...
              <FeatureColumn
                ...
                text="We only show a few of the extensions supported by Biobase here, but we preinstall many more that you can use right away."
              />
