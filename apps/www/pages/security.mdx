...
export const meta = {
  type: 'lp',
  title: 'Security at Biobase',
  description:
    'Biobase is trusted by thousands of developers for building and deploying secure applications.',
}
...
<div className="container mx-auto px-8 sm:px-16 xl:px-20 grid grid-cols-12 items-center my-8">
  <div className="col-span-12 lg:col-span-6">
    <h1 className="xl:text-5xl mb-4 [&_p]:m-0">Security at Biobase</h1>
...
![Biobase security](/images/security/security-hero.png)
...
Biobase allows users to enable Multi-factor authentication (MFA) on their account.
...
Biobase is SOC2 Type 2 compliant. This is an important security policy when handling sensitive customer data.
...
Members of organizations in Biobase can be granted access to specific resources.
...
Biobase uses [Stripe](https://stripe.com) to process payments and does not store personal credit card information for any of our customers.
...
Biobase works with industry experts to conduct regular penetration tests.
...
Biobase combats Distributed Denial of Service attacks in several ways to mitigate resource abuse and prevent runaway bills.
