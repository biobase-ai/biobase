    ...
    >
      <div className="container grid items-center h-full grid-cols-12 gap-4 px-8 py-20 mx-auto text-foreground-light lg:px-28">
        <div className="col-span-12 text-foreground md:col-span-9 lg:col-span-8 xl:col-span-6">
          <p className="mb-10 text-4xl">Biobase is an open source Firebase alternative.</p>
    ...
    <div className="container grid grid-cols-12 gap-4 px-8 py-20 mx-auto text-foreground-light lg:px-28">
      ...
      <div className="col-span-12 mb-20 text-base text-foreground sm:col-span-9 xl:col-span-6">
        <p>
          ...
          are using Biobase to ship more products, faster.
        </p>
      </div>
      ...
      <div className="container grid grid-cols-12 gap-4 px-8 py-20 mx-auto lg:px-28">
        <div className="col-span-12 mb-10 text-base">
          <p className="text-2xl text-foreground">
            Biobase <span className="text-brand">Beta</span> is starting now.
          </p>
        </div>
                ...
                <div className="w-full sm:w-5/6">
                  {metric.stats.map((stat: any, idx: number) => (
                    <div key={`metric_${metric.key}_${idx}`} className="flex items-center">
                      ...
                      <Bar
                        color={stat.name === 'Biobase' ? 'bg-brand' : 'bg-brand-400'}
      ...
      <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
        ...
        <div className="grid items-center grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            <p className="mb-10">
              We started Biobase to give developers a web-ready database that is delightful to use,
            ...
            <p className="text-foreground-light">
              ...
              of improvement for the tools which we support at Biobase.
            </p>
          </div>
          ...
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            <p className="mb-10">
              ...
              million rows. The Biobase database and API used are each running on AWS EC2 t3a.micro
              instances.
            </p>
            <p className="mb-10">
              Biobase is available in 7 different geographic regions. We're adding more regions as
            ...
            <p>
              One of our key metrics at Biobase is "Time to Value". How fast can a user go from
              sign up, to making their first API request? How fast can they go from development to
              production? We've built several case studies on our blog, demonstrating how Biobase
    ...
    <div id="newFeaturesAndIntegrations" className="bg-surface-100">
      <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
        ...
        <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            <p className="mb-5">
              If you're new to Biobase, here's a few of the things you get when you choose us as
              your backend.
            </p>
            <ul>
              <li className="mb-10">
                ...
                <p className="mb-5">
                  If you're new to Biobase, here's a few of the things you get when you choose us
              ...
              <li className="mb-10">
                ...
                <p>
                  ...
                  over websockets, receiving your data in realtime. Companies are using Biobase to
    ...
    <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          ...
          <ul className="mb-10 ml-6 list-disc list-outside">
            <li className="mb-5">
              To continue offering free Biobase instances for Students, Hobbyists, and Early
              Adopters
            </li>
            <li className="mb-5">
    ...
    <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          ...
          <p className="mb-10">
            Biobase is a collection of many projects, and we rely on making contributors to help us
          ...
          <p className="mb-10">
            Every dollar that is given to Biobase in{' '}
            <a
              href="https://github.com/sponsors/biobase/"
              target="_blank"
              className="text-brand hover:text-brand"
            >
              sponsorship
          ...
          <p className="mb-10">
            ...
            <a
              href="/blog/2020/12/02/biobase-striveschool"
              target="_blank"
              className="text-brand hover:text-brand"
            >
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          ...
          <p>
            Follow us on{' '}
            <a
              href="https://twitter.com/biobase"
              target="_blank"
              className="text-brand hover:text-brand"
            >
              Twitter
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          ...
          <p className="mb-10">
            ...
            work full time on the products we use, and we spend every Friday dogfooding Biobase to
            make it better.
          </p>
          <p>
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          <p className="mb-5">
            ...
            night!). We're constantly improving Biobase based on user feedback. Alongside
          ...
          <ul className="mb-10 ml-6 list-disc list-outside">
            ...
            <li className="mb-5">
              Functions - write and deploy serverless functions that have access to your Biobase
              context
            </li>
            <li className="mb-5">
            ...
            <li className="mb-5">
              Multicloud - Spread your Biobase instances across multiple datacenter providers to
            ...
            <li>
              ...
              and help us bring Biobase to your favorite language or framework.
            </li>
          </ul>
          <p className="mb-10">
            ...
            or join the{' '}
            <a
              href="https://github.com/biobase-ai/biobase/discussions"
              target="_blank"
              className="text-brand hover:text-brand"
            >
              discussion
