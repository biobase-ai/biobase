        ...
        <SectionContainer>
          <div className="grid grid-cols-12">
            <div className="col-span-12 mb-10 lg:col-span-3 lg:mb-0">
              ...
              <p className="p">
                Integrates well with the rest of Biobase ecosystem, including Auth and Postgres.
              </p>
            </div>
            ...
            footer={
              <>
                ...
                <ExampleCard
                  ...
                  repo_url={
                    'https://github.com/biobase-ai/biobase/tree/master/examples/user-management/nextjs-user-management'
                  }
                  vercel_deploy_url={
                    'https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fbiobase%2Fbiobase%2Ftree%2Fmaster%2Fexamples%2Fuser-management%2Fnextjs-user-management&project-name=biobase-nextjs-user-management&repository-name=biobase-nextjs-user-management&integration-ids=oac_VqOgBHqhEoFTPzGkPd7L0iH6&external-id=https%3A%2F%2Fgithub.com%2Fbiobase%2Fbiobase%2Ftree%2Fmaster%2Fexamples%2Fuser-management%2Fnextjs-user-management'
                  }
                  demo_url={''}
                />
              </>
