...
const addons = [
  {
    ...
    ctaLink: 'https://biobase.com/docs/guides/platform/spend-cap',
    ctaTarget: '_blank',
  },
  {
    ...
    ctaLink: 'https://biobase.com/docs/guides/platform/custom-domains',
    ctaTarget: '_blank',
  },
  {
    id: 'addon-pitr',
    ...
    ctaText: 'Documentation',
    ctaLink: 'https://biobase.com/docs/guides/platform/backups',
    ctaTarget: '_blank',
  },
]
