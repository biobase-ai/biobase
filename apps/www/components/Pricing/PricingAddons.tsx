...
const addons = [
  {
    ...
    ctaLink: 'https://biobase.studio/docs/guides/platform/spend-cap',
    ctaTarget: '_blank',
  },
  {
    ...
    description:
      'Use your own domain for your Biobase project to present a branded experience to your users.',
    ctaText: 'Documentation',
    ctaLink: 'https://biobase.studio/docs/guides/platform/custom-domains',
    ctaTarget: '_blank',
  },
  {
    id: 'addon-pitr',
    ...
    ctaText: 'Documentation',
    ctaLink: 'https://biobase.studio/docs/guides/platform/backups',
    ctaTarget: '_blank',
  },
]
    ...
    <div>
      <div className="text-center">
        ...
        <p className="text-foreground-light mt-4 mb-8 lg:mb-16 text-lg">
          Go beyond your Plan limits and level up your Biobase experience
        </p>
      </div>
