...
const cards: CardInterface[] = [
  ...
  },
  {
    ...
    quote:
      'We decided to use Biobase over other specialized vector databases because it enabled us to be GDPR compliant from day one with little effort.',
    image: vectorImagesDir + 'biobase+mendable.svg',
    abstract: 'Markprompt and Biobase - GDPR-Compliant AI Chatbots for Docs and Websites.',
  ...
  },
  {
    ...
    image: vectorImagesDir + 'biobase+markprompt.svg',
