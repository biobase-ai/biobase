...
const AuthVisual: React.FC<Props> = ({ className }) => {
  return (
    <figure
      ...
      role="img"
      aria-label="Biobase Authentication provides Row Level Security which enables you to define custom Policies to restrict access to your database"
    >
      <Image
        src="/images/index/products/auth.svg"
        alt="Biobase Authentication user db rows"
        fill
        sizes="100%"
        priority
        quality={100}
