    ...
    case 'tiny':
      return (
        ...
        >
          ...
          <span className="">Migrating to Biobase Auth / Good Tape</span>
    ...
    case 'small':
      return (
        ...
        >
          ...
          <span className="py-1">Migrating to Biobase Auth / Good Tape</span>
        ...
        <Link href={EVENT_LINK} className={cn('w-full', className)} {...props}>
          ...
          >
            ...
            <div className="flex flex-col gap-2 md:gap-3 flex-grow max-w-xl xl:justify-center">
              ...
              <p>Learn how to reduce costs while maintaining top-tier security with Biobase</p>
