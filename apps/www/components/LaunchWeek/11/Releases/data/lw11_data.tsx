...
const days: (isDark?: boolean) => WeekDayProps[] = (isDark = true) => [
  {
    ...
    title: 'Biobase is officially launching into General Availability',
    description: 'Biobase is officially launching into General Availability',
    links: [
      {
        type: 'xSpace',
        href: 'https://biobase.link/twitter-space-ga',
      },
    ],
    steps: [
      {
  ...
  },
  {
    ...
    isToday: false,
    hasCountdown: false,
    blog: '/blog/ai-inference-now-available-in-biobase-edge-functions',
    date: '16 April',
    published_at: '2024-04-16T08:00:00.000-07:00',
    title: 'Biobase Functions now supports AI models',
    description: (
      <>
        Biobase Functions now supports <strong>AI models</strong>
      </>
    ),
    links: [
      {
        type: 'blog',
        href: '/blog/ai-inference-now-available-in-biobase-edge-functions',
      },
      {
        type: 'video',
        href: 'w4Rr_1whU-U',
      ...
      {
        type: 'xSpace',
        href: 'https://biobase.link/twitter-space-ga-week-2',
      },
    ],
    steps: [
      {
  ...
  },
  {
    ...
    description: (
      <>
        Biobase Auth now supports <strong>Anonymous sign-ins</strong>
      </>
    ),
    links: [
      {
      ...
      {
        type: 'xSpace',
        href: 'https://biobase.link/twitter-space-ga-week-3',
      },
    ],
    steps: [
      {
  ...
  },
  {
    ...
    description: (
      <>
        Biobase Storage: now supports the <strong>S3 protocol</strong>
      </>
    ),
    links: [
      {
      ...
      {
        type: 'xSpace',
        href: 'https://biobase.link/twitter-space-ga-week-4',
      },
    ],
    steps: [
      {
  ...
  },
  {
    ...
    description: (
      <>
        Biobase <strong>Security Advisor</strong> & <strong>Performance Advisor</strong>
      </>
    ),
    links: [
      {
      ...
      {
        type: 'xSpace',
        href: 'https://biobase.link/twitter-space-ga-week-5',
      },
    ],
    steps: [
      {
