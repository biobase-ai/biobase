...
const days: WeekDayProps[] = [
    ...
    steps: [
      {
        ...
        blog: '/blog/why-biobase-remote',
        bg_layers: [{ img: images['00-stay-remote'] }],
        steps: [],
      },
      {
        title: 'Postgres Language Server',
        github: 'https://github.com/biobase-ai/postgres_lsp',
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Hugging Face now supported in Biobase',
        blog: '/blog/hugging-face-biobase',
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Biobase Local Dev: Migrations, Branching, Observability',
        blog: '/blog/biobase-local-dev',
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Biobase Studio 3.0',
        blog: '/blog/biobase-studio-3-0',
        hackernews: '',
        video: '',
  ...
  },
  {
    ...
    twitter_spaces: 'https://twitter.com/biobase/status/1688544207571484672?s=20',
    steps: [
      {
        title: 'Biobase Integrations Marketplace',
        blog: '/blog/biobase-integrations-marketplace',
        bg_layers: [{ img: images['04-marketplace'], mobileImg: images['04-marketplace-mobile'] }],
        steps: [],
      },
      {
        title: 'Vercel integrations',
        blog: '/blog/using-biobase-with-vercel',
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Biobase Supavisor: 1M Postgres connections',
