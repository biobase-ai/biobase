...
const days: WeekDayProps[] = [
  {
    ...
    description: (
      <>
        Biobase Studio: introducing an <strong>AI Assistant</strong>,{' '}
  ...
  },
  {
    ...
    d: 3,
    dd: 'Wed',
    title: 'Biobase Branching',
    shipped: true,
    hasCountdown: false,
    blog: '/blog/biobase-branching',
    date: '13 Dec',
    published_at: '2023-12-13T08:00:00.000-08:00',
    description: (
      <>
        Introducing Biobase <strong>Branching</strong>, a Postgres database for every pull request
      </>
    ),
    links: [
      {
        type: 'blog',
        href: '/blog/biobase-branching',
      },
      {
        type: 'video',
        href: 'peXKxavGnBo',
  ...
  },
  {
    ...
    shipped: true,
    hasCountdown: false,
    blog: '/blog/biobase-auth-identity-linking-hooks',
    date: '14 Dec',
    published_at: '2023-12-14T08:00:00.000-08:00',
    description: (
      <>
        Biobase Auth: <strong>Identity Linking</strong>, <strong>Session Control</strong>,{' '}
    ...
    links: [
      {
        type: 'blog',
        href: '/blog/biobase-auth-identity-linking-hooks',
      },
      {
        type: 'video',
        href: 'LF8GABnAFyE',
