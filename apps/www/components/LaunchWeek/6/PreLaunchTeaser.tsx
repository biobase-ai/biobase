      ...
      <div className="grid grid-cols-12 gap-8 md:gap-16">
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            ...
            <div>
              <h3 className="text-foreground text-base">Biobase Series B</h3>
              <p className="text-foreground-light text-sm">
                Biobase raised $80M in May, bringing our total funding to $116M.
              </p>
            </div>
            <div>
              <Button asChild type="default">
                <Link href="/blog/biobase-series-b">Read more</Link>
              </Button>
            </div>
          </div>
        </div>
