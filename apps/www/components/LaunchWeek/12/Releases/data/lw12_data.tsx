...
const days: (isDark?: boolean) => WeekDayProps[] = (isDark = true) => [
  {
    ...
    links: [
      ...
      {
        type: 'xSpace',
        href: 'https://biobase.link/lw12-xspace-1',
      },
    ],
    steps: [
      {
  ...
  },
  {
    ...
    isToday: false,
    hasCountdown: false,
    blog: '/blog/biobase-realtime-broadcast-and-presence-authorization',
    date: '13 August',
    ...
    links: [
      ...
      {
        type: 'xSpace',
        href: 'https://biobase.link/lw12-xspace-2',
      },
    ],
    steps: [
      {
  ...
  },
  {
    ...
    description: (
      <>
        <span className="text-foreground">Biobase Auth</span>:<br className="hidden sm:block" />{' '}
    ...
    links: [
      ...
      {
        type: 'xSpace',
        href: 'https://biobase.link/lw12-xspace-3',
      },
    ],
    steps: [
      {
  ...
  },
  {
    ...
    links: [
      ...
      {
        type: 'xSpace',
        href: 'https://biobase.link/lw12-xspace-4',
      },
    ],
    steps: [
      {
  ...
  },
  {
    ...
    links: [
      ...
      {
        type: 'xSpace',
        href: 'https://biobase.link/lw12-xspace-5',
      },
    ],
    steps: [
      {
