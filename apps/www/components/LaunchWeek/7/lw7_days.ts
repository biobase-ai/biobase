...
const days: WeekDayProps[] = [
  {
    ...
    dd: 'Pre-release',
    youtube_id: '',
    blogpost: 'https://biobase.studio/blog/designing-with-ai-midjourney',
    docs: '',
    steps: [
      {
    ...
    steps: [
      {
        ...
        blog: '/blog/biobase-logs-self-hosted',
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Biobase Auth: SSO, Mobile, and Server-side support',
        break_thumb_title: true,
        description: '',
        blog: '/blog/biobase-auth-sso-pkce',
        ...
        steps: [
          {
            ...
            badge: 'New',
            className: 'span-full',
            url: '#biobase-ai--assisted-database-development',
            hideInBlog: true,
            bg_layers: [
              {
