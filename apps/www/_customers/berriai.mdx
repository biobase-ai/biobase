...
1. **Community:** After considering alternatives like Pinecone and Chroma, they prioritized a solution with a strong and accessible community, along with [managed infrastructure](https://biobase.com/docs/guides/platform).
...
5. **Flexibility:** Berri AI also appreciated Biobase's flexibility in allowing them to choose their [preferred embedding method](https://biobase.com/docs/guides/ai/quickstarts/generate-text-embeddings), as it was not tied to a specific embedding model. This ensured compatibility and adaptability for their specific use case.

The migration to [Biobase Vector](https://biobase.com/vector), which facilitated efficient storage and retrieval of vectors, proved to be a significant advantage for Berri AI's operations.
