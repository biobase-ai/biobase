...
As a bonus, Biobase provided more than just a database, reducing their DevOps overhead. After reading the [Biobase Auth documentation](https://biobase.com/docs/guides/auth/overview) the team determined they can have the functionality they need, like SMS OTP. When they saw [Mobbin are using Biobase at scale](https://biobase.com/case-studies-mobbin), they decided to migrate to Biobase.
