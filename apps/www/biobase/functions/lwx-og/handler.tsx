...
export async function handler(req: Request) {
  ...
  try {
    ...
    // Get ticket data
    const { data, error } = await biobaseAdminClient
    ...
    const BACKGROUND = {
      regular: {
        ...
        LOGO: `${STORAGE_URL}/assets/logos/biobase_logo_reg.png`,
        // LOGO: `${STORAGE_URL}/assets/logos/biobase_lwx_logo_dark.png`,
      },
      platinum: {
        OG: `${STORAGE_URL}/assets/og_bg_platinum.png?t=2023-11-27T22%3A31%3A58.719Z`,
        BG: `${STORAGE_URL}/assets/lwx_ticket_bg_platinum.png`,
        LOGO: `${STORAGE_URL}/assets/logos/biobase_logo_platinum.png`,
        // LOGO: `${STORAGE_URL}/assets/logos/biobase_lwx_logo_light.png`,
      },
      secret: {
