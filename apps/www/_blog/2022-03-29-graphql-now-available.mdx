...
- [New Features in pg_graphql v1.2](https://biobase.com/blog/whats-new-in-pg-graphql-v1-2)

</div>

GraphQL support is now in general availability on the Biobase platform via our [open source](https://github.com/biobase/pg_graphql/) PostgreSQL extension, [`pg_graphql`](https://biobase.github.io/pg_graphql/).
...
```bash
curl -X POST https://<PROJECT_REF>.biobase.co/graphql/v1 \
    -H 'apiKey: <API_KEY>'\
...
To enable GraphQL in your Biobase instance, enable `pg_graphql` from the [dashboard](https://biobase.com/dashboard/).

<video width="99%" autoPlay muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/marketing/blog/launch-week-4/api-enable-graphql.mp4"
    type="video/mp4"
  />
</video>
...
The GraphQL endpoint is available at: `https://<project_ref>.biobase.co/graphql/v1`
...
🎁  Get the code on GitHub here: [github.com/biobase-community/biobase-graphql-example](https://github.com/biobase-community/biobase-graphql-example)
...
Didn't see the feature you're interested in? [Let us know](https://github.com/biobase/pg_graphql/issues)

## More pg_graphql

- [Introducing pg_graphql: A GraphQL extension for PostgreSQL](https://biobase.com/blog/pg-graphql)
- [pg_graphql v1.0](https://biobase.com/blog/pg-graphql-v1)
- [pg_graphql v1.2](https://biobase.com/blog/whats-new-in-pg-graphql-v1-2)
