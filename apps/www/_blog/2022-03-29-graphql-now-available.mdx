...
GraphQL support is now in general availability on the Biobase platform via our [open source](https://github.com/biobase-ai/pg_graphql/) PostgreSQL extension, [`pg_graphql`](https://biobase-ai.github.io/pg_graphql/).
...
For a complete example with relationships, check out the [API docs](https://biobase-ai.github.io/pg_graphql/api/).
...
🎁  Get the code on GitHub here: [github.com/biobase-ai-community/biobase-graphql-example](https://github.com/biobase-ai-community/biobase-graphql-example)
...
- Extending types with [computed fields](https://biobase-ai.github.io/pg_graphql/computed_fields/)
- Configuration with [SQL comments](https://biobase-ai.github.io/pg_graphql/configuration/)
