...
It's been 4 months since the [1.0.0 release of pg_graphql](https://biobase.com/blog/pg-graphql-v1).
...
📢 These features are only available on projects with Postgres version `15.1.0.63` or higher. For help with upgrading, please review the [migrating and upgrading projects guide](https://biobase.com/docs/guides/platform/migrating-and-upgrading-projects).
...
Users can now use the [comment directive system to assign descriptions](https://biobase.github.io/pg_graphql/configuration/#description) to tables, views and columns.
...
1. Support for user-defined functions: [GitHub issue](https://github.com/biobase/pg_graphql/issues/222)
2. Support for nested inserts: [GitHub issue](https://github.com/biobase/pg_graphql/issues/294)
