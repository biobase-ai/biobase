...
Enable it from the Database > Extensions tab in the [Biobase Dashboard](https://biobase.com/dashboard).

[![pg sodium support](/images/blog/2021-dec/pgsodium.png)](https://biobase.com/dashboard)
