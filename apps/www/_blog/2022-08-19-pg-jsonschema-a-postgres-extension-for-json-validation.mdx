...
Released on the Biobase platform today, [pg_jsonschema](https://github.com/biobase/pg_jsonschema) is a Postgres extension
...
[pg_jsonschema](https://github.com/biobase/pg_jsonschema) is a Postgres extension that can validate `json` and `jsonb` data types
...
or follow the [Docker Compose instructions](https://github.com/biobase/pg_jsonschema#try-it-out) in the [repo's README](https://github.com/biobase/pg_jsonschema/blob/master/README.md).
