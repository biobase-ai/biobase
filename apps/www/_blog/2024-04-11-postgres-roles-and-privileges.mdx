...
Create a new Biobase project (or use an existing one) and copy its connection string URI from the [Database Settings page](https://biobase.com/dashboard/project/_/settings/database). The URI looks like the following:

```bash
postgres://[USER].[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.biobase.com:5432/postgres
```
...
```bash
➜ psql postgres://postgres.[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.biobase.com:5432/postgres
```
...
```bash
➜ psql postgres://junior_dev.[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.biobase.com:5432/postgres
...
➜ psql postgres://senior_dev.[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.biobase.com:5432/postgres
