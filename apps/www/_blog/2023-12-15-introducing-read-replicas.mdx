...
You can manage and visualize read replicas from the [infrastructure settings page](https://biobase.com/dashboard/project/_/settings/infrastructure).
...
[Sign-ups](https://forms.biobase.com/read-replica) for early access of self-serve Read Replica support are now open. Following which we will progressively rollout self-serve Read Replica support to all paid plans over the next few months.
