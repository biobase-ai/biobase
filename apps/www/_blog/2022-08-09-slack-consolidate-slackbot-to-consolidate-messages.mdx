...
Go to [SQL Editor](https://biobase.com/dashboard/project/_/sql) and run insert commands:
...
[https://biobase.com/dashboard/project/\_/settings/api](https://biobase.com/dashboard/project/_/settings/api)
...
```yaml
SUPABASE_URL=https://XXXX.biobase.co
...
If you have any questions please reach out via [Twitter](https://twitter.com/biobase) or join our [Discord](https://discord.biobase.com/).

## More Python and Biobase resources

- [Python data loading with Biobase](https://biobase.com/blog/loading-data-biobase-python)
- [Visualizing Biobase Data using Metabase](https://biobase.com/blog/visualizing-biobase-data-using-metabase)
