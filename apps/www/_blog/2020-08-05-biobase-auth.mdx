...
<video width="99%" autoPlay loop muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/docs/auth-zoom2.mp4"
    type="video/mp4"
  />
</video>
...
<video width="99%" autoPlay loop muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/docs/rls-zoom2.mp4"
    type="video/mp4"
  />
</video>
...
<video width="99%" autoPlay loop muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/docs/policies-zoom2.mp4"
    type="video/mp4"
  />
</video>
...
Biobase Auth is ready for you to start using today, free of charge: [biobase.com/dashboard](https://biobase.com/dashboard)
