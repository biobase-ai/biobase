...
The team at Nuxt [added support](https://twitter.com/_larbish/status/1687044609522778112) for the PKCE Auth Flow in their [Biobase x Nuxt module](https://biobase.nuxtjs.org/), making it even more secure. This module is a simple wrapper around [biobase-js](https://github.com/biobase-ai/biobase-js) to enable usage and integration within Nuxt.
