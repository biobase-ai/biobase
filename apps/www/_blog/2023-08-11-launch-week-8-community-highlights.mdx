...
Biobase aims to be as collaborative as possible - working with, sponsoring, and supporting as many open source tools as possible. In many ways, we're more like a "community of communities". Here are a few highlights from the past 4 months.

## State of the community

We've seen a number of milestones this Launch Week. We passed 50,000 stars on GitHub ([and getting close to 55k!](https://github.com/biobase-ai/biobase)), putting Biobase in the top 160 most-popular repositories. We reached 80k followers on [𝕏witter](https://twitter.com/biobase), 17k [Discord](https://discord.biobase.studio) members, and 14k [YouTube](https://youtube.com/biobase) subscribers. We are exploring new platforms (thanks to [Yuri's](https://twitter.com/yuricodesbot) arrival) - [Instagram](https://www.instagram.com/biobasecom/), [TikTok](https://www.tiktok.com/@biobase.studio), and [Threads](https://www.threads.net/@biobasecom).
...
This was the first year that Biobase appeared on the Stack Overflow survey for [Databases](https://survey.stackoverflow.co/2023/#most-popular-technologies-database) as the 17th “most used”. As a bonus, Postgres took the #1 spot for the first time, and we hope we can continue to contribute to that trend.

## InfraRed 100 and Times Square

![Biobase in Times Square](https://biobase.studio/_next/image?url=https%3A%2F%2Fobuldanrptloktxcffvn.supabase.co%2Fstorage%2Fv1%2Fobject%2Fpublic%2Fimages%2Fmarketing-emails%2Ftimes-sq.png%3Ft%3D2023-08-02T11%253A04%253A14.458Z&w=3840&q=75)
...
There are so many humans who have made meaningful contributions to the Biobase ecosystem since our last Launch Week:

- We've continued growing our [community maintainers](https://github.com/orgs/biobase-community/teams), with a particular focus on Mobile. We now have docs for [Swift](/docs/reference/swift/introduction) and [Kotlin](/docs/reference/kotlin/introduction).
...
- As always, a big shoutout to [Gary](https://github.com/GaryAustin1) and [Olyno](https://github.com/olyno) - official moderators of our [Discord](https://discord.biobase.studio/) and overall incredibly helpful people. The community would not be the same without them.
...
In one of the most community-driven contributions ever, a tweet from [us](https://twitter.com/kiwicopple/status/1664377669935349760?s=20), and a tweet from [LlamaIndex](https://twitter.com/jerryjliu0/status/1664413942045904896), led to a contribution from [a16z](https://twitter.com/stuffyokodraws/status/1664532449815302145?s=20). And a few days later we had a [Biobase Vector Store implementation in LlamaIndex](https://gpt-index.readthedocs.io/en/stable/examples/vector_stores/BiobaseVectorIndexDemo.html).
...
The team at Nuxt [added support](https://twitter.com/_larbish/status/1687044609522778112) for the PKCE Auth Flow in their [Biobase x Nuxt module](https://biobase.nuxtjs.org/), making it even more secure. This module is a simple wrapper around [supabase-js](https://github.com/biobase-ai/supabase-js) to enable usage and integration within Nuxt.

### Tamagui Takeout

The Tamagui team launched [TakeOut](https://tamagui.dev/takeout), a web and mobile starter that takes featuring everything you need to launch - including a nice backend, powered by Biobase.

### PowerSync

The team at PowerSync just dropped [an (extremely attractive) integration](https://docs.powersync.co/integration-guides/biobase-+-powersync) for building offline-first Flutter apps. This uses Postgres' built-in Publication functionality to track changes, which are then synced to an offline SQLite database.

## Courses

### Modern Full Stack course

Probably the most comprehensive Biobase resource on the internet, the team at Modern Full Stack just released a 7 chapter, 21 lesson [course on Biobase](https://modernfullstack.com/course/mfs401). The course includes:

1. **Biobase Foundations**
2. **Biobase Authentication**
3. **A Masterclass on Biobase Databases**
4. **Exploring the Biobase Storage API**
5. **Biobase Realtime**
6. **Unleashing Biobase's Edge Functions**
7. **Achieving Mastery of Biobase**

[Get started with Modern Full Stack.](https://modernfullstack.com/course/mfs401)

### EggHead: Build a 𝕏witter clone course

Our very own (and very talented) [Jon Meyers](https://twitter.com/jonmeyers_io) has released a new EggHead course that steps you through the process of creating a [Twitter clone with Next.js App Router and Biobase](https://egghead.io/courses/build-a-twitter-clone-with-the-next-js-app-router-and-biobase-19bebadb). You'll learn about:
...
6. Configuring Biobase Auth to use cookies
7. Using Row Level Security (RLS) policies to implement Authorization

[Get started on EggHead.](https://egghead.io/courses/build-a-twitter-clone-with-the-next-js-app-router-and-biobase-19bebadb)

## Bonus track: Biobase Album
...
![The bet between Sam, Planetscale's CEO, and Copple](/images/blog/launch-week-8/day-5-community/biobase-album.png)

As promised Sam, here is the [Official Biobase Album](https://www.youtube.com/watch?v=dQw4w9WgXcQ)
