...
Any other metrics you want to see in your projects? Reach out on our [Discord channel](https://discord.biobase.com/) and give Biobase a try by [creating a project](https://biobase.com/dashboard/).
