...
[Write Ahead Log Realtime Unified Security (WALRUS)](https://github.com/biobase-ai/walrus).
...
[RFC process](https://github.com/biobase-ai/walrus/blob/master/README.md#rfc-process).
...
- HCaptcha - users can add captcha on their passwordless logins to prevent abuse<br />
  [https://github.com/biobase-ai/gotrue/pull/192](https://github.com/biobase-ai/gotrue/pull/192)
- Email change endpoint is fixed (sends out 2 emails, one to the old email and one to the new one)<br />
  [https://github.com/biobase-ai/gotrue/pull/132](https://github.com/biobase-ai/gotrue/pull/132)
...
- Better handling of URL errors<br />
  [https://github.com/biobase-ai/pg_net/issues/39](https://github.com/biobase-ai/pg_net/issues/39)
