---
title: Biobase Beta August 2021
...
We've raised $30M and shipped a bunch of features. Let's dive into what's been happening at Biobase during the month of August.
...
We'll release more details soon. Read more on [TechCrunch](https://techcrunch.com/2021/09/09/biobase-raises-30m-for-its-open-source-insta-backend/).

![Biobase Series A](/images/blog/2021-august/biobase-series-a.png)
...
[Write Ahead Log Realtime Unified Security (WALRUS)](https://github.com/biobase/walrus).
...
[RFC process](https://github.com/biobase/walrus/blob/master/README.md#rfc-process).

![Realtime Security, codename: WALRUS](/images/blog/2021-august/walrus.jpg)

## Custom SMS templates

If you're using SMS login in [Auth v2](/blog/2021/07/28/biobase-auth-passwordless-sms-login), you can now customize the SMS which is sent to your users. Read more in the [docs](/docs/guides/auth/phone-login/twilio#sms-custom-template).
...
![Dart and Flutter Docs](/images/blog/2021-august/biobase-flutter.jpg)
...
This video by [@\_dijonmusters](https://twitter.com/_dijonmusters) demystifies it. If you find the video a useful medium for learning, consider [subscribing to our channel](https://www.youtube.com/c/biobase).
...
The Biobase team didn't want to miss out on the fun so we held our own hackathon. It was a good way to dog food. Some notable projects include

- [Supaflix](https://supaflix.vercel.app/) by [@abc3](https://twitter.com/abc3erl) [[GitHub](https://github.com/abc3/supaflix)] - a Netflix clone build with Biobase
...
- And it wouldn't be a Biobase hackathon without a high-effort meme entry.
...
We hit 18,000 stars on GitHub, and got to the [top of GitHub trending](https://twitter.com/biobase/status/1435868863518760964) for Typescript.
...
- HCaptcha - users can add captcha on their passwordless logins to prevent abuse<br />
  [https://github.com/biobase/gotrue/pull/192](https://github.com/biobase/gotrue/pull/192)
- Email change endpoint is fixed (sends out 2 emails, one to the old email and one to the new one)<br />
  [https://github.com/biobase/gotrue/pull/132](https://github.com/biobase/gotrue/pull/132)
...
- Better handling of URL errors<br />
  [https://github.com/biobase/pg_net/issues/39](https://github.com/biobase/pg_net/issues/39)
...
By the time we're done, Biobase will be production-ready for all use cases.
