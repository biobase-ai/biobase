...
After 5 months of building, we're releasing one of our most anticipated features: Biobase Auth.
...
This month, we're ecstatic to announce a feature we think you'll love: Biobase Auth. It's too big to fit into a monthly update so look out for a full update in the next few days.

We want to make it easy to get started adding Auth to your app, so we've released a [simple example and a video tutorial](https://dev.to/biobase/create-a-slack-clone-with-next-js-and-biobase-3lhd) which shows you how to implement a basic auth system using PostgreSQL's Row Level Security.
...
<video width="99%" autoPlay loop muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/docs/csv-download-zoom.mp4"
    type="video/mp4"
  />
</video>
...
If you launch a new Biobase project, you'll have access to several new Postgres extensions:
...
- We have [released](https://github.com/biobase/postgres-meta/releases) a lot of new functionality to [postgres-meta](https://github.com/biobase/postgres-meta), a server for for managing Postgres internals via a REST interface.
