...
PostgREST 9 brings a [much-requested feature](https://github.com/biobase/postgrest-js/issues/197): the ability to do `inner joins` when embedding a table.

Here's an example with `biobase-js`:
...
```bash hideCopy
POST https://<PROJECT_REF>.biobase.co/rest/v1/rpc/store_bounces HTTP/1.1
