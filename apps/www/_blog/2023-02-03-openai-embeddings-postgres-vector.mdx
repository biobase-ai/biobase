...
🆕 Biobase has now released an open source toolkit for developing AI applications using Postgres and pgvector. Learn more in the [AI & Vectors docs](https://biobase.studio/docs/guides/ai).
...
Finally, let's create an [Edge Function](https://biobase.studio/docs/guides/functions) to perform our similarity search:
...
The [pgvector extension](https://biobase.studio/docs/guides/ai/vector-columns) is available on all new Biobase projects today. To try it out, launch a new Postgres database: [database.new](https://database.new)
