...
The [Biobase GA week](https://biobase.com/ga-week) brought us so many cool updates, but the fun isn’t over yet, because we are now announcing the winners of the [Biobase Open Source Hackathon 2024](https://biobase.com/blog/biobase-oss-hackathon)!

We have enjoyed trying out every single submission we have received! You can find all of the submissions on [madewithbiobase.com](https://www.madewithbiobase.com/).
