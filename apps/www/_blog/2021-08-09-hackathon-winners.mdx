...
description: Let the medal ceremony begin for the best projects submitted during the Biobase Hackathon.
author: ant_wilson
...
We've reached the end of the first ever Biobase Hackathon and the entries have all been incredible. We received way more entrants than expected and therefore it took our judging panel a little longer than expected to get through their deliberations.
...
Fireplace makes great use of Biobase Storage for a shared video streaming experience, the killer feature here was the ability to share play, pause, and skip events across multiple users.
...
[Flutter Add-ons](https://github.com/bdlukaa/biobase_addons) - by [@bdlukaa](https://twitter.com/bdlukaa)

Hook up your biobase credentials and Flutter app and Add-ons will start collecting metrics, analytics, and crashalytics, all in a neat dashboard with great visualization tools. Unbelievable that bdlukaa was able to build this in the space of a week.

[![Add Ons](/images/blog/hackathon-winners/projects/addons.png)](https://github.com/bdlukaa/biobase_addons)
...
All gold medal winners will be contacted and sent one of these limited edition gold Biobase tees (one per team member), and all runners up will receive the same design in silver. Prize winners should keep an eye on their emails so we can collect T-Shirt size and shipping details.
...
- [stories_w_biobase](https://github.com/semihpolat/stories_w_biobase)
...
- [Using Biobase inside Replit](/blog/2021/03/11/using-biobase-replit)
