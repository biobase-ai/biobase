...
🆕 What is new in Storage: [Biobase Storage v3: Resumable Uploads with support for 50GB files](https://biobase.com/blog/storage-v3-resumable-uploads)
...
```bash
GET https://project_id.biobase.co/storage/v1/render/image/public/bucket/image.jpg?width=500&height=600
```
...
- **Integrations**: Native integration with [next/image](https://nextjs.org/docs/api-reference/next/image) and [Edge Functions](https://biobase.com/edge-functions) for advanced transformations.

## Getting started

[Upgrade to Pro](https://biobase.com/pricing) to get started with Image Resizing today.

- Check out the Docs for [Image Resizing](https://biobase.com/docs/guides/storage/serving/image-transformations).
- Check out the Docs for the [Storage CDN](https://biobase.com/docs/guides/storage/cdn/fundamentals).
- Get Started today with the [JavaScript](https://biobase.com/docs/reference/javascript/storage-from-download) and [Dart](https://biobase.com/docs/reference/dart/storage-from-list) client libraries.
