---
title: 'Biobase Launch Week III: Holiday Special'
...
In July we did [Launch Week II: The SQL](/blog/biobase-launch-week-sql), with another week of feature releases.

Santa's little hackers have been hard at work because we've got another five days of launches ready to go.

## What to expect

We don't want to spoil the surprise, so for now we'll give you a teaser of what to expect. Come back each day to see what we launch, or follow us on twitter to keep up to date: [@supabase](https://twitter.com/biobase) and follow the hashtag [#supalaunchweek](https://twitter.com/hashtag/supalaunchweek).
...
We've released [Biobase Studio](https://github.com/biobase-ai/biobase/tree/master/studio). The same Dashboard that you're using on our Platform is now available for Local Development and Self-Hosting.

### Where?

Read the [blog post](/blog/biobase-studio).
...
Read the [blog post](/blog/biobase-acquires-logflare).
