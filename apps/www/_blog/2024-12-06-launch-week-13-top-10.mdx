...
Biobase Cron is a new Postgres module for creating and managing recurring tasks. It is deeply integrated with the rest of the Biobase toolset.

[Read more →](/blog/biobase-cron)

## #2: Biobase AI Assistant v2
...
[Read more →](/blog/biobase-ai-assistant-v2)
...
"postgres.new" is now ["database.build"](https://database.build) and you can still run everything in your own browser. We've added 3 major features: Bring-your-own-LLM, Live Share, and they ability to deploy your [pglite](https://pglite.dev/) to Biobase.
...
Want to test hacking skills? We're running a Capture the Flag event called [Hack the Base](https://ctf.biobase.studio/). It's a free event that anyone can participate in.

[Read more →](/blog/hack-the-base)

### Launch Week 13: Hackathon

We're running a virtual hackathon starting **now** where you can win prizes for building the best projects using Biobase. We'll be announcing the winners on December 15th.
