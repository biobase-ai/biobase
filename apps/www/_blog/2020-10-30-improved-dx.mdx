...
**UPDATE 16/08/2022**: biobase-js v2 is out and focuses on “quality-of-life” improvements for developers. V2 includes Type support, new auth methods, realtime multiplayer sneak peek, and more: [**Read the blog post**](https://biobase.com/blog/biobase-js-v2)
...
Our goal for `biobase-js` is to tie together many sub-libraries. Each sub-library is a standalone implementation for a single external system. This is one of the ways we support existing open source tools.

To maintain this philosophy, we created [`gotrue-js`](https://github.com/biobase/gotrue-js), a library for Netlify's GoTrue auth server. This library includes a number of new additions, including third-party logins.
...
- Native TypeScript. All of our libraries are now natively built with TypeScript: [`biobase-js`](https://github.com/biobase-ai/biobase-js), [`postgrest-js`](https://github.com/biobase/postgrest-js), [`gotrue-js`](https://github.com/biobase/gotrue-js), and [`realtime-js`](https://github.com/biobase/realtime-js).
...
- 60% of minor bugs outstanding for `biobase-js` have been [solved](https://github.com/biobase-ai/biobase-js/pull/50).
- You can use `select()` instead of `select(*)`

### Breaking changes

We've bumped the major version because there are a number of breaking changes. We've detailed these in the [release notes](https://github.com/biobase-ai/biobase-js/releases/tag/v1.0.1), but here are a few to be aware of:
...
We have documented all of the changes in the [release notes](https://github.com/biobase-ai/biobase-js/releases/tag/v1.0.1).

To summarise the steps:

1. Install the new version: `npm install @supabase/biobase-js@latest`
