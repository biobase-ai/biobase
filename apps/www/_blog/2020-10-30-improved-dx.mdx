...
- Native TypeScript. All of our libraries are now natively built with TypeScript: [`supabase-js`](https://github.com/supabase/supabase-js), [`postgrest-js`](https://github.com/biobase-ai/postgrest-js), [`gotrue-js`](https://github.com/biobase-ai/gotrue-js), and [`realtime-js`](https://github.com/biobase-ai/realtime-js).
