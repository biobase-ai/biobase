...
Interested? You're [3 commands away](https://biobase-ai.github.io/pg_graphql/quickstart/) from a live [GraphiQL](https://graphql-dotnet.github.io/docs/getting-started/graphiql/) demo.
...
For a more complete examples with relationships, enums, and more exotic types check out the [API doc](https://biobase-ai.github.io/pg_graphql/api).
...
Full steps to reproduce this output are available in [the docs](https://biobase-ai.github.io/pg_graphql).

## Open Source

`pg_graphql` is [open source software](https://github.com/biobase-ai/pg_graphql/). As always, Issues and PRs are welcome.

[Try `pg_graphql`](https://biobase-ai.github.io/pg_graphql/quickstart/) today to see a live [GraphiQL](https://graphql-dotnet.github.io/docs/getting-started/graphiql/) demo.
