...
Over the next few weeks, you'll be able to use it with the Biobase libraries. We've already added PKCE to the [JavaScript](https://biobase.studio/docs/reference/javascript/installing) client library and our [auth-helpers](https://biobase.studio/docs/guides/auth/auth-helpers) library. If you're using `supabase-js` , you can switch to PKCE by initializing your client with the following option:
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const biobase = createServerSupabaseClient(
    { req, res },
    {
      supabaseUrl: process.env.BIOBASE_URL,
