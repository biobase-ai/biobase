...
[Refactoring the module loader](https://github.com/biobase/edge-runtime/pull/223) fixes a few other bugs, such [edge functions erroring out](https://github.com/biobase/cli/issues/1584#issuecomment-1848799355) when an `deno.lock` file is already present in the project.
