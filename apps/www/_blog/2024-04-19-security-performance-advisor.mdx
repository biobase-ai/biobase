...
This week, we're adding features into Biobase Studio to address common issues as you scale up. These are powered by tools that we have open sourced this week: [index_advisor](https://github.com/biobase/index_advisor) and [splinter](https://github.com/biobase/splinter) (“**S**upabase **P**ostgres **linter**").
...
If you have ideas for new lints or wish to report problems you can open an issue on our GitHub repository [`splinter`](https://github.com/biobase/splinter) or [`index_advisor`](https://github.com/biobase/index_advisor).
