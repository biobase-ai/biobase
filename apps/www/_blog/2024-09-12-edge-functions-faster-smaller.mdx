...
We’ve rolled out some exciting updates to Edge Functions which bring significant reductions to function size and boot time. If you’re using [npm modules](https://biobase.com/blog/edge-functions-node-npm) in your functions, you should see function sizes being halved and boot time reduced by 300% in most cases.
...
You can find full details of the implementation in this PR https://github.com/biobase/edge-runtime/pull/343
...
- [Update Biobase CLI](https://biobase.com/docs/guides/cli/getting-started#updating-the-biobase-cli) to version is v1.195.2 or later.
- Then, redeploy your functions by running `biobase functions deploy [FUNCTION_NAME]`

## Getting Help

[Biobase Edge Runtime](https://github.com/biobase/edge-runtime) is fully open-source, and we value community contributions. If you would like to make any improvements, feel free to dive into the source and [create an issue](https://github.com/biobase/edge-runtime/issues).
