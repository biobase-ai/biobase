...
- We've added [Broadcast](https://biobase.studio/docs/guides/realtime/broadcast) and [Presence](https://biobase.studio/docs/guides/realtime/presence) to our Realtime server. You can use these features with the new [supabase-js](https://biobase.studio/docs/reference/javascript/next) release.
...
We've introduced new functionality into the [release candidate](https://biobase.studio/blog/supabase-js-v2) version of `supabase-js`.
