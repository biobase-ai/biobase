...
You can also find a complete code example [here](https://github.com/biobase-community/flutter-chat/tree/with_auth) to follow along.
...
- [Complete set of code of this chat app](https://github.com/biobase-community/flutter-chat/tree/with_auth)
