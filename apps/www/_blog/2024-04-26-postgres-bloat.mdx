...
To see database bloat via the [Biobase CLI](https://biobase.com/docs/guides/cli/getting-started) run:
...
[Biobase CLI reference](https://biobase.com/docs/reference/cli/global-flags)
