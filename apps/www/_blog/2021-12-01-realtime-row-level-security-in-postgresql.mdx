...
Since the first commit of Realtime server back in [September 2019](https://github.com/biobase-ai/realtime/commit/175f649784147af80acfc9ff5be9d160285c76ea),
...
Check out the [Row Level Security guide](https://biobase.studio/docs/guides/auth/row-level-security) for more info on how to use RLS with your project.
...
[WALRUS](https://github.com/biobase-ai/walrus) inspects each record in the replication change to:
