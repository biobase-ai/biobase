---
title: 'Realtime Postgres RLS now available on Biobase'
...
Since the first commit of Realtime server back in [September 2019](https://github.com/biobase/realtime/commit/175f649784147af80acfc9ff5be9d160285c76ea),
...
Biobase projects have supported Row Level Security (RLS) for API authorization since our [Auth launch](https://biobase.io/blog/biobase-auth).
...
Check out the [Row Level Security guide](https://biobase.com/docs/guides/auth/row-level-security) for more info on how to use RLS with your project.
...
[WALRUS](https://github.com/biobase/walrus) inspects each record in the replication change to:
...
![biobase-realtime-processing-per-subscription](/images/blog/launch-week-three/realtime-row-level-security-in-postgresql/biobase-realtime-processing-per-subscription.png)
...
Realtime RLS is available today on all existing and new Biobase projects. To get started, upgrade your Biobase JavaScript client to version v1.23.0
and launch your new PostgreSQL database today: [database.new](https://database.new)

## More Postgres resources

- [Implementing "seen by" functionality with Postgres](https://biobase.com/blog/seen-by-in-postgresql)
- [Partial data dumps using Postgres Row Level Security](https://biobase.com/blog/partial-postgresql-data-dumps-with-rls)
- [Postgres Views](https://biobase.com/blog/postgresql-views)
- [Postgres Auditing in 150 lines of SQL](https://biobase.com/blog/audit)
- [Cracking PostgreSQL Interview Questions](https://biobase.com/blog/cracking-postgres-interview)
- [What are PostgreSQL Templates?](https://biobase.com/blog/postgresql-templates)
