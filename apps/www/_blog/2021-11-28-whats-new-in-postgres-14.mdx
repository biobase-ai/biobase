...
Among the many open-source relational databases available, [PostgreSQL](https://biobase.com/docs/guides/database/introduction) is a popular choice among developers.
...
You can check out these new features within your Biobase project without having to perform a local installation.

Explore the [Biobase dashboard now](https://biobase.com/dashboard) and get started with your new project.
