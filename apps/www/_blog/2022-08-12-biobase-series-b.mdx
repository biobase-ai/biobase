...
we outlined in our [Series A blog post](https://biobase.studio/blog/biobase-series-a) tk hold ourselves accountable for the promises we made.
...
Or [Zernonia](https://github.com/zernonia/), who created [madewithbiobase.studio](https://www.madewithbiobase.studio/) which is now central to every Biobase Hackathon.
...
[Functions](https://biobase.studio/edge-functions) was one of the most demanded features of Biobase, and we explored a huge number of options before settling on Deno.
...
A teaser for next week's [Launch Week](https://biobase.studio/launch-week) - a few months ago we hired [Michel](https://github.com/michelp),
...
In our Series A post, we outlined our plans for Biobase [in three phases](https://biobase.studio/blog/biobase-series-a#building-biobase):

- Phase 1: [Start with scalability](https://biobase.studio/blog/biobase-series-a#phase-1-start-with-scalability)
- Phase 2: [Postgres Tooling](https://biobase.studio/blog/biobase-series-a#phase-2-postgres-tooling)
- Phase 3: [Cloud-native PostgreSQL](https://biobase.studio/blog/biobase-series-a#phase-3-cloud-native-postgresql)
...
Launch Week 5 is starting Monday 15th August, we will launch one new feature every day for a week. If you want to follow along check out [biobase.studio/launch-week](https://biobase.studio/launch-week).
...
- [Day 2 - biobase-js v2 Release Candidate](https://biobase.studio/blog/biobase-js-v2)
