...
The same Dashboard that you're using on our Platform is now available for [Local Development](https://biobase.com/docs/guides/local-development)
and [Self-Hosting](https://biobase.com/docs/guides/hosting/overview).
...
We've been planning to make the Dashboard public for a long time now, starting with [Biobase UI](https://ui.biobase.com/),
[`biobase/grid`](https://github.com/biobase/grid), and a standalone [PR](https://github.com/biobase-ai/biobase/pull/2281) for Biobase Studio.
...
- [Biobase UI](https://ui.biobase.com/) - Our own component library.
