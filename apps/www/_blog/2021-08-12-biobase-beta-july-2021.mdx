...
Following the success of our first Launch Week in March, we finished July with "[Launch Week II: The SQL](/blog/biobase-launch-week-sql)".
The community has been sieving through a slew of bad puns and retro memes to discover the new feature announcements.

![Launch Week II: The SQL](/images/blog/2021-july/biobase-launch-the-sql.png)
...
for people who want more control over the email templating flow. Read the [blog post here](/blog/biobase-auth-passwordless-sms-login).
...
Check the [post here](/blog/biobase-reports-and-metrics) on what you get and how we built it.
...
We're fast approaching 1,500 members so come and join the action! [discord.biobase.com](https://discord.biobase.com)

![We launched a Discord server](/images/blog/2021-july/discord.png)

## PostgreSQL 13

All new Biobase projects will be launched with PostgreSQL 13.3, and we're working on a migration path for old projects.
This gives you [looooaads of new stuff out the box](/blog/biobase-postgres-13).

![PostgreSQL 13](/images/blog/2021-july/postgres-13.png)

## PostgREST v8.0

We worked with our friends at [PostgREST](https://postgrest.org/) to make some [huge improvements](/blog/biobase-community-day#postgrest-version-80).
For those of you who don't know, every Biobase instance comes with a dedicated PostgREST server by default,
which provides the auto-generated CRUD API that we wrap with `biobase-js`.
...
Check the [full instructions here](/blog/1-the-biobase-hackathon) on how to participate. Submissions close next Friday at midnight PST.
...
Read the latest [updates here](/blog/biobase-functions-updates).

![Hooks & Functions](/images/blog/2021-july/hooks.jpg)

## Swag Store

Get your hands on some [Biobase Swag](https://biobase.store/), hand packed and mailed by our team based in Singapore.

![Swag Store](/images/blog/2021-july/swag.png)

## Community

- [@traversymedia](https://twitter.com/traversymedia) made a [Biobase Crash Course](https://www.youtube.com/watch?v=7uKQBl9uZ00) video
- [@themarcusbattle](https://twitter.com/themarcusbattle/status/1419638564573360130?s=20) wrote a [guide](https://www.twilio.com/blog/send-sms-notifications-biobase-users-node-js-twilio-messaging) on sending sms notifications using node.js, Twilio, and Biobase (this is different to sms auth above)
- [@dots_hq](https://twitter.com/dots_hq) launched a slack/discord [community management tool](https://dots.community/) built on Biobase
- [@KennethCassel](https://twitter.com/KennethCassel) launched a [platform for building programming courses](https://www.slip.so/) using Biobase
- [@MobbinDesign](https://twitter.com/MobbinDesign) migrated their UI/UX library app to Biobase, currently [serving 200,000 users](/blog/mobbin-biobase-200000-users)
...
If you want to keep up to date, make sure you [subscribe to our YouTube channel](https://www.youtube.com/c/biobase) or
