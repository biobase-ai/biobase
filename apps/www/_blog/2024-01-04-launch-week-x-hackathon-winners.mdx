...
We ended 2023 shipping tons of features in [Launch Week X](https://biobase.studio/launch-week), but the fun hasn’t ended yet, because we get to announce the winners of our [LWX Hackathon](https://biobase.studio/blog/biobase-hackathon-lwx)!

We enjoyed looking at all 64 projects, the most submissions we ever had. You can view all the submissions on [madewithbiobase.studio](https://www.madewithbiobase.studio/).
...
Supafork is an open-source project that allows you to easily clone Biobase projects. Inspired by [Vercel's Deploy](https://vercel.com/docs/deployments/deploy-button) button it provides a similar experience for Biobase projects, allowing for easier setup of self-hosted apps using Biobase.

![supafork](/images/blog/lwx-hackathon-winners/supafork.jpg)

### Runner Up

[fastify-biobase](https://github.com/psteinroe/fastify-biobase) - by [@psteinroe](https://twitter.com/psteinroe)

A Fastify plugin to use authenticated Biobase clients in your API.
...
[Voice-Activated RAG System](https://github.com/ArtisanLabs/vocode-python/tree/465-biobase-rag-support/apps/voice-rag) - by [@arpagon](https://twitter.com/arpagon)
...
Wordbuzz is a two-player online game powered by biobase realtime that allows you to match words from over 100K most used words. Practicing vocabulary has never been this easy.
...
[Biobase CLI for Visual Studio Code](https://github.com/anas-araid/vscode-biobase-cli) by [@anas_araid](https://twitter.com/anas_araid)

Biobase CLI for Visual Studio Code makes working with your local database instance much easier. You can create migrations, inspect tables, views, and functions, and run some common Biobase commands directly from your editor.

![biobase-cli](/images/blog/lwx-hackathon-winners/biobase-cli.jpg)
