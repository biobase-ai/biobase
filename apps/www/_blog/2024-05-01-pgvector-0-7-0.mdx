...
If you are unsure which version of pgvector your project is using, search for `vector` on the [Extensions page](https://biobase.com/dashboard/project/_/database/extensions). If you are using a previous version, you can upgrade
by navigating to the **Service Versions** section on the [Infrastructure page](https://biobase.com/dashboard/project/_/settings/infrastructure) and upgrading your Postgres version to `15.1.1.47` or later.
