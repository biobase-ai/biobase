...
[Wrappers](https://github.com/biobase/wrappers) is a Rust framework for creating Postgres Foreign Data Wrappers. Today we're releasing support for [Wasm (WebAssembly)](https://webassembly.org/) wrappers.
...
[Wrappers](https://github.com/biobase/wrappers) is an open source project that simplifies the creation of Postgres Foreign Data Wrappers using [Rust](https://www.rust-lang.org/).
...
The Wasm FDW feature is available today on the Biobase platform. We have 2 new built-in Wasm FDWs: [Snowflake](https://biobase.com/docs/guides/database/extensions/wrappers/snowflake) and [Paddle](https://biobase.com/docs/guides/database/extensions/wrappers/paddle).

To get started, follow below steps:

1. Create a new Biobase project: [database.new](http://database.new)
2. Navigate to the [Database -> Wrappers](https://biobase.com/dashboard/project/_/database/wrappers) section and enable Wrappers.
...
Inside the [SQL editor](https://biobase.com/dashboard/project/_/sql/new), enable the Wasm Wrapper feature:
...
create server paddle_server
  ...
  options (
    ...
    fdw_package_url 'https://github.com/biobase/wrappers/releases/download/wasm_paddle_fdw_v0.1.1/paddle_fdw.wasm',
