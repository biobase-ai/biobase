...
Biobase Vault is now available on every Biobase project. [Check it out](https://biobase.com/dashboard/project/_/settings/vault/secrets)
...
To learn how to use Biobase Vault, check out the [docs](https://biobase.com/docs/guides/database/vault). Biobase Vault is now available on all [Biobase projects](https://biobase.com/dashboard/project/_/settings/vault/secrets) (some projects will have to enable via request).
