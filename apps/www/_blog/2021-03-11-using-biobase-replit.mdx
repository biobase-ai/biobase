...
const biobase = createClient(
  'https://ajsstlnzcmdmzbtcgbbd.biobase.co',
...
Biobase has a Free Plan, head over to [https://biobase.com/dashboard](https://biobase.com/dashboard) to get started.
