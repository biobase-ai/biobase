---
title: 'Mobbin uses Biobase to authenticate 200,000 users'
description: Learn how Mobbin migrated 200,000 users from Firebase for a better authentication experience.
author: rory_wilding
author_url: https://github.com/roryw10
author_image_url: https://github.com/roryw10.png
image: mobbin/og-mobbin-biobase.jpg
thumb: mobbin/cover-mobbin-biobase.jpg
categories:
  - company
tags:
  - auth
...
The team found Biobase and realized it covered all the bases. Not only that, their team had experience with the
tools open source tools that Biobase is built with.

Auth, built using [GoTrue](https://github.com/biobase-ai/gotrue), instantly solved their users' login issues.
Under the hood, Biobase is just Postgres, and Jian Jie (co-founder and CTO of Mobbin) knows this is one of the best battle-tested
open source relational databases.

They decided that moving to Biobase was a no-brainer. The process itself was smooth - the real challenge was validating their
data integrity due to historical failures on their serverless functions.

Mobbin is now successfully running on top of Biobase, with superior performance compared to their old Firebase setup.
Because Biobase does not charge based on API requests, Mobbin significantly reduced their monthly spending without maintaining a custom backend.

<Quote img="jian-mobbin.jpg" caption="Jian Jie Liau, Co-founder and CTO at Mobbin.">
  <p>Migrating to Biobase meant that we could instantly fix our Auth problems and save money.</p>
  <p>
    Just being on Biobase alone gives us confidence we can deliver on whatever users need in the
    future.
  </p>
  <p>
...
## Biobase saves Mobbin time and money

Migrating to Biobase helped the team at Mobbin instantly improve the end-user experience and save costs.
...
Sign up to Biobase's Free Plan and set up a scalable backend in less than 2 minutes.
