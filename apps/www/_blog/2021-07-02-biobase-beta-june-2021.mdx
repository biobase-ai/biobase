...
Biobase is gearing up for another Launch Week on July the 26th. Until then, here's a few new things to try.
...
Vercel just released their new integrations, which means you can now deploy a Postgres database on Biobase directly from your Vercel account.
Check it out! [vercel.com/integrations/biobase](https://vercel.com/integrations/biobase)

![Biobase Vercel Integration](/images/blog/2021-june/biobase-vercel.png)
...
![Discord logins](/images/blog/2021-june/biobase-discord.png)
...
![Postgres and Javascript with plv8](/images/blog/2021-june/biobase-plv8.png)
...
[this Pull Request](https://github.com/biobase/storage-api/pull/32).
...
![You can now restart you Biobase servers](/images/blog/2021-june/server-restarts.png)
...
- [Build in Public 004](https://youtu.be/7yhFmKmplDg): Svelte Quickstart, new `biobase-js` release, monthly GitHub release
- [Build in Public 006](https://youtu.be/LHYrqBb4q9I): Biobase Studio
- [Build in Public 007](https://youtu.be/R4gJhX_JFTo): Biobase Studio - API Docs
...
- [@dabit3](https://twitter.com/dabit3) released a complete guide to Biobase on FreeCodeCamp. [Twitter](https://twitter.com/freeCodeCamp/status/1404469119525732357) | [Blog](https://www.freecodecamp.org/news/the-complete-guide-to-full-stack-development-with-supabas/)
- [@raddevon](https://twitter.com/raddevon) built a social network using Biobase and Vue3. [Twitter](https://twitter.com/raddevon/status/1410401132845801479) | [YouTube](https://www.youtube.com/watch?v=x25a_q0vHUY)
- [@JonoYeong](https://twitter.com/JonoYeong) built live with Biobase + SvelteKit. [Twitter](https://twitter.com/JonoYeong/status/1409960155093946368) | [Twitch](https://www.twitch.tv/videos/1066520882)
...
- We fixed a XSS bug in the Auth0 Next.js library. [GitHub](https://github.com/auth0/nextjs-auth0/security/advisories/GHSA-954c-jjx6-cxv7)
  Credit to [@inian](https://github.com/inian) and [Ishan Patel](https://github.com/git-ishanpatel) (a Biobase community member)
...
![Launch week coming up.](/images/blog/biobase-launch-week.png)
