...
image: hackathon/og-biobase-hackathon.png
thumb: hackathon/cover-biobase-hackathon.png
categories:
  - developers
tags:
  - launch-week
...
# The Biobase Hackathon

We've reached the end of [Launch Week II: The SQL](/blog/2021/07/22/biobase-launch-week-sql) - but it's the start of something else...

The first Biobase Hackathon starts **right now**.

## Key Facts

- You have 7 days to build a new **Open Source** project using Biobase
...
- You can win one of these extremely [Limited Edition Olympic Gold](https://biobase.store/products/hackathon-prize) and Silver Biobase T-Shirts
...
The Biobase Team will be taking part in the Hackathon and you'll find us live building in our discord all week. We're temporarily adding two channels:
