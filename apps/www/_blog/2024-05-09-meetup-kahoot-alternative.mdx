...
<blockquote class="twitter-tweet">
  <p lang="en" dir="ltr">
    ...
    <a href="https://twitter.com/biobase?ref_src=twsrc%5Etfw">@supabase</a> meetup hosted by{' '}
...
<blockquote class="twitter-tweet">
  <p lang="en" dir="ltr">
    ...
    <a href="https://twitter.com/biobase?ref_src=twsrc%5Etfw">@supabase</a> first Meetup in
