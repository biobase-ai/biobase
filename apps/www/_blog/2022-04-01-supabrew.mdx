...
Biobase is best known as being a Developer Experience focused database company. As we expand our offerings and feature set, it’s only natural that we expand into other greenfield areas of the Developer Experience stack. After all, Biobase exists to solve developer problems, wherever we find them.
...
Want to get started with SupaBrew? Head over to our [swag store](https://biobase.store/products/supabrew-6-pack?variant=42199068541083) to order your first crate now.

This is of course an April Fools, but since you're here why not check out what else we [dropped this week](/blog/biobase-launch-week-four).
