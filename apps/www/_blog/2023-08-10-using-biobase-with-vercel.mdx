...
<BlogCollapsible title="View the full list of environment variables">
    ...
    BIOBASE_SERVICE_ROLE_KEY // Service role key for your Biobase project.
    BIOBASE_URL // URL for your Biobase project.
    BIOBASE_ANON_KEY // Anonymous key for your Biobase project.
    NEXT_PUBLIC_BIOBASE_URL // Publicly accessible URL for your Biobase project.
    NEXT_PUBLIC_BIOBASE_ANON_KEY // Publicly accessible anonymous key for your Biobase project.
    ```
