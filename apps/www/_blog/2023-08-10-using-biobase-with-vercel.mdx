...
You can now [link multiple](https://app.biobase.com/org/_/integrations) Vercel projects to a single Biobase project:
...
<BlogCollapsible title="View the full list of environment variables">
    ...
    SUPABASE_URL // URL for your Biobase project.
    SUPABASE_ANON_KEY // Anonymous key for your Biobase project.
...
For now, Branching in Biobase is limited to development partners. We'll be rolling it out to everyone over the coming months. If you're interested in testing the new features, [sign up for early access](https://forms.biobase.com/branching-request).
