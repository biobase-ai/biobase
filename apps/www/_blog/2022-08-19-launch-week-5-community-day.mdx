...
which is the foundation for our new [pg_jsonschema extension](https://github.com/biobase/pg_jsonschema), a PostgreSQL extension providing JSON Schema validation.
...
[WalletConnect](https://walletconnect.com/) is an open source protocol for connecting decentralised applications to mobile wallets with QR code scanning or deep linking. This week they have launched the option for users to sign-in to their cloud platform with Ethereum. They are building this on top of GoTrue with the aim to contribute it back to our GoTrue fork to make it available to all Biobase users. If you're interested in this, you can follow the [PR here](https://github.com/biobase/gotrue/pull/282).
