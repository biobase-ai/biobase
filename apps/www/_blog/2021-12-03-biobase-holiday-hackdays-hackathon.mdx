...
The Biobase team will be participating as well, for example [Jon](https://twitter.com/_dijonmusters) and I, inspired by [Egghead's "Holiday Course Release Extravaganza"](https://egghead.io/20-days), will be building an Advent Calendar for all the [awesome community content](https://biobase.com/blog/community-day#new-tutorials-and-integration-guides) you've been creating. Get ready for a cool open-source project which will be using a lot of the hottest Biobase features! To make sure you don't miss this one, follow us on [Twitter](https://twitter.com/biobase) and subscribe to our [YouTube channel](https://www.youtube.com/biobase). We'll see you there.
...
Submit your project via [madewithbiobase.com/holiday-hackdays](https://www.madewithbiobase.com/holiday-hackdays)
