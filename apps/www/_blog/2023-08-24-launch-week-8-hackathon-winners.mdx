...
[Launch Week 8](https://biobase.studio/launch-week) passed by, but we still have our favorite part left, celebrating the winners of the hackathon! We've had some exceptional results and the quality of these apps are out of this world. You can view all the submissions on [madewithbiobase.studio](https://www.madewithbiobase.studio/).

And now, without further ado, congratulations to the winners of the Biobase Launch Week 8 Hackathon!
...
Supalytic is a website analytic tracking alternative to Google Analytics. It is built with SvelteKit, Biobase for auth and database and deployed on Cloudflare pages.
...
As promised in the [hackathon announcement article](https://biobase.studio/blog/biobase-lw8-hackathon) the winners and runner-ups in each category will receive a limited edition Launch Week 8 swag kit.
...
- [Day 1 - Hugging Face is now supported in Biobase](/blog/hugging-face-biobase)
- [Day 2 - Biobase Local Dev: migrations, branching, and observability](/blog/biobase-local-dev)
- [Day 3 - Biobase Studio 3.0: AI SQL Editor, Schema Diagrams, and new Wrappers](/blog/biobase-studio-3-0)
- [Day 4 - Biobase Integrations Marketplace](/blog/biobase-integrations-marketplace) | [Vercel Integration and Next.js App Router Support](/blog/using-biobase-with-vercel)
