...
- [Airtable](https://biobase.studio/docs/guides/database/extensions/wrappers/airtable) (Read-only): query your Airtable bases with [support for jsonb](https://github.com/biobase/wrappers/pull/181)
...
- And a WIP Wrapper for [Auth0](https://github.com/biobase/wrappers/pull/183)

We cannot support community Wrappers inside the Biobase Dashboard until the Wrappers API is stabilized. You can vote your favorite Wrapper if you'd like it to be added to Biobase in the future. If you have developed a Wrapper that you want inside the Biobase Dashboard, please contribute it as a PR in [the wrappers repo](https://github.com/biobase/wrappers). Once we release Wrappers 1.0, we will support community Wrappers within the Biobase Dashboard.

More improvements and updates can be found on [Wrappers release page](https://github.com/biobase/wrappers/releases), including support for Query Pushdown, Remote Subqueries, and Usage Statistics which we’ll explore below.
