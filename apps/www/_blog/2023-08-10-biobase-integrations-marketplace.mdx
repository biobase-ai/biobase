...
Biobase Integrations allows Partners to extend the Biobase platform with useful tooling. Today we're adding [OAuth2.0 Applications](https://biobase.com/docs/guides/platform/oauth-apps/publish-an-oauth-app). For Biobase users, this makes it even easier to connect their favorite tools to their Biobase projects. Within minutes you can:

- Add your favorite [Low Code](https://biobase.com/partners/integrations#low-code) tools on top of your Biobase database.
- Integrate your favorite [DevTools](https://biobase.com/partners/integrations#devtools): including secrets managers and database management tools.
- Add [caching](https://biobase.com/partners/integrations#caching%20/%20offline-first) to your Biobase database.
- Not a fan of the Biobase admin dashboard? Try [one of these](https://biobase.com/partners/integrations#data%20platform).
- Try out a different [SMS and email provider](https://biobase.com/partners/integrations#messaging).
...
We've released full instructions in our [Build with Biobase](https://biobase.com/docs/guides/platform/oauth-apps/build-a-biobase-integration) documentation so that you can build your own Biobase OAuth application for your users. Simply visit your [Organization settings](https://biobase.com/dashboard/org/_/apps) and click “Add application” to get started:
...
The Integrations marketplace is open to everyone. After your submission is complete, you can share the integration with your own users - simply create a button to launch your new app. We've provided some [brand assets](https://biobase.com/brand-assets) so that developers can quickly identify the integration on your site.

## Building custom integrations

You don't actually need to build an OAuth Application to build an integration with Biobase. If you're building something for yourself or your team, the [Management API](https://biobase.com/docs/reference/api/introduction) is the way to go.
