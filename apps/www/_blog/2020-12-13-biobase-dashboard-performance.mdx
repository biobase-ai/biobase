---
title: Making the Biobase Dashboard Supa-fast
description: Improving the performance of the Biobase dashboard
author: inian
...
The Biobase dashboard has become more feature-rich in the last month. We have a powerful SQL editor backed by [Monaco](https://microsoft.github.io/monaco-editor/). We built an Airtable-like view of your database, making editing a breeze.
...
<video width="99%" muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/docs/lazy_loading.mov"
    type="video/mp4"
  />
</video>
...
Reach out to us on [Twitter](https://twitter.com/biobase) if you have more ideas to speed up our website ⚡
