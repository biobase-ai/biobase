...
We're always trying to innovate at Biobase, so when we started planning [Launch Week 6](https://biobase.studio/launch-week), we brainstormed ideas for a campaign to promote it that would involve the community. We took a bit of inspiration from things like Weezer’s YouTube takeover and came up with the concept of a Content Storm ⛈.
...
- [A quick look at Biobase](https://twitter.com/Rorstro/status/1600047388852293632) by Ania Kubów.
...
- [Why I Switched From AWS Cognito To Biobase The Week Before My Startup Launched](https://medium.com/@sleeplessfox/why-i-switched-from-aws-cognito-to-biobase-the-week-before-my-startup-launched-67fdc1eccb8c) by Danilo à Tellinghusen.
...
- [How to Connect Browser Extensions to Biobase](https://akoskm.com/how-to-connect-browser-extensions-to-biobase) by Ákos Kőműves.
...
- [Set up a monorepo with Biobase and Turborepo](https://philipp.steinroetter.com/posts/biobase-turborepo) by Philipp Steinrötter.
...
- [How to add SIGN-IN WITH APPLE using IONIC ANGULAR and BIOBASE](https://www.youtube.com/watch?v=xhzVyso-9OM) by [Simon Grimm].
- [SvelteKit + Biobase v2 Auth with Magic Links, Providers, Email + Password, & more! 🔐🔴 LIVE](https://www.youtube.com/watch?v=XuyMr4pM4B8) by Johnny Magrippis
...
And don't miss Launch Week 6, we've been working hard to make it our best Launch Week yet 🚀. Get your tickets [here](https://biobase.studio/launch-week).
