...
Before we jump into fetching data, we need some data to fetch. Let’s [create a new Biobase project](https://biobase.com/dashboard).

Once your instance is up and running, head over to the [SQL Editor](https://biobase.com/dashboard/project/_/sql), paste in the following snippet and click `RUN`.
...
Let’s install the [biobase-js library](https://www.npmjs.com/package/@supabase/biobase-js) to fetch our `posts`.
...
> The values for these can be found in [your project’s API settings](https://biobase.com/dashboard/project/_/settings/api).
...
> For automatically adding types to the Biobase client, check out [how to generate types](https://biobase.com/docs/reference/javascript/typescript-support).
...
> Again, check out [how to generate types](https://biobase.com/docs/reference/javascript/typescript-support) to add proper typing for Post.

But now we have loading spinners! Yuck!

# Realtime

Realtime allows us to subscribe to changes in Biobase — inserted, updated or deleted posts — and update our UI dynamically. In order to receive realtime events, we need to [enable replication](https://biobase.com/dashboard/project/_/database/publications) on the posts table.
...
- [Next.js Quickstart](https://biobase.com/docs/guides/with-nextjs)
- [Next.js 13 Beta Docs](https://beta.nextjs.org/docs)
- [Creating an authenticated Biobase client in Next.js 13 Server Component](https://github.com/biobase/auth-helpers/tree/main/examples/nextjs-server-components)
