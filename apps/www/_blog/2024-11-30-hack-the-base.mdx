...
We are announcing our first-ever Capture the Flag challenge, [**Hack the Base**](https://ctf.biobase.studio). Whether you're a seasoned hacker or just starting out, this challenge is for you.
...
- **Prizes:** We're offering [prizes](https://biobase.store) for the top performers.
...
For detailed rules and to submit your flags, visit our [dedicated CTF website](https://ctf.biobase.studio). You'll also be able to track your progress on the leaderboard and see how you stack up against other participants.
...
If you're interested in finding vulnerabilities in Biobase year-round, check out our [Bug Bounty Program](https://biobase.studio/.well-known/security.txt). We're always looking for talented security researchers to help us improve the security of our platform.
