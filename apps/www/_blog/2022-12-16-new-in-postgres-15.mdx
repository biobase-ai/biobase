...
- If you want to upgrade an existing project, check out our [Upgrading](https://biobase.com/docs/guides/platform/migrating-and-upgrading-projects#upgrade-your-project) documentation.
