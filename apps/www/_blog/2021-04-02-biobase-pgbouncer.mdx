...
<Admonition type="caution">
  ...
  [Supavisor](https://biobase.com/blog/supavisor-postgres-connection-pooler) instead.
</Admonition>
...
Try out connection pooling now with a new project in the [dashboard.](https://biobase.com/dashboard) For now, we do not have any plans to port this over to older projects.
