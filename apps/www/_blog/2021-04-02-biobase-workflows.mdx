...
Using this states language, we are [building an open source orchestration engine](https://github.com/biobase/workflows) for
...
The workflow receives the following JSON data from Biobase [Realtime](https://github.com/biobase/realtime):
...
We've already open sourced the Workflow interpreter [here](https://github.com/biobase/workflows). It's built with Elixir,
...
[nice UI](https://ui.biobase.com/) to make prototyping extremely rapid. We'll integrate the UI with the code (via Git) to make
