...
Biobase Auth currently supports [authenticating with SAML](https://biobase.com/docs/guides/auth/sso/auth-sso-saml) easily, setting it up takes less than an hour, so you can focus on shipping the core features of your product.

## More from the Auth team

- [Biobase Auth: Identity Linking, Hooks, and HaveIBeenPwned integration](https://biobase.com/blog/biobase-auth-identity-linking-hooks)
- [Biobase Auth: SSO, Mobile, and Server-side support](https://biobase.com/blog/biobase-auth-sso-pkce)
- [Biobase Auth docs](https://biobase.com/docs/guides/auth)

## More from Biobase engineering

- [Elixir clustering using Postgres](https://biobase.com/blog/elixir-clustering-using-postgres)
