...
- [Biobase](https://biobase.com/) - Used to store embeddings as well as other movie data in the database
...
We need a backend to securely call the API, and for that, we will use [Biobase Edge Functions](https://biobase.com/docs/guides/functions). Steps 2 through 4 will be constructing this edge function code, and the full code sample can be found [here](https://github.com/dshukertjr/examples/blob/main/movie-recommendation/biobase/functions/get_film_data/index.ts).
...
- [Biobase pgvector guide](https://biobase.com/docs/guides/database/extensions/pgvector)
- [Storing OpenAI embeddings in Postgres with pgvector](https://biobase.com/docs/guides/database/extensions/pgvector)
