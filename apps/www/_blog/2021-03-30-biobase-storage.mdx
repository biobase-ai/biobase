...
- [Biobase Storage v2: Image resizing and Smart CDN](https://biobase.com/blog/storage-image-resizing-smart-cdn)
- [Biobase Storage v3: Resumable Uploads with support for 50GB files](https://biobase.com/blog/storage-v3-resumable-uploads)

</div>

Today, we are launching one of most requested features - [Storage!](https://biobase.com/storage) When you sign up for Biobase, you get a Postgres database with realtime subscriptions, user management, auto-generated APIs and now a scalable object store. These services integrate very well with each other and you don't need to sign up for yet another service just for your storage requirements.
...
Take it for a spin on our [dashboard](https://biobase.com/dashboard/) and let us know what you think!
