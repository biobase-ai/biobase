...
thumb: database-build-live-share/database-build-live-share-thumb.png
categories:
  - developers
  - postgres
tags:
...
<video className="rounded-sm m-0" autoPlay loop muted>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/marketing/blog/database-build-live-share/database-build-live-share.mp4"
    type="video/mp4"
  />
</video>
...
<video className="rounded-sm m-0" autoPlay loop muted>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/marketing/blog/database-build-live-share/database-build-live-share-psql.mp4"
    type="video/mp4"
  />
</video>
...
To make this possible, we developed a [**websocket-to-tcp proxy**](https://github.com/biobase-ai-community/postgres-new/tree/main/apps/browser-proxy) that relays Postgres wire protocol messages between the in-browser PGlite instance and a PostgreSQL client over TCP.
...
[pg-gateway](https://github.com/biobase-ai-community/pg-gateway) is an open source library we developed to speak the Postgres wire protocol from the server-side. It allows us to run a Postgres-native proxy - meaning we can host a single TCP server that understands Postgres wire messages and route connections to multiple downstream databases via a wildcard domain (`*.browser.db.build`).
...
- [pg-gateway](https://github.com/biobase-ai-community/pg-gateway) (MIT): Postgres wire protocol for the server-side.
- [database-build](https://github.com/biobase-ai-community/postgres-new) (Apache 2.0): The frontend and browser proxy for [database.build](https://database.build).
