...
This article assumes you are familiar with creating an application in Flask. It also assumes that you have read the Biobase documentation and are familiar the with concept of [Authentication](https://biobase.com/docs/guides/auth).
...
For detailed set up and implementation instructions please refer to the [docs](https://biobase.com/docs/guides/auth/social-login/auth-github).
...
- [biobase-py reference docs](https://biobase.com/docs/reference/python/installing)
- [biobase-py GitHub repo](https://github.com/biobase-community/biobase-py)
- [Deep Dive series on auth concepts in Biobase](https://biobase.com/docs/learn/auth-deep-dive/auth-deep-dive-jwts)
