...
Today, we are excited to introduce a groundbreaking service that bridges the digital divide with the most enduring medium known to humankind: paper. Meet [pg_paper_dump](https://github.com/biobase-community/pg_paper_dump), Biobase’s answer to the ultimate data preservation conundrum.
...
As all of our products, we have open-sourced the code and made it available to the public to be used without any restrictions [here](https://github.com/biobase-community/pg_paper_dump).
