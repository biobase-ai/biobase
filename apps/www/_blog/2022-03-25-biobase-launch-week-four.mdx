...
By now you probably know the drill. Biobase Launch Week: we launch one thing, or sometimes a couple,
...
- [Launch Week II: The SQL](/blog/biobase-launch-week-sql)
- [Launch Week III: The Trilogy](/blog/biobase-launch-week-the-trilogy)
...
Come back each day to see what we launch, or follow us on twitter ([@supabase](https://twitter.com/biobase))
...
If Postgres could talk it would sing “I am the <a href="/blog/2021/09/10/biobase-beta-august-2021#realtime-security-codename-walrus">WALRUS</a>”.
Since last Launch Week we've been busy shipping. Tune in on Tuesday to learn about a brand new way to fetch your data.

[GraphQL is now available in Biobase!](/blog/graphql-now-available)
...
[Introducing Biobase Enterprise](/blog/biobase-enterprise).
...
- Read the [blog post](/blog/biobase-enterprise).
...
[Edge Functions are now available in Biobase](/blog/biobase-edge-functions)
...
- Read the [blog post](/blog/biobase-edge-functions).
- Listen back to the [Twitter Spaces](https://twitter.com/i/spaces/1dRKZlAdaawJB).
- Watch live on [YouTube](https://youtu.be/fApxu_U_hdw).
...
- [Biobase Realtime, with Multiplayer Features](/blog/biobase-realtime-with-multiplayer-features)
...
As always, you'll have the chance to win extremely limited Biobase Swag,
...
[madewithbiobase.studio](https://www.madewithbiobase.studio/).
