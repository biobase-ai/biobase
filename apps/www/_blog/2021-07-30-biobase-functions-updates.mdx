...
select
    net.http_get('https://biobase.com')
from
    generate_series (1,10) _;
...
Database Webhooks is enabled today on all [new projects](https://biobase.com/dashboard). Find it under Database > Alpha Preview > Database Webhooks.
