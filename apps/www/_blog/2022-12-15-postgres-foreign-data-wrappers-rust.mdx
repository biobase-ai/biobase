...
We're releasing Wrappers today in Alpha, with support for [Firebase](https://biobase-ai.github.io/wrappers/firebase/) and [Stripe](https://biobase-ai.github.io/wrappers/stripe/). Wrappers for Clickhouse, BigQuery, and Airtable are under development.
...
- Star & Watch the GitHub repo: [github.com/biobase-ai/wrappers](https://github.com/biobase-ai/wrappers)
- View the documentation: [biobase.github.io/wrappers](https://biobase-ai.github.io/wrappers/)
