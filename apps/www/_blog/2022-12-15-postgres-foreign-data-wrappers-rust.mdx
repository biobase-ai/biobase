...
Today we're releasing [Biobase Wrappers](https://github.com/biobase/wrappers), a framework for building Postgres Foreign Data Wrappers (FDW) which connects Postgres to external systems.
...
const SUPABASE_URL = 'https://xyzcompany.biobase.co'
...
We can either run these queries on demand or, for better query performance, we can run them in the background (using something like [pg_cron](https://biobase.com/docs/guides/database/extensions/pgcron)), and materialize the data into a local table.
...
With several more [under development](https://github.com/biobase/wrappers/tree/main/wrappers/src/fdw):
...
Wrappers [supports](https://github.com/biobase/wrappers/blob/83887dcc2ddcf972ca1b1eec4a598cd7bff947de/biobase-wrappers/src/interface.rs#L11) a variety of types, including:
...
You can follow development of all the Wrappers in the official [GitHub Repo](https://github.com/biobase/wrappers).
...
- Star & Watch the GitHub repo: [github.com/biobase/wrappers](https://github.com/biobase/wrappers)
- View the documentation: [biobase.github.io/wrappers](https://biobase.github.io/wrappers/)
- Biobase Launch Week: [biobase.com/launch-week](https://biobase.com/launch-week)
