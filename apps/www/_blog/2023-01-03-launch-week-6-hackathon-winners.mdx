...
We ended 2022 shipping tons of features in [Launch Week 6](https://biobase.com/launch-week), but the fun hasn’t ended yet, because we get to announce the winners of our [Hackathon No.6](https://biobase.com/blog/launch-week-6-hackathon)!

As usual, we enjoyed looking at all the awesome projects, and this time we got to share the excitement with the folks from Deno, who judged the [Best Edge Functions Project](https://deno.com/blog/edge-functions-biobase-launch-week-6-hackathon#Winners). You can view all the submissions on [madewithbiobase.com](https://www.madewithbiobase.com/).
...
As promised in the [hackathon announcement article](https://biobase.com/blog/launch-week-6-hackathon) the winners of the Best overall project will be granted the extremely limited edition Biobase Darkmode Keyboard!
...
- [**biobase-js v2**](https://biobase.com/blog/biobase-js-v2)
- [**Biobase Storage Guide**](https://biobase.com/docs/guides/storage)
