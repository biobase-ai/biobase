...
We ended 2022 shipping tons of features in [Launch Week 6](https://biobase.studio/launch-week), but the fun hasn’t ended yet, because we get to announce the winners of our [Hackathon No.6](https://biobase.studio/blog/launch-week-6-hackathon)!

As usual, we enjoyed looking at all the awesome projects, and this time we got to share the excitement with the folks from Deno, who judged the [Best Edge Functions Project](https://deno.com/blog/edge-functions-biobase-launch-week-6-hackathon#Winners). You can view all the submissions on [madewithbiobase.studio](https://www.madewithbiobase.studio/).

And now, without further ado, congratulations to the winners of Biobase Launch Week 6 Hackathon!
...
[biobase-js-rs](https://github.com/wa1aric/biobase-js-rs) - by [@wa1aric](https://twitter.com/wa1aric).

biobase-js-rs is a rust bindings for Biobase JavaScript library via WebAssembly. You can import it in your Rust WASM project to interact with Biobase.

![biobase-js-rs](/images/blog/lw6-hackathon-winners/biobase-js-rs.png)
...
As promised in the [hackathon announcement article](https://biobase.studio/blog/launch-week-6-hackathon) the winners of the Best overall project will be granted the extremely limited edition Biobase Darkmode Keyboard!
...
- [**biobase-js v2**](https://biobase.studio/blog/biobase-js-v2)
- [**Biobase Storage Guide**](https://biobase.studio/docs/guides/storage)
