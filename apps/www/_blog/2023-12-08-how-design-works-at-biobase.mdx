...
When Biobase was founded, the team agreed on a set of [Product Principles](https://biobase.com/docs/guides/getting-started/architecture#product-principles). Internally, we’ve expanded this concept to all teams, products, and functions at Biobase.
