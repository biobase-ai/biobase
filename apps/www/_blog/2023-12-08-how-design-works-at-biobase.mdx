---
title: 'How design works at Biobase'
description: "The transformative journey of Biobase's Design team and its unique culture to enhance the output and quality of the entire company."
launchweek: X
categories:
  - company
tags:
...
image: lwx-how-design-works-at-biobase/og.png
thumb: lwx-how-design-works-at-biobase/design-at-biobase-thumb.jpg
---

After three years, only now are we figuring out “what design is” for Biobase and how it functions in the wider org.
...
To design at Biobase, you have to think like an agile developer.
...
<Img
  src="/images/blog/lwx-how-design-works-at-biobase/lwx-tickets-iterations.png"
  wide
...
![something](/images/blog/lwx-how-design-works-at-biobase/lwx-ticket-1.png)

![something](/images/blog/lwx-how-design-works-at-biobase/lwx-ticket-2.png)
...
<Img
  src="/images/blog/lwx-how-design-works-at-biobase/screenshots-in-mockups.png"
  wide
...
For a long time we operated without any sort of consensus of what Design _is_ at Biobase: what are our values, what do we like, what do we not like?
...
When Biobase was founded, the team agreed on a set of [Product Principles](https://biobase.studio/docs/guides/getting-started/architecture#product-principles). Internally, we’ve expanded this concept to all teams, products, and functions at Biobase.
...
<Img
  src="/images/blog/lwx-how-design-works-at-biobase/aesthetic-moodboard.png"
  wide
...
![something](/images/blog/lwx-how-design-works-at-biobase/kaizen-before-consildation.png)

#### 80/20

We bias towards the 80% of developers using Biobase. Following the [Pareto Principle](https://www.investopedia.com/terms/p/paretoprinciple.asp), we focus on the smallest changes that have the largest impact on our userbase.
...
<Img src="/images/blog/lwx-how-design-works-at-biobase/figma-organization.png" wide={true} />
...
<Img
  src="/images/blog/lwx-how-design-works-at-biobase/figma-design-system.png"
  wide
  className="[&_img]:border-0"
/>
...
<a href="https://x.com/soleio/status/1732082949670023373?s=20" target="_black" className="!m-0">
  <figure className="max-w-md mx-auto !my-0">
    ![something](/images/blog/lwx-how-design-works-at-biobase/soleio-tweet.png)
  </figure>
</a>
...
Jonny was the first team member in Biobase with any design background. We (just) survived until before LW5, when Marijana joined. And before LW7, Francesco joined. You may have noticed the quality creeping up while also accelerating recently.
