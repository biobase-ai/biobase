...
# Save the install biobase-js library
npm install --save @supabase/biobase-js
```
...
So we did what we always strive to do - improve existing open source software. We created a CLI mode for the Schema Diff on [our repo](https://github.com/biobase/pgadmin4/blob/cli/web/cli.py). We've also released a [docker image](https://hub.docker.com/r/biobase/pgadmin-schema-diff) for a quick start.
...
A sample diff can be seen on this [gist](https://gist.github.com/steve-chavez/3f286a233806aeee0bcea4a47f97f0b5). This was generated by diffing these [two databases](https://github.com/biobase/pgadmin4/tree/cli/web/pgadmin/tools/schema_diff/tests/pg/10_plus).
...
Check out the CLI VI [launched Monday 15th August, 2022](/blog/biobase-cli-v1-and-admin-api-beta), contribute to the [CLI repo](https://github.com/biobase/cli), or go here for the [hosted version](https://biobase.studio/dashboard).
