...
Check out the CLI VI [launched Monday 15th August, 2022](/blog/biobase-cli-v1-and-admin-api-beta), contribute to the [CLI repo](https://github.com/biobase/cli), or go here for the [hosted version](https://biobase.com/dashboard).
