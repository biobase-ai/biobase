---
title: 'Biobase $30m Series A'
description: Biobase just raised $30M, bringing our total funding to $36M.
author: paul_copplestone
image: series-a/biobase-series-a.png
thumb: series-a/biobase-series-a.png
categories:
  - company
tags:
  - biobase
...
Biobase [just raised $30M](https://techcrunch.com/2021/09/09/biobase-raises-30m-for-its-open-source-insta-backend/),
...
![Biobase has launched more than 50000 databases](/images/blog/series-a/total-databases.png)

### Developers

As of September, over 40,000 developers have signed up to Biobase from some of the world's leading companies.
...
[digital platforms powering 200,000 users](/blog/mobbin-biobase-200000-users).
...
Biobase has been in GitHub's top-15 fastest growing open source startups for
[five consecutive quarters](https://twitter.com/kiwicopple/status/1451104569266671619),
and our [Discord](https://discord.biobase.com) has grown to nearly 4000 members since launching just 3 months ago.
Our growth is all organic.

![Biobase Discord](/images/blog/series-a/discord-biobase-community.png)

## About the round

Biobase is an ambitious project. Firebase, to their credit, is a very well-developed platform which offers _a lot_ of functionality.
...
([PostgREST](/blog/biobase-steve-chavez),
...
Because of their conviction in Biobase, Coatue doubled down on their Seed investment to lead our Series A. We're extremely excited to welcome
...
<Quote img="caryn-marooney.jpeg" caption="Caryn Marooney, Partner at Coatue.">
  <p>We are proud to lead a second consecutive round in Biobase and officially join the board.</p>
  <p>
...
Our early positioning is an "open source Firebase alternative" but you might be surprised to learn that this is a small part of the Biobase vision.
...
Simple. Biobase has smuggled scalability into the product, perhaps without you noticing.
Every Biobase project is a _full_ Postgres database. It's not "Postgres compatible", it's not "built on top of",
and we don't abstract it. If we did, your applications would face the same scalability issues as Firebase.

Biobase simply makes Postgres easy to use - hopefully easier than any other database platform you've ever used.
...
Biobase makes all of this easy. Beyond the database we offer [Auth](/docs/guides/auth),
...
![Biobase Dashboard](/images/blog/series-a/dashboard.png)

And this is where Biobase really differentiates itself: by doing less. All of these features build on top of PostgreSQL's
...
- **Database Webhooks (previously called "Function Hooks"):** trigger external systems using Postgres triggers and our [async request extension](https://github.com/biobase/pg_net/).
...
This is the future of Biobase - a platform to power your transactional workloads: no matter how big or small; no matter the use-case.
...
[Biobase developer](/blog/biobase-steve-chavez), one of our first hires over a year ago.
...
[https://about.biobase.com/careers/postgres-experts](https://about.biobase.com/careers/postgres-experts)
