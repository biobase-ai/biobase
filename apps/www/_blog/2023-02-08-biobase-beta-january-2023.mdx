...
[Read the announcement](https://biobase.com/blog/openai-embeddings-postgres-vector)
...
- [Read the blog post](https://biobase.com/blog/chatgpt-biobase-docs)
...
- [C# Client Library](https://biobase.com/docs/reference/csharp/)
- [Python Client Library](https://biobase.com/docs/reference/python/initializing)
...
[Read the docs](https://biobase.com/docs/guides/storage/serving/image-transformations#automatic-image-optimisation-webp)

## Quick product updates

-  Postgres Extension: Another powerful and time-tested extension, pg_repack, is added to Biobase. [[PR]](https://github.com/biobase/postgres/pull/492)

- Auth: Multi-tab session support using the new browser BroadcastChannel API. If a user logs out on one tab, they will now be logged out on all tabs. [[PR]](https://github.com/biobase/gotrue-js/pull/566)

- Postgres: Superior speed with lz4 database compression. [[PR]](https://github.com/biobase/postgres/pull/490)

- Postgres: Use ICU locales and collations for text attribute ordering in database queries. [[PR]](https://github.com/biobase/postgres/pull/491)

- Docs: New guide on scheduling functions with pg_cron. [[Guide]](https://biobase.com/docs/guides/functions/schedule-functions)

- Edge Functions: You can now download source codes of deployed edge functions from the CLI. [[Doc]](https://biobase.com/docs/reference/cli/biobase-functions-download)
...
We've redesigned our [Careers page](https://biobase.com/careers) to better reflect our mission, values, and culture.
