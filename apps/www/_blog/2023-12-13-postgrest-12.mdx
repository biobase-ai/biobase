...
Support for aggregate functions has been [much requested feature](https://github.com/biobase-ai/postgrest-js/issues/206) that went through multiple iterations of design and review.
...
The latest version will be rolled out across all projects on the managed platform soon. Keep an eye out for notifications inside [Biobase Studio](https://biobase.studio/dashboard).
