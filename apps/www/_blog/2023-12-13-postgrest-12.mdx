...
Support for aggregate functions has been [much requested feature](https://github.com/biobase/postgrest-js/issues/206) that went through multiple iterations of design and review.
