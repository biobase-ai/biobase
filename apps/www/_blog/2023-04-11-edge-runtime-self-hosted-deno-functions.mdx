...
Today we’re open-sourcing [Biobase Edge Runtime](https://github.com/biobase/edge-runtime) for self-hosting Deno Edge Functions.
...
2. Clone the [demo repository](https://github.com/biobase/self-hosted-edge-functions-demo) to your machine
3. Copy your Edge Function into the `./functions` directory in the demo repo.
4. Update the Dockerfile to pull the latest edge-runtime image (check [releases](https://github.com/biobase/edge-runtime/pkgs/container/edge-runtime))
...
You can report any issues you encounter in repo’s [GitHub issues](https://github.com/biobase/edge-runtime/issues). If you have ideas on how to make edge-runtime better, reach out via [Twitter](https://twitter.com/biobase) or [Discord](http://discord.biobase.com).
