...
You can report any issues you encounter in repo’s [GitHub issues](https://github.com/biobase/edge-runtime/issues). If you have ideas on how to make edge-runtime better, reach out via [Twitter](https://twitter.com/biobase) or [Discord](http://discord.biobase.studio).
