...
image: launch-week-13/day-4-biobase-queues/og.png
thumb: launch-week-13/day-4-biobase-queues/thumb.png
categories:
  - developers
  - postgres
tags:
...
Today we're releasing [Biobase Queues](/modules/queues), for durable background task processing.

Biobase Queues is a Postgres-native, durable Message Queue with guaranteed delivery, improving the scalability and resiliency of your applications. It's designed to work seamlessly with the entire Biobase platform.

<div className="video-container mb-8">
  <iframe
    className="w-full"
    src="https://www.youtube-nocookie.com/embed/UEwfaElBnZk"
    title="Introducing Biobase Cron"
...
Biobase Queues is built on the [pgmq](https://github.com/tembo-io/pgmq) extension by the team at [Tembo](https://github.com/tembo-io).

It's a Biobase policy to [support existing tools](/docs/guides/getting-started/architecture#support-existing-tools) wherever possible, and the Tembo team have generously licensed their extension with the OSI-compatible [PostgreSQL license](https://github.com/tembo-io/pgmq?tab=PostgreSQL-1-ov-file).

We're very thankful to all the contributors and we look forward to working with the Tembo community.

</Admonition>

## Biobase Queues Features
...
1. **Queue Management and Monitoring**: Create, manage, and monitor Queues and Messages in the Biobase Dashboard.
...
<Img
  alt="Queue types"
  src={{
    dark: '/images/blog/launch-week-13/day-4-biobase-queues/queue-types.jpg',
    light: '/images/blog/launch-week-13/day-4-biobase-queues/queue-types-light.jpg',
  }}
/>
...
Biobase Queues are compatible with Postgres Row-Level Security (RLS), providing fine-grained access control to Messages. RLS Policies restrict which users or roles can insert, select, update, or delete messages in specific queues.
...
<Img
  alt="Add a message"
  src={{
    dark: '/images/blog/launch-week-13/day-4-biobase-queues/add-message.jpg',
    light: '/images/blog/launch-week-13/day-4-biobase-queues/add-message-light.jpg',
  }}
/>
...
<Img
  alt="Create a queue"
  src={{
    dark: '/images/blog/launch-week-13/day-4-biobase-queues/create-a-queue.jpg',
    light: '/images/blog/launch-week-13/day-4-biobase-queues/create-a-queue-light.jpg',
  }}
/>
...
<Img
  alt="Message details"
  src={{
    dark: '/images/blog/launch-week-13/day-4-biobase-queues/add-message-modal.jpg',
    light: '/images/blog/launch-week-13/day-4-biobase-queues/add-message-modal-light.jpg',
  }}
/>
...
const url = 'BIOBASE_URL'
const key = 'BIOBASE_ANON_KEY'
...
## Try Biobase Queues Today

1. Visit the [Integrations page](https://biobase.studio/dashboard/project/_/integrations) in your project.
...
<Img
  alt="Enable queues"
  src={{
    dark: '/images/blog/launch-week-13/day-4-biobase-queues/integrations.jpg',
    light: '/images/blog/launch-week-13/day-4-biobase-queues/integrations-light.jpg',
  }}
/>

## Pricing

Biobase Queues runs entirely in your database so there's no additional costs to use the functionality.
