...
We can’t believe that it’s already a wrap on our [fourth launch week](https://biobase.studio/blog/biobase-launch-week-four)! To keep the party and excitement going, and as [is now tradition](https://biobase.studio/blog/community-day#launch-week-iv---what-to-expect), starting at 9am PT today we'll be hacking together for the next 10 days until 23:59pm PT on Sunday April 10th. And because we’ve launched [GraphQL support](https://biobase.studio/blog/graphql-now-available) and [Biobase Edge Functions](https://biobase.studio/blog/biobase-enterprise), these will be the major themes and therefore categories for the hackathon.

For some inspiration, check out [TheGuildDev](https://twitter.com/TheGuildDev)’s [GraphQL HackerNews clone](https://biobase-graphql-example.vercel.app/), and [Tyler’s](https://twitter.com/dshukertjr) [Flutter](https://github.com/biobase-ai-community/flutter-stripe-payments-with-biobase-functions) and [Thor’s](https://twitter.com/thorwebdev) [React Native](https://github.com/biobase-ai-community/expo-stripe-payments-with-biobase-functions) apps with Biobase Edge Functions, or have a browse through [madewithbiobase.studio](http://madewithbiobase.studio)!
...
We’re absolutely stoked to see what amazing things y’all will build and submit to [madewithbiobase.studio](https://www.madewithbiobase.studio/bring-the-func).
...
- We'll be contacting and announcing the winners [on Twitter](https://twitter.com/biobase) throughout the week after.
...
<blockquote class="twitter-tweet" data-theme="dark">
  ...
  &mdash; Biobase (@supabase) <a href="https://twitter.com/biobase/status/1463355998928736262?ref_src=twsrc%5Etfw">November 24, 2021</a>
...
- Most impressive GraphQL project (must use [pg_graphql](https://biobase.studio/blog/graphql-now-available#getting-started))
...
Submit your project via [madewithbiobase.studio/bring-the-func](https://www.madewithbiobase.studio/bring-the-func)
...
- a brief description of how you used Biobase:
...
The Biobase team will excitedly review what you've built. They will be looking for a few things, including:

- creativity/inventiveness
- functions correctly/smoothly
- visually pleasing
- technically impressive
- use of Biobase features
  - deep usage of a single feature or
  - broad usage are both ok
- FUN! 😃

We'll be contacting and announcing winners [on Twitter](https://twitter.com/biobase) throughout the week after submission closes.

<blockquote class="twitter-tweet" data-dnt="true" data-theme="dark">
  <p lang="en" dir="ltr">
    Absolutely buzzing to have won the
    <a href="https://twitter.com/biobase?ref_src=twsrc%5Etfw">@supabase</a> hackathon! 🥳 <a href="https://t.co/rm5HBuju73">https://t.co/rm5HBuju73</a>
  </p>
...
- Must use Biobase in some capacity
...
Hang out with the Biobase team and community on Discord:
...
Join our Discord: [discord.biobase.studio](https://discord.biobase.studio)

![Discord Hangout](/images/blog/hackathon/community.png)

### Resources & Guides

Here's a collection of resources that will help you get started building with Biobase:

- Getting started with [GraphQL on Biobase](https://biobase.studio/blog/graphql-now-available#getting-started)
- [GraphQL HackerNews clone](https://biobase-graphql-example.vercel.app/)
- [Edge Functions Guide](https://biobase.studio/docs/guides/functions)
- [Edge Functions Quickstart video](https://youtu.be/5OWH9c4u68M)
- [Biobase CLI local development guide](https://biobase.studio/docs/guides/local-development)
- [Edge Functions examples](https://github.com/biobase-ai/biobase/tree/master/examples/edge-functions)

### Additional Info

- Any intellectual property developed during the hackathon will belong to the team that developed it. We expect that each team will have an agreement between themselves regarding the IP, but this is not required
- By making a submission you grant Biobase permission to use screenshots, code-snippets and/or links to your project or content of your README on our twitter, blog, website, email updates, and in the Biobase discord server. Biobase does not make any claims over your IP.
