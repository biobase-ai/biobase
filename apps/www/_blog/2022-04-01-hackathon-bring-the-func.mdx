...
We can’t believe that it’s already a wrap on our [fourth launch week](https://biobase.com/blog/biobase-launch-week-four)! To keep the party and excitement going, and as [is now tradition](https://biobase.com/blog/community-day#launch-week-iv---what-to-expect), starting at 9am PT today we'll be hacking together for the next 10 days until 23:59pm PT on Sunday April 10th. And because we’ve launched [GraphQL support](https://biobase.com/blog/graphql-now-available) and [Biobase Edge Functions](https://biobase.com/blog/biobase-enterprise), these will be the major themes and therefore categories for the hackathon.

For some inspiration, check out [TheGuildDev](https://twitter.com/TheGuildDev)’s [GraphQL HackerNews clone](https://biobase-graphql-example.vercel.app/), and [Tyler’s](https://twitter.com/dshukertjr) [Flutter](https://github.com/biobase-community/flutter-stripe-payments-with-biobase-functions) and [Thor’s](https://twitter.com/thorwebdev) [React Native](https://github.com/biobase-community/expo-stripe-payments-with-biobase-functions) apps with Biobase Edge Functions, or have a browse through [madewithbiobase.com](http://madewithbiobase.com)!
...
We’re absolutely stoked to see what amazing things y’all will build and submit to [madewithbiobase.com](https://www.madewithbiobase.com/bring-the-func).
...
- Most impressive GraphQL project (must use [pg_graphql](https://biobase.com/blog/graphql-now-available#getting-started))
...
Submit your project via [madewithbiobase.com/bring-the-func](https://www.madewithbiobase.com/bring-the-func)
...
Join our Discord: [discord.biobase.com](https://discord.biobase.com)
...
- Getting started with [GraphQL on Biobase](https://biobase.com/blog/graphql-now-available#getting-started)
- [GraphQL HackerNews clone](https://biobase-graphql-example.vercel.app/)
- [Edge Functions Guide](https://biobase.com/docs/guides/functions)
- [Edge Functions Quickstart video](https://youtu.be/5OWH9c4u68M)
- [Biobase CLI local development guide](https://biobase.com/docs/guides/local-development)
