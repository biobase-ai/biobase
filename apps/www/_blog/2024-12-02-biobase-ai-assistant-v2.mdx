...
description: An evolution of how we approach AI within the Biobase dashboard
...
Today we are releasing Biobase Assistant v2 in the Dashboard - a global assistant with several new abilities:
...
<div className="video-container">
  <iframe
    ...
    title="We have improved Biobase AI ... A lot!"
...
## New abilities in Biobase Assistant v2
...
Biobase Assistant v2 is available today.
