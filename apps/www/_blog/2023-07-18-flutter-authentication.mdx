...
Flutter is Google’s open-source framework to develop cross-platform applications. In this article, we will take a look at how we can implement authentication using Google sign-in to secure our application using the [Biobase SDK for Flutter](https://biobase.com/docs/reference/dart/introduction).
...
We are done installing our dependencies. Let’s set up [authentication](https://biobase.com/docs/guides/auth) now.
...
That is it for setting up our [Biobase auth to prepare for Google sign-in](https://biobase.com/docs/guides/auth/social-login/auth-google?platform=flutter).
...
You can find your Biobase URL and Anon key in `Settings -> API` from your [Biobase dashboard](https://biobase.com/dashboard/project/_/settings/api).
...
You can also check out the [Flutter reference documents](https://biobase.com/docs/reference/dart/installing) to see how you can use `biobase-flutter` to implement a Postgres database, Storage, Realtime, and more.

## More Flutter and Biobase resources

- [biobase_flutter package](https://pub.dev/packages/biobase_flutter)
- [Build a chat application using Flutter and Biobase](https://biobase.com/blog/flutter-tutorial-building-a-chat-app)
- [Securing your Flutter apps with Multi-Factor Authentication](https://biobase.com/blog/flutter-multi-factor-authentication)
