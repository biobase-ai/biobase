---
title: 'Biobase Studio: AI Assistant and User Impersonation'
...
image: launch-week-x/day-1/day-1-biobase-assistant-thumb.png
thumb: launch-week-x/day-1/day-1-biobase-assistant-og.png
---

During the previous Launch Week we introduced text-to-sql in the SQL Editor within Biobase Studio. This was our first step towards a full AI Assistant.

Today, we're introducing the Biobase Assistant, an AI side-kick inside the dashboard, and a few new features that will take you from idea to production even faster.
...
## Introducing the Biobase Assistant

We're excited to expand Studio's AI capabilities with our new **Biobase Assistant**.
...
![Biobase AI Assistant](/images/blog/launch-week-8/day-2/biobase-ai-loading-animation.gif)

## Easy RLS Policies with AI

Of all the feature requests we get (and we get many!), an easier way to write [Row Level Security](https://biobase.studio/docs/guides/auth/row-level-security) Policies is one of the most frequent.
...
<Img src="/images/blog/launch-week-x/day-1/1.png" alt="Biobase new AI Assistant" />
...
<video width="99%" autoPlay loop muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/marketing/blog/lwx/rls-editor-run-through.mp4"
    type="video/mp4"
  />
</video>

We've explored various approaches and designs for the RLS Editor. This SQL-first approach, with assistance from AI, feels like the solution we've been seeking. The new RLS Editor can be enabled today via Feature Previews (more on that below). We'd love to [hear your feedback](https://github.com/orgs/biobase/discussions/19594).

## Postgres Roles

You may have never thought about this, but Studio connects to your database just like any other Postgres client.

It uses the default [Postgres role](https://biobase.studio/docs/guides/database/postgres/roles), `postgres`. The `postgres` role functions like your `service role` key, granting it admin privileges to your database. It has admin read and write privileges, and bypasses Row Level Security.
...
```js
{
  ...
  "iss": "biobase"       // the issuer of the JWT
...
<Img src="/images/blog/launch-week-x/day-1/3.png" alt="Biobase new postgres roles" />
...
<video width="99%" autoPlay loop muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/marketing/blog/lwx/role-switcher.mp4"
    type="video/mp4"
  />
</video>
...
The Role dropdown unlocks another handy capability: when combined with Biobase Auth it can even pretend to be a different _user_.
...
<Img src="/images/blog/launch-week-x/day-1/7.png" alt="Biobase AI" />
...
<Img src="/images/blog/launch-week-x/day-1/8.png" alt="Biobase AI" />

And in GraphiQL:

<Img src="/images/blog/launch-week-x/day-1/11.png" alt="Biobase AI" />

Combining this feature with the new RLS Editor, you're able to write and test RLS policies with real data in a matter of minutes. This makes the process of writing RLS policies many times faster and easier. If you've got feedback, [we'd love to hear it](https://github.com/orgs/biobase/discussions/19595).

## Realtime Inspector

Biobase [Realtime](https://biobase.studio/realtime) is great for building collaborative applications. You can receive database changes over websockets, store and synchronize data about user presence, and broadcast any data to clients via "channels".
...
<Img src="/images/blog/launch-week-x/day-1/6.png" alt="Biobase AI" />
...
If you use Realtime, you'll find the new inspector very handy. Please send along any [feedback](https://github.com/orgs/biobase/discussions/19596) you've got.
...
<Img src="/images/blog/launch-week-x/day-1/4.png" alt="Biobase AI Feature Preview" />

We currently have two features in preview:

`1.` The new RLS Assistant that we looked at earlier:

<Img src="/images/blog/launch-week-x/day-1/5.png" alt="Biobase AI new RLS Assistant" />

`2.` And a revised API side panel:

<Img src="/images/blog/launch-week-x/day-1/10.png" alt="Biobase AI revised API side panel" />

We'll be actively keeping an eye on the Github Discussions and will be responding to your feedback.

## Wrapping up

In this update, we've taken huge strides in enhancing your experience with Biobase.
...
3. **Realtime Inspector**: With the Realtime Inspector, you can prototype, inspect, and debug Realtime messages. This tool will be very useful for those who use Biobase Realtime.
...
These updates reflect our commitment to a SQL-first approach and a user-centric development. We look forward to your feedback as we continue to work hard making Biobase faster and easier for you to get your ideas out into the wild.
