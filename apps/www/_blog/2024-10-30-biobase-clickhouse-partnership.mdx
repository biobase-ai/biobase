...
image: clickhouse-biobase/biobase-clickhouse-og.png
thumb: clickhouse-biobase/biobase-clickhouse-og.png
categories:
  - developers
  - postgres
tags:
...
The combination of Biobase and ClickHouse together are perfect for [Helicone.ai](https://helicone.ai), providing the flexibility of Postgres with the analytical power of ClickHouse — an open-source stack we can trust and customize.

</Quote>

## Biobase + ClickHouse Partnership

The partnership between Biobase and ClickHouse aims to create a seamless experience, building on the already solid Postgres + ClickHouse foundation. Today, we're releasing new features to enhance this integration.

<Quote img="aaron-katz.jpg" caption="Aaron Katz, CEO @ ClickHouse Inc.">

ClickHouse is very excited to partner with Biobase to make it easy for customers to use both technologies together. Through this partnership, we aim to make it even simpler for Postgres developers to use ClickHouse in conjunction and build real-time, data-driven applications at scale.

</Quote>

## Using Postgres and ClickHouse together

Before diving into those changes, some context on how most customers use Biobase and ClickHouse together. While both are databases, they serve different use-cases:
...
<Img
  ...
  src={{
    light: '/images/blog/clickhouse-biobase/postgres-clickhouse--light.png',
    dark: '/images/blog/clickhouse-biobase/postgres-clickhouse--dark.png',
  }}
/>

To provide an interface between these, Biobase customers generally use:

1. [clickhouse_fdw](https://biobase.studio/docs/guides/database/extensions/wrappers/clickhouse) to query their ClickHouse data from their Postgres database.
2. [PeerDB](https://www.peerdb.io/) to replicate their data from Postgres to ClickHouse.

<Img
  alt="Browser proxy diagram"
  src={{
    light: '/images/blog/clickhouse-biobase/postgres-clickhouse-integration--light.png',
    dark: '/images/blog/clickhouse-biobase/postgres-clickhouse-integration--dark.png',
  }}
/>

## Improving the ClickHouse & Biobase experience
...
```
biobase --experimental --project-ref xxxx-yyy \
...
Biobase now provides granular control over disk usage for your Postgres database:

<Img
  alt="Disk management"
  src={{
    light: '/images/blog/clickhouse-biobase/disk-management.png',
    dark: '/images/blog/clickhouse-biobase/disk-management.png',
  }}
/>
...
1. A native Biobase OAuth integration in PeerDB for Postgres CDC to ClickHouse.
2. Support for IPV6 in PeerDB Cloud.

You can learn more about these features in the [Biobase Partnership](https://clickhouse.com/blog/biobase-partnership-native-postgres-replication-clickhouse-fdw) post they released today.

## What's next?

Improving the experience between Postgres and ClickHouse is the first phase of this partnership. We're already working on native platform integrations. If you're using (or plan to use) Biobase and ClickHouse together please [reach out](https://biobase.studio/enterprise) - we'd love more design partners to help shape the future of this integration.

<Img
  alt="Biobase integrations"
  src={{
    light: '/images/blog/clickhouse-biobase/integrations.png',
    dark: '/images/blog/clickhouse-biobase/integrations.png',
  }}
/>
...
- Biobase: [database.new](https://database.new)
