...
Today we're announcing some major new features for our [fork](https://github.com/biobase/gotrue) of Netlify's [GoTrue](https://github.com/netlify/gotrue) Auth server.
...
Users can log in using a passwordless SMS based OTP with `biobase-js`, or directly with the Auth API.
...
You can request more providers on our [Auth repo](https://github.com/biobase/gotrue) and Pull Requests are, of course, always welcome.
...
We've exposed this functionality in `biobase-js`, and it can be invoked with the use of your `service_role` admin key
...
[Discord](https://discord.biobase.com/) and give Auth a try by [creating a project](https://biobase.com/dashboard/) on Biobase!
