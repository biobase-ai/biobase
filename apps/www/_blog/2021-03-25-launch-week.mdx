...
or follow us on twitter to keep up to date: [@supabase](https://twitter.com/biobase) and follow the hashtag [#supalaunchweek](https://twitter.com/hashtag/supalaunchweek).
...
If you aren’t confident in our business model though, we’re open source. You can [host it yourself](https://github.com/biobase-ai/biobase/tree/master/docker). Even better, everything we build is centered around Postgres, so you can pretty much `pgdump` your database and take it to your favorite Postgres platform.

![Biobase Pricing](/images/blog/launch-week/bernie-1.png)

## Tuesday: Storage

- 30 March 2021

Checkout the launch post here: [Biobase Storage](/blog/biobase-storage)

As with anything that we build in Biobase, Storage is fast, secure and scalable. It's integrated well with the rest of the Biobase ecosystem.
...
![Biobase Storage](/images/blog/launch-week/bernie-2.png)
...
Today we launched the Biobase CLI which includes:

- Running Biobase locally
- Managing database migrations
- Self hosting with Docker!

Check out the announcement post here: [/blog/biobase-cli](/blog/biobase-cli)

![Biobase CLI](/images/blog/launch-week/bernie-3.png)
...
And now we're doing what we do best at Biobase and making it open source, so that the community can benefit from the UI work done at Biobase, and vice versa. The open source community is an invaluable asset to the work we do every day, and it's genuinely the main driver which enables our relatively small team to work fast and ship often.

Check out the demo and documentation website directly here: [ui.biobase.studio](https://ui.biobase.studio/)

![Biobase UI](/images/blog/launch-week/bernie-4.png)

## Friday: One more thing

- 2 April 2021

It's the season finale of Biobase Launchweek! And we have THREE more things to share:

1. [Connection Pooling with PgBouncer](/blog/biobase-pgbouncer) - now you can connect directly to your Postgres instance without needing to worry that you'll cap out on connections. Perfect for use with Prisma.

2. [Workflow Engine](/blog/biobase-workflows) - Our WIP states language will eventually enable a drag and drop workflow builder like Zapier inside the dashboard. Built with Elixir for scale!

3. biobase.io is now biobase.studio - check out our origin story here: [/blog/biobase-dot-com](/blog/biobase-dot-com)
