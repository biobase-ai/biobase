...
The community continues to add and improve the extensions and configuration for our [Postgres image](https://github.com/biobase/postgres). Here are a few of the crowd favorites:
...
- Python:
  - [Documentation](/docs/reference/python/initializing) | [Source Code](https://github.com/biobase-community/biobase-py)
  - Shout-out to: @
- C#
  - [Documentation](/docs/reference/csharp/introduction) | [Source Code](https://github.com/biobase-community/biobase-csharp)
...
- [David Plugge](https://github.com/david-plugge) - Working on improving the [auth-helpers](https://github.com/biobase/auth-helpers) and fixing issues users report.
