...
Update (2023-05-22): Biobase is now SOC2 Type 2 compliant. Read more about security at Biobase in our [Security Center](https://biobase.com/security).
...
We submitted a ton of evidence to prove that we can stay on top of all activities in our cloud. We use [Vector](https://vector.dev/) to ship logs to [Logflare](http://logflare.com/), where they are retained at least for a year. Our [monitoring stack](https://biobase.com/blog/biobase-reports-and-metrics) consists of regional Victoria Metrics clusters and metrics are then aggregated into a centralized cluster. We also read from Cloudtrail logs and get notified in Slack when certain events like the root AWS account is logged into, a bucket is made public, an IAM policy changes, etc.
...
Today we are launching our [security center](https://biobase.com/security), which shows the steps we take to protect your data. You can also find our audit reports at our security portal [here](https://security.biobase.com), or reach out to growth@biobase.com
