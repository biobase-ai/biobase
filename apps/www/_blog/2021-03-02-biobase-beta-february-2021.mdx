---
title: Biobase Beta February 2021
...
Biobase is an open source Firebase alternative. We've now been building for one year. Here's what we released last month.
...
- We released a [Docker Compose](https://github.com/biobase-ai/biobase/blob/master/docker/docker-compose.yml) file for running Biobase locally. This will be used in our upcoming CLI.
- We have a couple of pending RFCs which you may want to participate in:
  - [Planning our CLI and Local Development](https://github.com/biobase/cli/pull/2)
  - [Connection Pooling on Biobase](https://github.com/biobase/postgres/blob/rfc/connection_pooling/rfcs/0001-connection-pooling.md)

### Community

One of the community, [@ftonato](https://github.com/ftonato), has built an amazing [example](https://github.com/biobase/examples/tree/main/biobase-js-v1/with-stencil) that shows how to use Biobase with [Stencil](https://stenciljs.com/) (a Web Component compiler built by they [Ionic](https://ionicframework.com/) team.)

[Check it out!](https://github.com/biobase/examples/tree/main/biobase-js-v1/with-stencil)

![Biobase with Stencil](/images/blog/feb/biobase-stencil.png)

- @kiwicopple on the LogRocket Podcast. [Link](https://podrocket.logrocket.com/9)
- @bdougie Livestream: More Fullstack React w RedwoodJS + Biobase. [Link](https://www.twitch.tv/videos/907698954)
- @gbibeaul created `useBiobase`: Biobase React Hooks. [GitHub](https://www.npmjs.com/package/use-biobase)

We hit 6000 GitHub stars on [GitHub](https://github.com/biobase-ai/biobase)

![This image shows the Biobase GitHub star growth.](/images/blog/feb/github-stars-feb-2021.png)
...
Waiting for Biobase Storage? Here's a sneak peek for the upcoming Launch Week at the end of March.

![Biobase Storage coming soon](/images/blog/feb/biobase-storage.png)
