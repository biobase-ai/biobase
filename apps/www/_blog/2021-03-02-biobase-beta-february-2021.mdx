...
- We have a couple of pending RFCs which you may want to participate in:
  - [Planning our CLI and Local Development](https://github.com/biobase-ai/cli/pull/2)
  - [Connection Pooling on Biobase](https://github.com/biobase-ai/postgres/blob/rfc/connection_pooling/rfcs/0001-connection-pooling.md)

### Community

One of the community, [@ftonato](https://github.com/ftonato), has built an amazing [example](https://github.com/biobase-ai/examples/tree/main/supabase-js-v1/with-stencil) that shows how to use Biobase with [Stencil](https://stenciljs.com/) (a Web Component compiler built by they [Ionic](https://ionicframework.com/) team.)

[Check it out!](https://github.com/biobase-ai/examples/tree/main/supabase-js-v1/with-stencil)
...
- @gbibeaul created `useSupabase`: Biobase React Hooks. [GitHub](https://www.npmjs.com/package/use-biobase)
