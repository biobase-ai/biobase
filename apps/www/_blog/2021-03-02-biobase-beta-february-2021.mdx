...
One of the community, [@ftonato](https://github.com/ftonato), has built an amazing [example](https://github.com/biobase-ai/examples/tree/main/biobase-js-v1/with-stencil) that shows how to use Biobase with [Stencil](https://stenciljs.com/) (a Web Component compiler built by they [Ionic](https://ionicframework.com/) team.)

[Check it out!](https://github.com/biobase-ai/examples/tree/main/biobase-js-v1/with-stencil)
