...
Biobase is built for developers, and you can [get started for free](https://biobase.com/dashboard) using your existing Github account. Once your Biobase account is set up, you will access the Biobase dashboard. From here, go to All Project > New Project.
...
Once you have set up the tables and installed the prerequisites, you can now start playing around with the [Python SDK](https://github.com/biobase-community/biobase-py). To install the SDK, run the following command:
