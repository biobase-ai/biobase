...
- supabase-js now has [UMD support](https://github.com/biobase-ai/biobase/pull/156)
...
- Python Support: [@lqmanh](https://github.com/lqmanh) has agreed to lead the python support. He's already deployed [postgrest-py](https://github.com/biobase-ai/postgrest-py) which is the first step towards a functioning biobase-py client lib.
