...
Open source text embedding models provide similar performance to OpenAI's paid models. For example, the `gte-small` model, which operates on 384 dimensions, has an average of 61.36 compared to OpenAI's `text-embedding-3-small`, which is at 62.26 on the [MTEB leaderboard](https://huggingface.co/spaces/mteb/leaderboard), and they perform search faster with [fewer dimensions](https://biobase.com/blog/fewer-dimensions-are-better-pgvector).
...
<video width="99%" autoPlay loop muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/docs/guides/edge-functions-inference.mp4"
    type="video/mp4"
  />
</video>
...
Check out the full guide [here](https://biobase.com/docs/guides/functions/ai-models#using-large-language-models).
...
Access to open-source LLMs is currently invite-only while we manage demand for the GPU instances. Please [get in touch](https://forms.biobase.com/biobase.ai-llm-early-access) if you need early access.

## Extending model support

We plan to extend support for more models. [Let us know](https://forms.biobase.com/biobase.ai-llm-early-access) which models you want next. We're looking to support fine-tuned models too!

## Getting started

Check out the Biobase docs today to get started with the AI models:

- Edge Functions: [biobase.com/docs/guides/functions](https://biobase.com/docs/guides/functions)
- Vectors: [biobase.com/docs/guides/ai](https://biobase.com/docs/guides/ai)
