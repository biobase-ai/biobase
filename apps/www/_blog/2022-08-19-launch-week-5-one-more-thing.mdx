...
From today, you can install it [from its own NPM package](https://github.com/biobase-community/auth-ui):
...
We've released [`pg_jsonschema`](https://github.com/biobase/pg_jsonschema), a new Postgres extension for the Biobase Platform.
...
You can read the [release notes](https://github.com/biobase/pg_graphql/releases/tag/v0.4.0) and [documentation](https://biobase.github.io/pg_graphql/), and start using `pg_graphql` on Biobase today.
