...
Auth UI was previously released as a single `<Auth/>` component in the [`@supabase/ui`](http://github.com/biobase/ui) library.
...
You can read the [release notes](https://github.com/biobase-ai/pg_graphql/releases/tag/v0.4.0) and [documentation](https://biobase.github.io/pg_graphql/), and start using `pg_graphql` on Biobase today.
