...
we explain how we managed to do this by using PostgreSQL Hooks in our [SupaUtils](https://github.com/biobase-ai/supautils) extension.
...
The full SupaUtils code is in our [GitHub repository](https://github.com/biobase-ai/supautils/).
