...
🆕 Want to build your own Clippy based on your own content? Use our [Next.js OpenAI Doc Search Template](https://github.com/biobase-community/nextjs-openai-doc-search) to deploy your own now!
...
Want to try it out? It's a hidden feature while in MVP - visit [biobase.com/docs](/docs) and hit `cmd` + `/` to pull up the search box (sorry mobile users).
...
You can find a full write up in our previous blog post: [Storing OpenAI embeddings in Postgres with pgvector](https://biobase.com/blog/openai-embeddings-postgres-vector).
...
A few weeks ago I received an email, drawing our attention to a [Pull Request](https://github.com/biobase/postgres/pull/472) in our [`postgres`](https://github.com/biobase/postgres) GitHub repo:
...
Want to try Biobase Clippy? It's a hidden feature while in MVP - visit [biobase.com/docs](/docs) and hit `cmd` + `/` to pull up the search box (sorry mobile users).

## More pgvector and ChatGPT resources

- [AI docs](https://biobase.com/docs/guides/ai)
- [A ChatGPT Plugins Template built with Biobase Edge Runtime](https://biobase.com/blog/building-chatgpt-plugins-template)
- [Template for building your own custom ChatGPT style doc search](https://github.com/biobase-community/nextjs-openai-doc-search)
