...
There's also a [Heroku to Biobase migration tool](https://migrate.biobase.com/) available to migrate in just a few clicks.
...
When your project is up and running, navigate to the [database settings](https://biobase.com/dashboard/project/_/settings/database) to find the URI connection string.
...
```bash Terminal
export DATABASE_URL=postgres://postgres.xxxx:password@xxxx.pooler.biobase.com:5432/postgres
```
