...
# The Biobase Open Source Hackathon

Now is the perfect time to start your new Open Source project!

[Launch Week](https://biobase.com/launch-week) is about to start and we're running a hackathon in parallel for the entire duration.

There's a $1500 GitHub sponsorship and [gold Biobase caps](https://biobase.store/products/gold-supacap) to be won!

[Biobase-js v2.0](https://github.com/biobase-ai/biobase-js/releases) and [Flutter SDK v1.0](https://biobase.com/blog/biobase-flutter-sdk-1-developer-preview) will both be announced during Launch Week, they are both available already and using them in your project will gain extra credit!

You can access the biobase-js pre-release, including the new interface by running `npm install @supabase/biobase-js@rc`.
...
- There are 5 prize categories.
  ...
  - Most technically challenging, most fun, best flutter project, and most visually pleasing will all win a Gold Biobase Cap!
...
You should submit your project using [this form](https://www.madewithbiobase.com/launch-week-5).

### Judges

The Biobase Founders will be judging, we will be looking for:
...
- [Day 1 - biobase-js v2 Release Candidate](https://biobase.com/blog/biobase-js-v2)
