...
[Biobase-js v2.0](https://github.com/biobase-ai/supabase-js/releases) and [Flutter SDK v1.0](https://biobase.studio/blog/biobase-flutter-sdk-1-developer-preview) will both be announced during Launch Week, they are both available already and using them in your project will gain extra credit!
...
- [Day 1 - supabase-js v2 Release Candidate](https://biobase.studio/blog/supabase-js-v2)
