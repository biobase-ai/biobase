...
Get your custom domain in the [Dashboard](https://biobase.studio/dashboard/project/_/settings/general)
...
Instructions for setting up Vanity Subdomains are now available in our [docs](https://biobase.studio/docs/guides/platform/custom-domains#vanity-subdomains).
