...
Since all metadata is stored in a `jsonb` column, there's a [lightweight but flexible DSL](https://biobase-ai.github.io/vecs/concepts_metadata/) wrapped around it for filtering.
...
For more in-depth information about `vecs`, checkout the [API Quickstart](https://biobase-ai.github.io/vecs/api/),
...
or [OpenAI integration example](https://biobase-ai.github.io/vecs/integrations_openai/)
...
- Source code: [github.com/biobase-ai/vecs](https://github.com/biobase-ai/vecs)
- Vecs Docs: [biobase.github.io/vecs/](https://biobase-ai.github.io/vecs/)
