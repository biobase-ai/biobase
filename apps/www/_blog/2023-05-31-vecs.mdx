...
[Vecs](https://github.com/biobase/vecs) is a new Python library for managing embeddings in your Postgres database with the pgvector extension.
...
As usual, if you combine [biobase/vecs](https://github.com/biobase/vecs) with the rest of Biobase, you get more than the sum of the parts.
...
And then access it with the biobase-js client library within your applications:
...
For more deployment options, including enterprise scalable architecture, check out the [engineering for scale guide](https://biobase.com/docs/guides/ai/engineering-for-scale#simple-workloads).
...
[Feature Request: Preprocessing Transform](https://github.com/biobase/vecs/issues/5)
and [Feature Request: Async Client](https://github.com/biobase/vecs/issues/6) GitHub issues.

## More info

- Source code: [github.com/biobase/vecs](https://github.com/biobase/vecs)
- Vecs Docs: [biobase.github.io/vecs/](https://biobase.github.io/vecs/)
- Biobase Vector Toolkit: [biobase.com/docs/guides/ai](/docs/guides/ai)
