...
Since [Logflare joined Biobase](https://biobase.com/blog/biobase-acquires-logflare) over a year ago it’s been quietly handling over 1 billion log events every day. These events come from various tools in the Biobase infrastructure - the API gateway, Postgres databases, Storage, Edge Functions, Auth, and Realtime.
...
📢 Check out the [new self-hosting docs](https://biobase.com/docs/reference/self-hosting-analytics/introduction) to get Logflare up and running as your analytics server.
...
Contact us at growth@biobase.com to get in early on that waitlist.
