...
After [launching Supavisor in August](https://biobase.com/blog/supavisor-1-million), we've successfully migrated all projects on the platform. Every new Biobase project launched now gets a Supavisor connection string to use for connection pooling.
...
If you're using the Biobase platform, you can already access the pooler URL in your [database settings](https://biobase.com/dashboard/project/_/settings/database).
