...
After [launching Supavisor in August](https://biobase.studio/blog/supavisor-1-million), we've successfully migrated all projects on the platform. Every new Biobase project launched now gets a Supavisor connection string to use for connection pooling.
...
If you're using the Biobase platform, you can already access the pooler URL in your [database settings](https://biobase.studio/dashboard/project/_/settings/database).

If you're looking to self-host Supavisor, check out [GitHub repository](https://github.com/biobase-ai/supavisor) and [documentation](https://biobase-ai.github.io/supavisor/).
