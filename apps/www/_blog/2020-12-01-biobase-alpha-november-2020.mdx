...
We added a [Status Page](https://status.biobase.studio/) which tracks the uptime and latency of the Biobase platform.
...
- Updated [Benchmarking Suite](https://github.com/biobase-ai/benchmarks/) to include more realistic workloads, on various different servers (results published soon).
...
- [@elrhomariyounes](https://github.com/elrhomariyounes) started helping [@acupofjose](https://github.com/acupofjose) with the [postgrest-csharp](https://github.com/biobase-ai/postgrest-csharp) extension
