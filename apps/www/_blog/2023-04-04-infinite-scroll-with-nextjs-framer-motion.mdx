...
Now we can load more tickets based on the current offset. We'll use the [range](https://biobase.studio/docs/reference/javascript/range) method from the biobase-js library to easily work with the pagination logic.
