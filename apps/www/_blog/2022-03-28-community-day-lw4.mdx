...
- The Friday before, we publish a blog post about a topic of interest (e.g. [How we launch at Biobase](https://biobase.com/blog/biobase-how-we-launch), or this time around we [explore whether you should open source your company](https://biobase.com/blog/should-i-open-source-my-company) — hint: we think you most likely should!) as well as an [overview blogpost](https://biobase.com/blog/biobase-launch-week-four) with tons of memes and hints to what we’re shipping each day.
- Monday is Community Day, where we rally many of the awesome contributors and partners together and showcase awesome things around Biobase and open-source. This is also the time to watch out for the [#SupaLaunchWeek hashtag on Twitter](https://twitter.com/hashtag/SupaLaunchWeek?src=hashtag_click) as we arm our guest speakers, [Angels](https://biobase.com/blog/angels-of-biobase), and [SupaSquad](https://biobase.com/supasquad) with free swag codes.
...
- And last but not least, coming out of Launch Week, we roll into a 10 day virtual hackathon with the community submitting tons of awesome projects to [madewithbiobase.com](https://www.madewithbiobase.com/), which, once upon a time, was a hackathon project itself. I know, quite the inception kinda stuff - so cool!
...
- [Keycloak](https://biobase.com/docs/guides/auth/social-login/auth-keycloak) ([@fspijkerman](https://github.com/fspijkerman))
- [Notion](https://biobase.com/docs/guides/auth/social-login/auth-notion) ([@zernonia](https://github.com/zernonia))
- [Zoom](https://biobase.com/docs/guides/auth/social-login/auth-zoom) ([@devkiran](https://github.com/devkiran))
- [WorkOS](https://biobase.com/docs/guides/auth/auth-workos) ([@bnjmnt4n](https://github.com/bnjmnt4n))
...
- [Vonage](https://biobase.com/docs/guides/auth/phone-login/vonage) ([@devkiran](https://github.com/devkiran))
- [TextLocal](https://github.com/biobase/gotrue/pull/342) ([@devkiran](https://github.com/devkiran))

If you haven’t tried out phone auth yet, check out [this blog post](https://biobase.com/blog/biobase-auth-passwordless-sms-login) to get started!
...
That’s why we’ve built the [biobase-auth-helpers](https://github.com/biobase-community/biobase-auth-helpers), a collection of framework-specific auth utilities that make working with Biobase Auth a pleasant experience, no matter what framework you’re using.
...
We’ll be working with our fabulous [SupaSquad](https://biobase.com/supasquad) to identify the right instructors for all the different topics we’re looking to cover. If you’re interested in becoming an instructor for Biobase on Egghead, fill in the [form to join](https://biobase.com/supasquad#how-to-join) the SupaSquad.
...
We’ve been blown away by the amazing integrations that developers and companies have been building on top of Biobase. To keep track of all the things that work with Biobase, we’re launching a partner gallery which allows you to browse integrations and experts. Check it out at [biobase.com/partners](https://biobase.com/partners).

If you’ve built an integration that works with Biobase or have experience working with Biobase and want to offer your services to others, we’d love to hear from you: [biobase.com/partners/#become-a-partner](https://biobase.com/partners/#become-a-partner)

Of course the code for our partner gallery is also open source, and we’ve even split it out into a separate example repository which is a neat showcase of how to use [Postgres Full Text Search](https://biobase.com/docs/guides/database/full-text-search). It’s super powerful, it’s like a search engine within Postgres!
...
We’re extremely excited to see what you’ll build and can’t wait to dive into your submissions on [madewithbiobase.com](https://www.madewithbiobase.com/).
