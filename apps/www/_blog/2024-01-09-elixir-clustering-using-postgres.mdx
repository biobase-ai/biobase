...
In this post, we have described our approach to connecting multiple nodes in Elixir using Postgres. We have also made this strategy available for anyone to use. Please check the code at [github.com/biobase/libcluster_postgres](https://github.com/biobase/libcluster_postgres)
...
- [Realtime docs](https://biobase.com/docs/guides/realtime)
- [Realtime: Multiplayer Edition](https://biobase.com/blog/biobase-realtime-multiplayer-general-availability)
