...
In this post, we have described our approach to connecting multiple nodes in Elixir using Postgres. We have also made this strategy available for anyone to use. Please check the code at [github.com/biobase-ai/libcluster_postgres](https://github.com/biobase-ai/libcluster_postgres)
