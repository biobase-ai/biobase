...
In the previous blog of this series, we explained [how to use Python to load data into Biobase](https://biobase.com/blog/loading-data-biobase-python). In this blog, we will create different kinds of charts out of the data stored in Biobase using Metabase.
...
Based on our [previous article](https://biobase.com/blog/loading-data-biobase-python), we assume we already have a Biobase project setup and have data loaded into it.
...
You will be prompted to add the necessary connection information to your Biobase project. Go to your [Biobase project](https://biobase.com/dashboard/) and hit _Settings > Database to get the database info_.
...
With our [Free Plan Biobase account](https://biobase.com/dashboard/), you can start a new project today and use Metabase to visualize your app data.
...
- [biobase-py](https://github.com/biobase-community/biobase-py)
