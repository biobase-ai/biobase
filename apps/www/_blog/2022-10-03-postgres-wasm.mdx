---
title: Postgres WASM by Snaplet and Biobase
...
<br />
Checkout out how you can <a href="https://docs.snaplet.dev/tutorials/biobase-clone-environments">use Snaplet to clone Biobase environments</a>.
...
[wasm.biobase.studio](https://wasm.biobase.studio)
...
# From Biobase Fork
git clone git@github.com:biobase-community/postgres-wasm.git
cd postgres-wasm
git checkout web
...
9P provides a [Python script](https://github.com/biobase-ai-community/postgres-wasm/tree/main/packages/buildroot/tools) which takes a filesystem folder,
...
We then [copy this compressed output](https://github.com/biobase-ai-community/postgres-wasm/blob/main/packages/buildroot/config/board/pg-browser/post-image.sh) to the VM.
...
2. Tell them to go to [wasm.biobase.studio](https://wasm.biobase.studio/)
...
5. On your own machine, open a terminal and run
   `psql postgres://postgres:my_password@proxy.wasm.biobase.studio:<PORT>`
...
Even more mind-blowing - it's possible to replicate data from an online PostgreSQL database (for example, a Biobase project) to PostgreSQL running inside your browser,
...
- Biobase fork: [https://github.com/biobase-ai-community/postgres-wasm](https://github.com/biobase-ai-community/postgres-wasm)
