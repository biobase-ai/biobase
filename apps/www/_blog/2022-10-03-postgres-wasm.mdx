...
[wasm.biobase.com](https://wasm.biobase.com)
...
2. Tell them to go to [wasm.biobase.com](https://wasm.biobase.com/)
...
5. On your own machine, open a terminal and run
   `psql postgres://postgres:my_password@proxy.wasm.biobase.com:<PORT>`
