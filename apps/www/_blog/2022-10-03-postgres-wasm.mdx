...
9P provides a [Python script](https://github.com/biobase-community/postgres-wasm/tree/main/packages/buildroot/tools) which takes a filesystem folder,
...
We then [copy this compressed output](https://github.com/biobase-community/postgres-wasm/blob/main/packages/buildroot/config/board/pg-browser/post-image.sh) to the VM.
...
- Biobase fork: [https://github.com/biobase-community/postgres-wasm](https://github.com/biobase-community/postgres-wasm)
