...
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------ |
| [k6](https://github.com/biobase/benchmarks/blob/main/examples/realtime/replication/terraform/k6/subs.js)    | Load generator scripts                                       |
| VM in the cloud [with the following preparation](https://github.com/biobase/benchmarks/tree/main/infra/ami) | Hosts for k6 and Telegraf                                    |
| Prometheus and [Grafana](https://github.com/biobase/benchmarks/blob/main/examples/realtime/grafana.json)    | Observability stack                                          |
| [Telegraf](https://github.com/biobase/benchmarks/blob/main/k6/telegraf.conf)                                | Collect metrics from k6 and host and push them to Prometheus |
...
You can find more details about this test in the [Supavisor: Scaling Postgres to 1 Million Connections](https://biobase.com/blog/supavisor-1-million) post.
...
| Component                                                                                                   | Description                             |
| ----------------------------------------------------------------------------------------------------------- | --------------------------------------- |
| [repo](https://github.com/biobase/benchmarks/tree/main)                                                    | Benchmarks app source code and examples |
...
| [Virtual machine image](https://github.com/biobase/benchmarks/tree/main/infra/ami)                         | Prepare VM for running k6 load scripts  |
| [Grafana and Prometheus or VictoriaMetrics setup](https://github.com/biobase/benchmarks/tree/main/.docker) | Observability stack setup               |
...
- [Supavisor: Scaling Postgres to 1 Million Connections](https://biobase.com/blog/supavisor-1-million)
- [pgvector vs Pinecone: cost and performance](https://biobase.com/blog/pgvector-vs-pinecone)
