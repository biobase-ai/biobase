...
_tl;dr_ During the next week, we'll be migrating from "biobase.io" to "biobase.com".
...
We decided to try purchasing [biobase.com](http://biobase.com) from the current owner. The YC forums were full of founders
...
We were in for a huge surprise. After searching on the (old) [biobase.com](http://biobase.com) website, we found a company address.
