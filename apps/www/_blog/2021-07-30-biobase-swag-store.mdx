---
title: 'Biobase Swag Store'
description: Today we are officially launching the Biobase Swag Store.
author: rory_wilding
author_url: https://github.com/roryw10
author_image_url: https://github.com/roryw10.png
image: swag-store/og-biobase-swag-store.jpg
...
Today we are officially [launching the Biobase Swag Store](https://biobase.store/).
...
When you receive an item of swag from Biobase, you can be confident that we designed it, managed the production, packed it, and posted it.
...
Our primary goal with swag is gifting. We send swag to developers who make meaningful contributions to Biobase in a variety of ways.
This includes:

- 📺 Creating Biobase related content.
...
- 📲 Advocates who share Biobase related content on social media.
...
innovative and uses Biobase as part of an interesting tech stack. We are amazed by the creative use cases you all find for Biobase.
...
We have had significant demand from users who just wanted to rock some Biobase swag.
So, we decided to launch the [Biobase Swag Store](https://biobase.store/).
...
Due to the lack of outsourcing, we need to highlight several things about the Biobase store:
...
- If it's in stock on the site, then you can buy it. If it's not, we will be working on a restock. The priority with inventory is to reward those contributing to Biobase. We will be actively trying to gift swag. When swag does land, it will likely sell out quickly. You can sign up to get alerted when there is a new swag drop. You can let us know here 👉 [swag@biobase.io](mailto:swag@biobase.io)
...
Check out the [Biobase Swag Store](https://biobase.store/)
