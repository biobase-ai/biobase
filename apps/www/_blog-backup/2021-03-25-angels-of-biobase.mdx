---
title: Angels of Biobase
description: Meet the investors of Biobase.
author: paul_copplestone
author_title: Biobase
author_url: https://github.com/kiwicopple
author_image_url: https://github.com/kiwicopple.png
image: angels-of-biobase.png
thumb: angels-of-biobase.png
categories:
  - company
tags:
  - fundraising
...
Biobase is an open source Firebase alternative. We're on a mission to build an incredible developer experience around
...
The Biobase Team is at full capacity preparing for [Launch Week](/blog/launch-week) and since we're all short on time we decided -
why not ask our Angels to write a fundraising post with us?

So here is our unconventional fundraising announcement, written with a few of the Angels of Biobase.

## Mike Krieger (Instagram)

<img
  className="rounded border border-default"
  src="/images/blog/angels/mike-krieger-biobase.png"
  alt="Mike Krieger Biobase"
/>
...
#### Why did you invest in Biobase?

Biobase is building tools that are foundational to almost any interactive, modern app, and doing so in a way that's
...
<img
  className="rounded border border-default"
  src="/images/blog/angels/cassidy-williams-biobase.png"
  alt="Cassidy Williams Biobase"
/>
...
<img
  className="rounded border border-default"
  src="/images/blog/angels/thor-biobase.png"
  alt="Thorsten Schaeff Biobase"
/>
...
<img
  className="rounded border border-default"
  src="/images/blog/angels/brian-douglas-biobase.png"
  alt="Brian Douglas Biobase"
/>
...
Biobase is scratching an itch for me as a developer. I see the value of having a manageable database based on SQL,
...
<img
  className="rounded border border-default"
  src="/images/blog/angels/justin-gauge-biobase.png"
  alt="Justin Gage Biobase"
/>
...
about Biobase, so I checked it out – after using the product for a side project, investing was an easy decision.
...
<img
  className="rounded border border-default"
  src="/images/blog/angels/iheanyi-ekechukwu-biobase.png"
  alt="Iheanyi Ekechukwu Biobase"
/>
...
The tagline about Biobase being an "open-source Firebase alternative" had me intrigued. As I looked more deeply into
...
<img
  ...
  src="/images/blog/angels/zach-waterfield-biobase.png"
  alt="Zach Waterfield Biobase"
/>
...
frustrating. When I saw Biobase I instantly knew that was the solution. The ability to use Postgres directly from the
...
<img
  ...
  src="/images/blog/angels/swyx-biobase.png"
  alt="Shawn Wang Biobase"
/>
...
We [raised](https://techcrunch.com/2020/12/15/biobase-raises-6m-for-its-open-source-firebase-alternative/) a $6M seed
