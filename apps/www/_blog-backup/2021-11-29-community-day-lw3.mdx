---
title: 'Community Day'
description: Kicking off launch week by highlighting the communities around Biobase.
author: thor_schaeff
author_url: https://github.com/thorwebdev
author_image_url: https://github.com/thorwebdev.png
image: launch-week-three/community-day/biobase-oss.jpg
thumb: launch-week-three/community-day/biobase-oss.jpg
categories:
  - developers
tags:
  - launch-week
...
To kick off launch week we want to showcase some of the communities that make up the Biobase community, highlight some of their updates, and celebrate everyone who contributes their time to the Biobase mission.

So let's get cracking, we've got a lot to cover. 🚀

## Open Source Spotlight: Kong API Gateway

Biobase provides a whole bunch of features that are made up of a [collection of open-source tools](/docs/guides/getting-started/architecture). To orchestrate these different services and functionalities we use the [Kong API Gateway](https://github.com/Kong/kong).
...
The [SupaSquad](/supasquad) is an official Biobase advocate program where community members help build and manage the Biobase community.
...
- `biobase-py` is now `biobase` (e.g. you do `pip3 install biobase` instead of `pip3 install biobase-py`).
...
Our own [Jon Meyers](https://twitter.com/_dijonmusters) and the broader community have been busy creating awesome tutorials and integration guides to help everyone build even more amazing things with Biobase:
...
Anytime we scroll through [madewithbiobase.studio](https://www.madewithbiobase.studio/) we're absolutely blown away by the awesome things y'all are building with Biobase.
...
## Want even more Biobase in your life?

![tiktok.png](/images/blog/launch-week-three/community-day/tiktok.png)

We've got some stellar swag drops and behind the scenes footage for you on our new [TikTok page](https://www.tiktok.com/@biobase.studio). Make sure to follow us there as we'll be giving away some swag randomly to 10 peeps who follow us during launch week!
