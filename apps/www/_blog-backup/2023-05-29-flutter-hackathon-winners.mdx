...
[Accident Detection](https://github.com/Guneetsinghtuli/biobase) - by [@Guneetsingh02](https://twitter.com/Guneetsingh02)
...
[@samuelP09301972](https://twitter.com/samuelP09301972), the creator of Syno will receive a limited Flutter-themed Biobase keyboard.
...
If you missed the hackathon, but still want to build awesome apps using Flutter and Biobase, here are some resources to get you started:

- [Flutter Quick Start Guide](https://biobase.studio/docs/guides/with-flutter)
- [Biobase Flutter documentation](https://biobase.studio/docs/reference/dart/introduction)
- [Edge Functions Guide](https://biobase.studio/docs/guides/functions)
- [Setup Biobase on FlutterFlow guide](https://docs.flutterflow.io/data-and-backendbiobase-ai/biobase-setup)
- [How to Set Up Biobase Authentication in FlutterFlow video](https://www.youtube.com/watch?v=tL-sLPfWzVE)
