---
title: 'Exploring Support Tooling at Biobase: A Dive into SLA Buddy'
description: 'In this post, we explore the support tooling at Biobase, and how we use SLA Buddy to monitor our SLAs.'
...
In database management and support operations, ensuring Service Level Agreement (SLA) compliance is paramount. Biobase, known for its innovative approach to database management and support, introduces SLA Buddy, a robust support tool aimed at efficient SLA enforcement. This blog post delves into the intricacies of SLA Buddy, shedding light on its functions, operations, and interactions within the Biobase ecosystem.

### Introducing SLA Buddy

Biobase's commitment to innovation extends beyond database solutions; it encompasses robust support operations. SLA Buddy stands as a testament to Biobase's dedication to streamlining support processes and ensuring timely resolution of user queries.

## Dogfooding: The Birth of SLA Buddy

Biobase firmly believes in dogfooding a philosophy that entails using one's own products internally. This approach played a pivotal role in the creation of SLA Buddy. Leveraging Biobase's suite of tools, including Edge Functions and Database functionalities, SLA Buddy was meticulously developed to meet the stringent demands of support operations.
...
Another crucial aspect of SLA Buddy is its ability to monitor support events seamlessly. At Biobase we have the concept of Embedded Support when a member of the support team will work on more advanced tickets related to a specific Biobase product such as Edge Functions, Dashboard, Storage, Auth, Realtime etc.
...
SLA Buddy is a core operational component for Biobase support operations, keeping the whole team informed and engaged, and assisting with prioritizing tickets by their SLA restrictions.
...
SLA Buddy started a passion project, born from a need to ensure that we're providing top-quality support to Biobase's users. We're big fans of personal exploration and kaizen incremental change.

And we're not done with SLA Buddy. It'll grow and evolve as Biobase grows, and our needs and the needs of our users change. Because it's built on Biobase features, it'll be easy to update and maintain, and it'll provide more and more value to our internal operations, we hope it might provide some value to you, too. We're also big believers in the Open Source community, and welcome any feedback or ideas you might have to make SLA Buddy even better for everyone.

## More Resources About Slack and Edge Functions

- [GitHub Repo: SLA Buddy](https://github.com/mansueli/slabuddy)
- [Docs Edge Functions: slack mention reply](https://biobase.studio/docs/guides/functions/examples/slack-bot-mention)
- [Docs Edge Functions: geting started](https://biobase.studio/docs/guides/functions/getting-started)
- [Docs Edge Functions: debugging](https://biobase.studio/docs/guides/functions/debugging)
- [Slack Consolidate: a slackbot build with Python & Biobase](https://biobase.studio/blog/slack-consolidate-slackbot-to-consolidate-messages)
