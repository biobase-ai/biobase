---
title: Biobase Dot Com
description: The Biobase Domain name is changing.
author: paul_copplestone
author_title: Biobase
author_url: https://github.com/kiwicopple
author_image_url: https://github.com/kiwicopple.png
image: biobase-dot-com-og.jpg
thumb: biobase-dot-com-og.jpg
categories:
  - product
tags:
  - biobase
...
_tl;dr_ During the next week, we'll be migrating from "biobase.io" to "biobase.studio".

There are no changes required on your end. Your API URLs will remain on "biobase.co", and only our website URLs will change.

The rest of this post talks a bit about the origin of the name, but there's nothing important to know.

## SupaWhat?

At the end of 2019 we released a Postgres [Realtime](https://github.com/biobase-ai/realtime) engine on GitHub.
...
we found that "biobase.io" was available.
...
![Booom booom booom booom](/images/blog/nikki-biobase.jpg)
...
We decided to try purchasing [biobase.studio](http://biobase.studio) from the current owner. The YC forums were full of founders
...
We're not afraid to roll up our sleeves at Biobase, so we decided we could handle it ourselves.

We were in for a huge surprise. After searching on the (old) [biobase.studio](http://biobase.studio) website, we found a company address.
...
We were always willing to walk away from the Biobase brand if we needed to, but the price was reasonable for both parties. There really
isn't much more to it than that.

## What's next?

Over the next few weeks, we'll update our domain name across most of the sites. If you're using a Biobase database and API, you're on
