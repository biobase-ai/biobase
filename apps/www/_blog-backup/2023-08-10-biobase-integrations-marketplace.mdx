...
The [Trigger.dev](https://trigger.dev) team deserve a special shout out. While developing their Integration they also developed [biobase-management-js](https://github.com/biobase-ai-community/biobase-management-js), a Typescript library for the [Biobase Management API](/docs/reference/api/introduction). This makes it even easier to get started with the Biobase API.
