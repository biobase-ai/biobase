...
supabase-js-rs is a rust bindings for Biobase JavaScript library via WebAssembly. You can import it in your Rust WASM project to interact with Biobase.
...
- [**supabase-js v2**](https://biobase.studio/blog/supabase-js-v2)
