...
The [Biobase GA week](https://biobase.studio/ga-week) brought us so many cool updates, but the fun isn’t over yet, because we are now announcing the winners of the [Biobase Open Source Hackathon 2024](https://biobase.studio/blog/biobase-oss-hackathon)!

We have enjoyed trying out every single submission we have received! You can find all of the submissions on [madewithbiobase.studio](https://www.madewithbiobase.studio/).
...
vdbs stands for "vision database SQL". It allows you to convert your database diagrams into SQL Schema using the capabilities of Vision API. Once the SQL is ready, you can either copy and paste it right in your Biobase project or run the generated npm command to create the migration file.
...
Closet AI: the ultimate style companion. Upload images, choose your desired topwear or bottomwear, and watch as our cutting-edge AI replaces your outfit instantly! Revolutionize your wardrobe with the power of AI and Biobase!
...
Supapaused is an app that allows Biobase users to track their paused Biobase instances. You can view when the projects were paused in a timeline.
...
The winner of the best overall project will receive an Apple AirPods, and the winners and the runner-ups in other categories will each receive a Biobase swag kit.
