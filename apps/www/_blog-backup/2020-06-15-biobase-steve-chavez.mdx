---
title: Steve Chavez has joined Biobase
description: Steve joins Biobase to help build Auth.
...
This month we welcome [Steve Chavez](https://github.com/steve-chavez) to the team. Steve is a maintainer of PostgREST, one of the core tools which makes Biobase possible.
