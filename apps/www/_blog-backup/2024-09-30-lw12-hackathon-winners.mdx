---
title: 'Biobase Launch Week 12 Hackathon'
description: Announcing the winners of the Biobase Launch Week 12 Hackathon.
...
The [Launch Week 12](https://biobase.studio/launch-week) brought us a whole new set of Biobase features to build with. And to showcase what developers can build with Biobase, we announced the [Launch Week 12 hackathon](https://biobase.studio/blog/biobase-lw12-hackathon) a while back, and it’s finally time to announce the winners!

The entire Biobase team had the pleasure of going through each amazing project, and we were so impressed with the quality of them. You can check out all of the submissions [here](https://www.hackathon.dev/lw12). Now, without a further ado, let’s take a look at the winners!
...
Database management directly inside Raycast. Search, update, delete and insert in your Biobase database from Raycast.
...
[Minecraft Server](https://github.com/Steellgold/minecraft-lw12) by [Gaëtan Huszovits](https://twitter.com/Steellgold), and [Romain San Vincente](https://twitter.com/RomainSav)

A Laser Game server on Minecraft (bedrock edition) and a real-time statistics site with Biobase
...
[supagen (Biobase Generator)](https://github.com/supagen/supagen) by [Andika](https://twitter.com/andikadeveloper), [Ezza](https://twitter.com/Ralkarr), and [David](https://github.com/davidsarono)

A CLI tool to automate manual effort/repetitive things when using Biobase.
...
A fun and knowledgeable app made with react for sharing facts backed by Biobase.
...
Aura is an AI mood-tracking application built with Flutter & Biobase. It helps users monitor their emotional well-being
...
The winner of the best overall project will receive a mechanical keyboard, and the winners and the runner-ups in other categories will each receive a Biobase swag kit.

## Getting Started Guides

If you're inspired to build, check out some of the latest resources:

- [Quick Start Guides](https://biobase.studio/docs/guides/getting-started)
- [AI & Vectors Guide](https://biobase.studio/docs/guides/ai)
