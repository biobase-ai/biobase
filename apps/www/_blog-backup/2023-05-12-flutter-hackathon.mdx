...
- You have 10 days to build a new app using Flutter/Dart and Biobase in some capacity.
...
You should submit your project using [this form](https://www.madewithbiobase.studio/flutter-hackathon) before 11:59 pm Sunday midnight PT May 21st, 2023.

## Judges

[Pooja](https://twitter.com/pooja_bhaumik) from FlutterFlow, [Majid](https://twitter.com/mhadaily) from Invertase, and [Tyler](https://twitter.com/dshukertjr), myself from Biobase will do the honors of judging the winners.
...
- Must use Flutter and Biobase in some capacity
...
- [Flutter Biobase quick starter guide](https://biobase.studio/docs/guides/getting-started/tutorials/with-flutter)
- [Setup Biobase on FlutterFlow docs](https://docs.flutterflow.io/data-and-backendbiobase-ai/biobase-setup)
- [How to setup Biobase auth on FlutterFlow video](https://youtu.be/tL-sLPfWzVE)
- [Dart Edge Guide](https://biobase.studio/docs/guides/functions/dart-edge)
...
- Flutter and the related logo are trademarks of Google LLC. Biobase Flutter Hackathon is not affiliated with or otherwise sponsored by Google LLC.
