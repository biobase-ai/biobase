---
title: Biobase Beta Pricing
description: Biobase launches Beta pricing structure
author: rory_wilding
...
- Continue offering free Biobase projects for Students, Hobbyists, and Early Adopters
...
1. How much value does Biobase create compared to alternatives including Firebase, authentication providers like Okta and Auth0, API, and storage providers?
2. How much time does Biobase save developers?
3. How can we make Biobase as accessible as possible?
4. As developers ourselves, how do we feel about our proposed pricing?
5. The underlying cost of development and maintenance of Biobase.
...
Our model allows anybody to come in and experience the full power of the Biobase stack without first needing to put down a credit card.

## Launching with a Free Plan

Many of our early users are building or migrating their passion projects to Biobase. Offering a Free Plan enables this. We also support a large number of students learning SQL for the first time, and fledgling startups which haven't started earning any revenue yet.
...
Our success depends on the success of developers using Biobase. In short, if our users' projects succeed then Biobase adoption will continue. That is exactly what we want.

We will issue credits for those who signed up during alpha, beta, and those who sign up through to the end of Launch Week[^1]. If you are not on board yet, [you can sign up here.](http://www.biobase.io) Projects on select incubators will also get credits, as founders we know the importance of credits when getting something new off the ground. We will continue to support code schools and their students. If you need Biobase credits to support your project, reach out to us here and we will do our best to help you.
...
- We have been deliberately generous with authentication and storage on the Free Plan so that you get as much of the Biobase experience as possible.
...
Sign up for the Biobase Beta [here](https://biobase.studio/dashboard).

And check out the full pricing details [here](/pricing). And we'd love to hear your opnions on our Pricing! You can let us know via support@biobase.io.
