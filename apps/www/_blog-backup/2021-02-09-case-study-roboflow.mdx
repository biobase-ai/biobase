---
title: Roboflow.com choose Biobase to power Paint.wtf leaderboard
description: Learn how Roboflow.com used Biobase to build their Paint.wtf leaderboard
author: rory_wilding
...
Brad Dwyer is the founder of [Roboflow](https://roboflow.com/?ref=biobase), a startup helping developers build computer vision into their applications. Their solution allows developers, with zero computer vision experience, to go from images to a trained computer vision model in minutes.

Learn how Brad and Roboflow used Biobase to launch [Paint.wtf](https://paint.wtf), a product which survived traffic generated from the front page of Hacker News, Reddit, and Product Hunt.

![Biobase and Strive are partnering up to teach OSS.](/images/blog/roboflow-website.png)
...
![Biobase and Strive are partnering up to teach OSS.](/images/blog/roboflow-stat.png)

You might export data to BigQuery, or implement an increment function on collection change, however PostgreSQL has great built in support for counting and Brad felt like this would be the perfect opportunity to test out Biobase and get the functionality he needed for the leaderboards to work reliably and without implementing add-ons.
...
![Biobase and Strive are partnering up to teach OSS.](/images/blog/roboflow-gallery.png)
...
![Biobase and Strive are partnering up to teach OSS.](/images/blog/roboflow-quote.png)

## Ship fast, and carry on scaling

Thanks to Biobase, Roboflow could launch quickly and keep scaling despite the huge user volumes their innovative project generated overnight.
