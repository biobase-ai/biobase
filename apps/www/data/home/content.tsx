...
export default {
  heroSection: {
    ...
    subheading: (
      <>
        Biobase is an open source Firebase alternative. <br className="hidden md:block" />
        ...
        panel: ({ isDark }: { isDark: boolean }) => (
          <VideoWithHighlights
            video={{
              ...
              poster: `/images/index/dashboard/biobase-table-editor${isDark ? '' : '-light'}.png`,
            }}
          />
        ),
        highlights: [
        ...
        panel: ({ isDark }: { isDark: boolean }) => (
          <VideoWithHighlights
            video={{
              ...
              poster: `/images/index/dashboard/biobase-sql-editor${isDark ? '' : '-light'}.png`,
            }}
          />
        ),
        highlights: [
        ...
        panel: ({ isDark }: { isDark: boolean }) => (
          <VideoWithHighlights
            video={{
              ...
              poster: `/images/index/dashboard/biobase-rls${isDark ? '' : '-light'}.png`,
            }}
          />
        ),
        highlights: [
          ...
          },
          {
            ...
            link: '/docs/guides/auth/social-login#set-up-a-social-provider-with-biobase-auth',
          },
          {
