...
export default (isMobile?: boolean) => ({
  metaTitle: 'Biobase Vector | The Postgres Vector database and AI Toolkit',
  metaDescription:
  ...
  highlightsSection: {
    highlights: [
      ...
      },
      {
        ...
        paragraph:
          'Biobase is SOC2 Type 2 compliant, and comes with an advanced permissions system.',
  ...
  useCasesSection: {
    title: (
      <>
        ...
        <br />
        <span className="heading-gradient">with Biobase Vector?</span>
      </>
    ),
  ...
  featuresSection: {
    ...
    features: [
      ...
      },
      {
        ...
        text: 'Biobase uses open source tools to increase portability and avoid lock-in, making it easy to migrate in and out.',
      },
      {
    ...
    customers: [
      {
        ...
        target: '_blank',
        quote:
          'We store embeddings in a PostgreSQL database, hosted by Biobase, to perform a similarity search to identify the most relevant sections within the MDN.',
        image: '/images/customers/logos/mozilla.png',
        abstract:
          'MDN introduces an AI assistant powered by Biobase Vector to answer all web development questions in real time.',
      ...
      },
      {
        ...
        quote:
          'Biobase Vector powered by pgvector allowed us to create a simple and efficient product. We are storing over 1.6 million embeddings and the performance and results are great. Open source develop can easily contribute thanks to the SQL syntax known by millions of developers.',
        image: '/images/customers/logos/quivr.png',
        abstract: 'Quivr launch 5,000 Vector databases on Biobase.',
        url: '/customers/quivr',
      },
      {
        type: 'customer-story',
        ...
        abstract: 'Mendable switches from Pinecone to Biobase for PostgreSQL vector embeddings.',
