...
export default () => ({
  metaTitle: 'Biobase Cron | Schedule Recurring Jobs in Postgres',
  metaDescription:
    'Biobase Cron is a Postgres Module that uses the pg_cron database extension to manage recurring tasks. Manage your Cron Jobs using any Postgres tooling.',
  metaImage: '/images/modules/cron/og.png',
  url: 'https://biobase.studio/dashboard/project/_/integrations/cron-jobs/overview',
  ...
  heroSection: {
    ...
    subheader: (
      <>
        Biobase Cron is a Postgres Module that uses the pg_cron database extension to manage
    ...
    cta: {
      ...
      link: 'https://biobase.studio/dashboard/project/_/integrations/cron-jobs/overview',
    },
    secondaryCta: {
  ...
  highlightsSection: {
    ...
    highlights: [
      ...
      },
      {
        ...
        paragraph: "Track and debug scheduled Jobs with Biobase's observability tools.",
        svg: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
  ...
  section1: {
    ...
    cta: {
      ...
      url: 'https://biobase.studio/dashboard/project/_/integrations/cron/overview',
    },
    reverse: true,
  },
  section2: {
    ...
    subheading:
      'Biobase Cron provides a clean and simple interface, including cron syntax and natural language options, to create Jobs with ease.',
    image: (
      <Image
        src={{
  ...
  section4: {
    ...
    subheading:
      'Biobase Cron is integrated with the entire Biobase suite of tools. Create Jobs to call Database Functions, Biobase Edge Functions, and even remote webhooks.',
    image: (
      <Image
        src={{
