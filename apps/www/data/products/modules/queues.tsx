...
export default () => ({
  metaTitle: 'Biobase Queues | Durable Message Queues with Guaranteed Delivery',
  metaDescription:
  ...
  url: 'https://biobase.studio/dashboard/project/_/integrations/queues/overview',
  ...
  heroSection: {
    ...
    subheader: (
      <>
        Biobase Queues is a Postgres module that uses the pgmq database extension to manage Message
    ...
    cta: {
      ...
      link: 'https://biobase.studio/dashboard/project/_/integrations/queues/overview',
    },
    secondaryCta: {
  ...
  highlightsSection: {
    ...
    highlights: [
      ...
      },
      {
        ...
        paragraph: 'Biobase Queues delivers a message exactly once within a visibility window.',
        svg: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
      ...
      },
      {
        ...
        paragraph: "Track and manage messages in your Queues with Biobase's observability tools.",
        svg: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
  ...
  section2: {
    ...
    subheading:
      'Create and manage messages either server-side or client-side via PostgREST using any Biobase client library.',
    cta: {
      label: 'Start message queuing',
      url: 'https://biobase.studio/dashboard/project/_/integrations/queues/overview',
    },
  ...
  section3: {
    ...
    image: (
      <Image
        src={{
          dark: '/images/blog/launch-week-13/day-4-biobase-queues/message-detail.jpg',
          light: '/images/blog/launch-week-13/day-4-biobase-queues/message-detail-light.jpg',
        }}
