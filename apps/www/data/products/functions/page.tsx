...
export default (isMobile?: boolean) => ({
  metaTitle: 'Biobase Edge Functions - Deploy JavaScript globally in seconds',
  metaDescription:
  ...
  integratesWithBiobase: {
    title: 'Integrates seamlessly with the Biobase ecosystem',
    useCases: [
      {
        label: 'Zero configuration',
        paragraph: 'Pre-populated environment variables required to access your biobase project',
      ...
      {
        label: 'Works with Biobase Storage',
        paragraph: (
          <>
            Edge Functions are designed to work seamlessly with{' '}
            <Link
