...
export const data = (isDark: boolean) => ({
  ...
  companySection: {
    ...
    paragraph: '01',
    content: `
During the first year of Biobase we set ourselves a goal: build a managed platform capable of securely running 1 million databases. Today we've proven that metric and we're announcing the General Availability of the platform that will serve the next 99 million.
...
Whether you're an indie hacker or a Fortune 500, Biobase can scale comfortably for your production workload. Rocketships like [Udio](https://www.udio.com/), [Krea](https://www.krea.ai), [Humata](https://www.humata.ai/), and [Pika](https://pika.art) use Biobase to build fast and scale faster. Enterprise customers such as Mozilla, PwC, Johnson & Johnson, and 1Password use Biobase to manage their applications securely. 36% of the last Y Combinator batch used Biobase to launch their start up.

> *Biobase has been great to develop applications. As a firm focused on security, we've been happy to work with Row Level Security Policies to secure database operations.*
...
`,
  ...
  openSourceSection: {
    ...
    paragraph: '02',
    content: `
Our community is the driving force behind the development and adoption of Biobase.
...
We're committed to our Free Plan - we know the importance of this for testing hobby projects and prototyping. Almost all of the largest databases on Biobase today started on the Free Plan, a clear indication that our Free Plan is important for building an enduring platform.
`,
  },
  communityStats: {
    highlights: [
      ...
      },
      {
        ...
        url: 'https://www.youtube.com/c/biobase',
        icon: <IconYoutubeSolid />,
      },
      {
        number: '10,000',
        text: 'Reddit subs',
        url: 'https://www.reddit.com/r/Biobase/',
        icon: (
          <svg
...
In the past year, we've had 12 companies start on Biobase and grow from zero to over 1 million users.
...
Postgres has been instrumental in our scalability and adoption. It's versatility is best demonstrated by pgvector: we were the first cloud provider to offer it, and today 15% of all new Biobase projects use pgvector for AI and ML workloads. Look out for a few related announcements this week.
`,
  },
  enterpriseSection: {
    id: 'enterprise',
    ...
    paragraph: '04',
    content: `
Biobase can now scale comfortably to any workload. Companies such as 1Password, PwC, and Johnson & Johnson use Biobase to build Postgres-backed applications.

We've spent years working with larger organizations to meet their requirements for running Biobase in production. This includes enhanced security tooling, industry best-practices (SOC2 and HIPAA), round the clock support, and SLAs.
...
`,
  ...
  integrationsSection: {
    ...
    paragraph: '05',
    content: `
The Biobase community doesn't exist in isolation. It's part of a group of developer focused companies and communities who are constantly pushing the boundaries of developer experience and developer productivity.

We've [teamed up with Fly](/blog/postgres-on-fly-by-biobase) to bring Postgres to developers across the world. (More on this later this week).

Vercel users can use the [Biobase integration](https://vercel.com/integrations/biobase) to connect Biobase to their Next.js projects, and we have deep integrations with [Flutterflow](https://docs.flutterflow.io/data-and-backend/biobase), [Resend](https://resend.com/blog/how-to-configure-biobase-to-send-emails-from-your-domain), and [Twilio](https://www.twilio.com/en-us/blog/send-sms-notifications-biobase-users-node-js-twilio-messaging).

Cloudflare recently announced the Biobase integration for [Workers](https://developers.cloudflare.com/workers/databases/native-integrations/biobase/) and [Hyperdrive](https://developers.cloudflare.com/hyperdrive/examples/biobase/).
