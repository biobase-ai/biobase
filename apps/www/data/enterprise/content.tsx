...
export default {
  metadata: {
    metaTitle: 'Biobase for Enterprise',
    metaDescription:
      'Leading enterprises use Biobase to build faster, better, and more scalable products.',
  },
  heroSection: {
    id: 'hero',
    title: 'Biobase for Enterprise',
    h1: (
      <>
        Innovative Enterprises
        <span className="block">use Biobase</span>
      </>
    ),
    subheader: [
      <>
        Leading enterprises use Biobase to build faster, better, and more scalable products. From
        GitHub to PwC, innovative companies trust Biobase to drive their digital transformation
        strategy.
      </>,
    ],
    ...
    stories: [
      {
        ...
        target: '_blank',
        heading: 'Mozilla use Biobase for GenAI and RAG',
        subheading: (
          <>
            We store embeddings in a PostgreSQL database, hosted by Biobase, to perform a{' '}
      ...
      },
      {
        ...
        heading: 'Epsilon3 use Biobase to build software for NASA',
        subheading: (
          <>
            <span className="text-foreground">
              Billion dollar missions need to run reliably and securely
            </span>
            . We use Biobase because they give us an open-source scalable back-end built by
      ...
      },
      {
        ...
        heading: 'Pebblely use Biobase to scale to millions of users.',
        subheading: (
          <>
    ...
    highlights: [
      {
        icon: LineChart,
        heading: '100x scale',
        subheading: 'Maergo handled 100x their highest sustained traffic with Biobase.',
        url: '/customers/maergo',
      },
      {
        icon: DollarSign,
        heading: '83% cost reduction',
        subheading: 'Shotgun reduced costs by 83% by migrating to Biobase.',
      ...
      },
      {
        ...
        subheading: 'Markprompt use Biobase to build GDPR-compliant AI chatbots.',
  ...
  performance: {
    ...
    subheading:
      "Biobase ensures optimal database performance at any scale, so you can focus on innovating and growing without worrying about infrastructure limitations—whether you're handling high-traffic applications, complex queries, or massive data volumes.",
    highlights: [
      {
  ...
  support: {
    ...
    features: [
      ...
      },
      {
        ...
        subheading:
          'Our team ensures a smooth transition to Biobase while guiding you with best practices for scaling. We’re dedicated to your long-term success, every step of the way.',
      },
    ],
  },
  quote: {
    id: 'quote',
    quote: {
      text: 'Biobase powers prototyping for fast-moving teams such as GitHub Next.',
      author: 'Idan Gazit',
      logo: (
        <svg
          width="91"
  ...
  'request-a-demo': {
    ...
    subheading:
      'We can take your requirements and show you how Biobase can help you achieve your goals.',
    quote: {
      text: 'Biobase powers prototyping for fast-moving teams such as GitHub Next.',
      author: '',
      logo: '',
