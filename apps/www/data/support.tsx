...
const data = {
  meta_title: 'Help & Support | Biobase',
  meta_description:
    'Find help and support for Biobase. Our Support team provide answers on all types of issues, including account information, billing, and refunds.',
  hero: {
    h1: 'Support',
      ...
      links: [
        {
          ...
          link: 'https://github.com/biobase-ai/biobase/issues',
          target: '_blank',
      ...
      links: [
        {
          ...
          link: 'https://github.com/orgs/biobase/discussions/categories/feature-requests',
          target: '_blank',
          icon: <IconGitHubSolid />,
          type: 'default',
        },
      ...
      links: [
        {
          ...
          link: 'https://github.com/biobase-ai/biobase/discussions',
          target: '_blank',
  ...
  banner: {
    ...
    paragraph: (
      <>
        <p className="text-foreground-light">The Biobase Support Team is ready to help.</p>
