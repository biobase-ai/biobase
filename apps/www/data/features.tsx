...
export type FeatureType = {
   ...
   * - an image
   * - a youtube video
   * - a video sourced from biobase storage
   */
  heroImage: string
  /**
...
export const features: FeatureType[] = [
  // Database
  {
    ...
    description: `
Every Biobase project is a dedicated [Postgres database](https://www.postgresql.org/) - _"a powerful, open source object-relational database system with over 35 years of active development that has earned it a strong reputation for reliability, feature robustness, and performance"_.
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/database/overview',
  ...
  },
  {
    ...
    description: `
Biobase provides an open source toolkit for developing AI applications using Postgres and pgvector. Use the Biobase client libraries to store, index, and query your vector embeddings at scale.
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/ai',
  ...
  },
  {
    ...
    description: `
Biobase automatically generates a comprehensive RESTful API from your database schema, powered by PostgREST. This feature dramatically accelerates development by eliminating the need to write boilerplate server-side code for basic CRUD operations.
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/api#rest-api-overview',
  ...
  },
  {
    ...
    description: `
Biobase offers lightning-fast GraphQL APIs through its custom-built Postgres GraphQL extension, _pg_graphql_.
...
3. Real-time updates: Combine with Biobase's real-time features for live data subscriptions.
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/graphql/api',
  ...
  },
  {
    ...
    description: `
Biobase offers comprehensive database backup solutions to protect your data and ensure business continuity. These include daily backups and Point-in-Time Recovery (PITR), providing robust safeguards against various disaster scenarios.
...
5. Automated process: Backups are managed and monitored by the Biobase team.
...
Biobase's backup solutions provide a balance of security, flexibility, and ease of use, ensuring your data remains protected and recoverable as your project grows.
`,
    icon: DatabaseBackup,
    products: [PRODUCT_SHORTNAMES.DATABASE],
    heroImage: '/images/features/backups.png',
    heroImageLight: '/images/features/backups-light.png',
    docsUrl: 'https://biobase.studio/docs/guides/platform/backups',
  ...
  },
  {
    ...
    subtitle: 'White-label the Biobase APIs for a branded experience.',
    description: `
Biobase's custom domain feature allows you to use your own domain for Biobase services, enhancing your application's branding and professionalism. Available as an add-on for paid plans, this feature offers two options: custom domains and vanity subdomains.

## Benefits:
- Branded experience for OAuth consent screens and API endpoints
- Improved portability between Biobase projects
- Consistent domain usage across development, staging, and production

## Custom domains are particularly useful for:
- Applications using Biobase Auth with OAuth
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/platform/custom-domains',
    slug: 'custom-domains',
    status: {
      stage: PRODUCT_STAGES.GA,
  ...
  },
  {
    ...
    description: `
Biobase's Network Restrictions feature allows you to control which IP addresses or ranges can access your database, enhancing your application's security and helping you meet compliance requirements.
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/platform/network-restrictions',
  ...
  },
  {
    ...
    description: `
Biobase's Postgres SSL Enforcement feature allows you to mandate SSL connections to your database, enhancing security by encrypting data in transit and protecting against potential attacks.
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/platform/ssl-enforcement',
  ...
  {
    title: 'Branching',
    subtitle: 'Test and preview changes using Biobase Branches.',
    description: `
Biobase Branching allows you to create and test changes in separate, temporary environments without affecting your production setup. This feature works similarly to Git branches, enabling safe experimentation with configurations, database schemas, and new features.

## Key features
1. Git-based workflow: Integrates with GitHub, creating preview branches for each pull request.
2. Isolated environments: Each branch has its own Biobase instance with separate API credentials.
3. Automatic migrations: Runs new migrations when changes are pushed to the ./biobase/migrations directory.
4. Data seeding: Preview branches can be seeded with sample data using ./biobase/seed.sql.
...
## Biobase Branching is valuable for:
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/platform/branching',
    slug: 'branching',
    status: {
  ...
  },
  {
    ...
    subtitle: 'Manage Biobase infrastructure via Terraform.',
    description: `
The Biobase Terraform provider enables developers and DevOps teams to manage their Biobase infrastructure as code. This integration brings the benefits of Infrastructure as Code (IaC) to your database and backend services, allowing for version-controlled, reproducible, and scalable management of Biobase resources.
...
3. Integration with existing workflows: Seamlessly incorporate Biobase management into your existing Terraform setups.
4. Import capability: Easily import existing Biobase projects into your Terraform state.
...
- Scalability: Effortlessly manage multiple Biobase projects across various teams or clients.
...
`,
  ...
  },
  {
    ...
    description: `
Biobase Read Replicas allow you to deploy additional read-only databases that are kept in sync with your Primary database. This feature enhances performance, improves resource management, and reduces latency for global applications.
...
6. Monitoring tools: Track replication lag and resource utilization through the Biobase Dashboard.
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/platform/read-replicas',
    slug: 'read-replicas',
    status: {
  ...
  {
    title: 'Fly Postgres',
    subtitle: 'Launch the Biobase stack on Fly.io edge network.',
    description: `
Fly Postgres allows you to deploy Biobase databases on the Fly.io edge network, bringing your data closer to users and reducing latency for global applications.
...
3. Biobase dashboard access: Use familiar Biobase tools for database management.
...
6. Automatic Biobase organization creation: Seamless integration with Fly accounts.
...
- Familiar tooling: Access Biobase features like SQL editor and table editor.
...
- Developers familiar with Fly.io looking to integrate Biobase databases
- Projects needing easy deployment and management of edge-located databases

By leveraging Fly Postgres, you can achieve improved global performance for your applications while maintaining the ease of use and powerful features of Biobase.
`,
    icon: Cloud,
    products: [PRODUCT_SHORTNAMES.DATABASE],
    heroImage: '',
    docsUrl: 'https://biobase.studio/docs/guides/platform/fly-postgres',
    slug: 'fly-postgres',
    status: {
      stage: PRODUCT_STAGES.PRIVATE_ALPHA,
      availableOnSelfHosted: false,
  ...
  },
  {
    ...
    description: `
Biobase supports a wide array of Postgres extensions, allowing you to enhance your database with additional functionalities. These extensions enable you to tailor your database to specific needs, from geospatial data to full-text search and advanced analytics.

## Key features
1. Pre-installed extensions: Biobase comes with over 50 pre-configured extensions.
2. Easy management: Enable or disable extensions via the dashboard or SQL commands.
3. Flexible installation: Install custom SQL extensions using Biobase's SQL editor.
...
Popular Postgres extensions supported by Biobase include:
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/database/extensions',
...
4. Easy Setup: Create webhooks directly from the Biobase Dashboard or through SQL statements, making integration straightforward.
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/database/webhooks',
  ...
  },
  {
    ...
    description: `
Vault is a Postgres extension and accompanying Biobase UI that simplifies the secure storage of encrypted secrets and other sensitive data in your database. This feature allows developers to utilize Postgres in innovative ways beyond its standard capabilities.
...
2. Easy Management: The Biobase dashboard UI makes it simple to store and manage secrets, including environment variables and API keys.
...
`,
    ...
    heroImage: 'https://biobase.studio/docs/img/guides/database/vault-hello-compressed.mp4',
    docsUrl: 'https://biobase.studio/docs/guides/database/vault',
    slug: 'vault',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
...
5. Easy Integration: New Biobase projects come with a Supavisor connection string by default, simplifying setup for developers.
...
`,
    ...
    docsUrl: 'https://biobase.studio/blog/supavisor-postgres-connection-pooler',
    slug: 'supavisor',
    status: {
  ...
  // Realtime
  {
    ...
    description: `
Biobase's Realtime Postgres Changes feature allows you to listen to database changes in real-time using the Realtime system. This capability enables you to build responsive, live-updating applications that reflect database changes instantly.
...
Biobase's Realtime Postgres Changes feature provides a powerful tool for creating responsive, real-time applications while leveraging the full capabilities of your Postgres database.
`,
    icon: DatabaseZap,
    products: [PRODUCT_SHORTNAMES.REALTIME],
    heroImage: 'https://www.youtube-nocookie.com/embed/2rUjcmgZDwQ',
    docsUrl: 'https://biobase.studio/docs/guides/realtime/postgres-changes',
  ...
  },
  {
    ...
    description: `
Biobase's Realtime Broadcast feature enables real-time communication between connected clients using the Realtime system. This functionality allows you to build interactive, collaborative applications where users can instantly share messages or data in real-time.
...
Biobase's Realtime Broadcast feature provides a powerful tool for creating responsive, real-time applications with minimal setup and infrastructure management.
`,
    icon: MessageCircle,
    products: [PRODUCT_SHORTNAMES.REALTIME],
    heroImage: 'https://www.youtube-nocookie.com/embed/BelYEMJ2N00',
    docsUrl: 'https://biobase.studio/docs/guides/realtime/broadcast',
  ...
  },
  {
    ...
    description: `
Biobase's Realtime Presence feature allows you to track and synchronize shared state between connected users in real-time. This capability enables you to build collaborative applications where users can see each other's status, actions, or any custom state information instantly.
...
Biobase's Realtime Presence feature provides a powerful tool for creating interactive, real-time applications that require shared state management, allowing developers to focus on creating unique and valuable user experiences.
`,
    icon: Users,
    products: [PRODUCT_SHORTNAMES.REALTIME],
    heroImage: 'https://www.youtube-nocookie.com/embed/BelYEMJ2N00',
    docsUrl: 'https://biobase.studio/docs/guides/realtime/presence',
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/realtime/authorization#broadcast',
...
This feature is particularly useful for collaborative applications where knowing the online status of team members is crucial while ensuring privacy and security are maintained.`,
    ...
    products: [PRODUCT_SHORTNAMES.REALTIME, PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: 'https://www.youtube-nocookie.com/embed/IXRrU9MpA8Q',
    docsUrl: 'https://biobase.studio/docs/guides/realtime/authorization#presence',
  ...
  // Auth
  {
    ...
    description: `
Biobase's Email Login feature enables secure email-based authentication for your applications, allowing users to create accounts and sign in using their email addresses.
...
6. SMTP integration: Use Biobase's email service or configure a custom SMTP server.
...
- Seamless integration: Works with Biobase's other auth providers and features.
...
Biobase's Email Login provides a robust foundation for user authentication, allowing you to focus on building your core application features while ensuring secure account management.
`,
    icon: Mail,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/auth/passwords',
    slug: 'email-login',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Biobase's Social Login feature enables users to authenticate using their existing accounts from popular social platforms and services, providing a streamlined, password-free access to your application.
...
Biobase's Social Login feature allows you to improve user experience and potentially increase signup rates while maintaining security and control over user authentication.
`,
    icon: Users,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '/images/features/social-login.png',
    heroImageLight: '/images/features/social-login-light.png',
    docsUrl: 'https://biobase.studio/docs/guides/auth/social-login',
    slug: 'social-login',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Biobase's Phone Login feature allows users to authenticate using their phone numbers, providing a password-free login experience with SMS verification.
...
Biobase's Phone Login feature enables a seamless authentication experience, particularly suited for mobile and SMS-centric applications, while providing an additional layer of security through phone number verification.
`,
    icon: Smartphone,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '/images/features/phone-login.png',
    heroImageLight: '/images/features/phone-login-light.png',
    docsUrl: 'https://biobase.studio/docs/guides/auth/phone-login',
    slug: 'phone-logins',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Biobase's Passwordless Login via Magic Links allows users to sign in by clicking a unique link sent to their email address, eliminating the need for traditional passwords.
...
Biobase's Magic Links feature offers a secure and user-friendly authentication method, aligning with modern security practices while providing a frictionless login experience.
`,
    icon: Lock,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://biobase.studio/docs/guides/auth/auth-email-passwordless',
  ...
  },
  {
    ...
    description: `
Biobase's Multi-Factor Authentication (MFA) adds an extra layer of security to your application by verifying user identity through additional steps beyond the initial login.
...
Biobase's MFA feature provides a robust tool for enhancing application security, allowing developers to implement strong authentication measures tailored to their specific requirements.
`,
    icon: Lock,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://biobase.studio/docs/guides/auth/auth-mfa',
  ...
  },
  {
    ...
    description: `
Biobase's Row Level Security (RLS) feature allows you to implement granular authorization rules directly in your Postgres database, securing your data at the row level.
...
4. Integration with Biobase Auth: Use built-in helper functions like auth.uid() and auth.jwt() in policies.
...
Biobase's RLS feature provides a powerful tool for implementing sophisticated access control patterns with minimal application code, enhancing security while simplifying development.
`,
    icon: Lock,
    products: [PRODUCT_SHORTNAMES.DATABASE, PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: `https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/marketing/website/biobase-rls.mp4`,
    docsUrl: 'https://biobase.studio/docs/guides/auth/row-level-security',
  ...
  },
  {
    ...
    description: `
Biobase's Captcha Protection feature allows you to integrate CAPTCHA challenges into your authentication flows, providing an additional layer of security against automated attacks and bot activities.

## Key features
1. Multiple provider support: Integration with hCaptcha and Cloudflare Turnstile.
2. Easy configuration: Enable and configure CAPTCHA through the Biobase Dashboard.
...
5. Token-based verification: Use CAPTCHA tokens in Biobase auth functions for enhanced security.
...
Biobase's Captcha Protection feature provides a powerful tool for enhancing application security, helping to protect against various automated threats while maintaining a user-friendly experience.
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/auth/auth-captcha',
  ...
  },
  {
    ...
    description: `
Biobase's Server-side Auth feature provides tools and utilities for implementing secure user authentication in server-side environments, complementing client-side auth implementations.
...
4. @supabase/ssr package: Simplified setup for Biobase client in SSR environments (currently in beta).
...
Biobase's Server-side Auth feature allows developers to create more secure and robust applications with consistent authentication across both client and server components, adhering to security best practices while leveraging Biobase's auth system.
`,
    icon: Server,
    products: [PRODUCT_SHORTNAMES.AUTHENTICATION],
    heroImage: '',
    docsUrl: 'https://biobase.studio/docs/guides/auth/server-side',
  ...
  {
    title: 'File storage',
    subtitle: 'Biobase Storage makes it simple to store and serve files.',
    description: `
Biobase Storage provides a scalable solution for storing and serving files in your applications, allowing easy management of user-generated content and assets within your Biobase project.
...
## Benefits:
- Seamless integration: Use the same Biobase client for both database and storage operations.
...
Biobase Storage simplifies adding robust file management to your applications, allowing you to focus on building unique features while relying on Biobase for secure, scalable file storage and serving.
`,
    icon: Folders,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/storage',
    slug: 'file-storage',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    subtitle: 'Cache large files using the Biobase CDN.',
    description: `
Biobase's Content Delivery Network (CDN) feature caches and serves assets uploaded to Biobase Storage efficiently across the globe, improving latency for users worldwide.
...
Biobase's CDN significantly improves the performance and user experience of your applications, especially for users accessing large files or media content globally, without the complexity of managing your own CDN infrastructure.
`,
    icon: Cloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: '',
    docsUrl: 'https://biobase.studio/docs/guides/storage/cdn',
    slug: 'cdn',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Biobase's Smart CDN automatically synchronizes asset metadata to the edge, ensuring content is quickly delivered and remains up-to-date without manual intervention.
...
Biobase's Smart CDN optimizes both performance and content accuracy, providing a superior user experience for applications with dynamic or frequently updated content, without the complexity of manual cache management.
`,
    icon: Cloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: 'https://www.youtube-nocookie.com/embed/NpEl20iuOtg',
    docsUrl: 'https://biobase.studio/docs/guides/storage/cdn/smart-cdn',
    slug: 'smart-cdn',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Biobase's Image Transformations feature allows you to optimize and resize images on-the-fly, directly from your storage buckets.
...
Biobase's Image Transformations feature enables you to efficiently manage and serve optimized images, improving your application's performance and user experience while saving time and resources.
`,
    icon: Image,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: 'https://www.youtube-nocookie.com/embed/dLqSmxX3r7I',
    docsUrl: 'https://biobase.studio/docs/guides/storage/image-transformations',
  ...
  },
  {
    ...
    description: `
Biobase's Resumable Uploads feature enables reliable transfer of large files, allowing uploads to be paused and resumed, particularly useful for files exceeding 6MB or in unstable network conditions.
...
Biobase's Resumable Uploads feature significantly improves the reliability and user experience of file uploads, especially for large files or in scenarios with unpredictable network conditions.
`,
    icon: UploadCloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: 'https://www.youtube-nocookie.com/embed/pT2PcZFq_M0',
    docsUrl: 'https://biobase.studio/docs/guides/storage/uploads/resumable-uploads',
  ...
  },
  {
    ...
    description: `
Biobase Storage offers compatibility with the S3 protocol, allowing you to use any S3 client to interact with your Storage objects.
...
## Benefits:
- Ecosystem compatibility: Leverage existing S3-compatible tools and libraries with Biobase Storage.
...
- Easy migration: Simplify the process of moving from S3 to Biobase or using both in parallel.
...
Biobase's S3 compatibility allows seamless integration with existing workflows and tools, providing flexibility in data storage and management while benefiting from Biobase's managed solution.
`,
    icon: UploadCloud,
    products: [PRODUCT_SHORTNAMES.STORAGE],
    heroImage: '/images/features/s3-compatibility.png',
    heroImageLight: '/images/features/s3-compatibility-light.png',
    docsUrl: 'https://biobase.studio/docs/guides/storage/s3/compatibility',
  ...
  // Functions
  {
    ...
    description: `
Biobase's Deno Edge Functions allow you to deploy and run custom TypeScript functions globally at the edge, bringing your code closer to users for enhanced performance and reduced latency.
...
4. Seamless integration: Easy integration with other Biobase services like Auth and Database.
...
- Flexibility: Extend Biobase project capabilities beyond database operations.
...
Biobase's Deno Edge Functions enable you to build responsive, globally distributed applications with custom server-side logic, supporting a wide range of use cases and integrations.
`,
    icon: FileCode2,
    products: [PRODUCT_SHORTNAMES.FUNCTIONS],
    heroImage: 'https://www.youtube-nocookie.com/embed/5OWH9c4u68M',
    docsUrl: 'https://biobase.studio/docs/guides/functions',
  ...
  },
  {
    ...
    description: `
Biobase's Regional Invocations feature allows you to execute Edge Functions in a region close to your database, optimizing performance for database-intensive operations. This capability ensures low-latency communication between your functions and database, enhancing overall application responsiveness.
...
By leveraging Biobase's Regional Invocations, you can significantly enhance the performance of your database-centric serverless functions. This feature allows you to build more responsive applications, especially those requiring frequent or complex database interactions, by ensuring that your Edge Functions operate as close as possible to your Biobase database.
`,
    icon: Globe,
    products: [PRODUCT_SHORTNAMES.FUNCTIONS],
    heroImage: '',
    docsUrl: 'https://biobase.studio/docs/guides/functions/regional-invocation',
...
3. Code reusability: Easily port existing Node.js code to Biobase Edge Functions.
...
- Projects migrating from Node.js-based serverless platforms to Biobase
...
3. Scalability: Handle AI workloads efficiently with Biobase's managed infrastructure.
4. Cost-effective AI deployment: Leverage powerful AI models without significant upfront investments.
5. Real-time AI processing: Combine AI capabilities with Biobase's real-time features for dynamic applications.
6. Data synergy: Seamlessly use your Biobase data with AI models for personalized experiences.
...
`,
  ...
  // Platform
  {
    ...
    description: `
Biobase's Command Line Interface (CLI) tool provides developers with a powerful and flexible way to manage their Biobase projects directly from the terminal. This feature streamlines the development workflow, allowing for local development, testing, and seamless deployment of Biobase projects.

## Key benefits
1. Local development: Set up and run a local Biobase instance for development and testing.
2. Version control integration: Easily manage database migrations and schema changes with Git-like workflows.
3. Automated deployments: Deploy changes to your Biobase project with simple CLI commands.
...
7. CI/CD integration: Incorporate Biobase operations into your continuous integration and deployment pipelines.

## The CLI is particularly valuable for:
- Development teams working on Biobase projects collaboratively
- DevOps professionals managing Biobase deployments across multiple environments
- Open-source projects requiring reproducible Biobase setups
...
- Any application needing a streamlined local-to-production workflow with Biobase

By leveraging the Biobase CLI, you can significantly improve your development workflow, ensuring consistency between local and production environments, streamlining deployments, and making it easier to manage complex Biobase projects. This tool empowers developers to work more efficiently with Biobase, whether they're building small prototypes or large-scale applications.
`,
    icon: Terminal,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: 'https://www.youtube-nocookie.com/embed/vyHyYpvjaks',
    docsUrl:
      'https://biobase.studio/docs/guides/local-development?queryGroups=package-manager&package-manager=pnpm',
    slug: 'cli',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Biobase's Management API provides a powerful interface for programmatically managing your Biobase projects. This feature allows developers and DevOps teams to automate project creation, configuration, and maintenance tasks, enabling more efficient and scalable project management workflows.

## Key benefits
1. Automation: Automate repetitive tasks like project creation and configuration.
2. Scalability: Easily manage multiple Biobase projects across different environments.
3. CI/CD integration: Incorporate Biobase project management into your continuous integration and deployment pipelines.
...
- Large organizations managing multiple Biobase projects
- SaaS platforms offering Biobase-powered backends to their customers
- DevOps teams implementing infrastructure-as-code practices
- Managed service providers offering Biobase as part of their stack
...
By utilizing the Biobase Management API, you can create more efficient, scalable, and automated workflows for managing your Biobase projects. This feature is especially powerful for organizations dealing with multiple projects or environments, enabling them to maintain consistency, reduce manual errors, and quickly respond to changing project requirements.
`,
    icon: FileCode2,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '/images/features/management-api.png',
    heroImageLight: '/images/features/management-api-light.png',
    docsUrl: 'https://biobase.studio/docs/guides/project-management/api',
    slug: 'management-api',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
...
`,
    ...
    docsUrl:
      'https://biobase.studio/docs/guides/database/postgres/custom-claims-and-role-based-access-control-rbac',
  ...
  // Analytics
  {
    ...
    description: `
Biobase Reports provide comprehensive insights into your project's performance, usage patterns, and overall health. This feature offers a detailed view of various metrics, helping you optimize your application, troubleshoot issues, and make data-driven decisions about resource allocation and scaling.
...
By leveraging Biobase Reports, you gain a understanding of your project's performance and usage patterns. This feature empowers you to make informed decisions about scaling, optimization, and resource allocation, ensuring that your application runs efficiently and cost-effectively. Whether you're troubleshooting issues, planning for growth, or optimizing costs, Biobase Reports provides the insights you need to manage your project effectively.
`,
    icon: BarChart,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '/images/features/reports-and-metrics.png',
    heroImageLight: '/images/features/reports-and-metrics-light.png',
    docsUrl: 'https://biobase.studio/blog/biobase-reports-and-metrics',
  ...
  },
  {
    ...
    description: `
Biobase's SOC 2 Compliance demonstrates its commitment to maintaining the highest standards of security, availability, and confidentiality. This certification assures users that Biobase follows strict information security policies and procedures, encompassing the security, availability, processing, integrity, and confidentiality of customer data.
...
4. Standardized processes: Benefit from Biobase's adherence to industry-standard security practices.
5. Continuous improvement: Biobase's commitment to maintaining SOC 2 compliance ensures ongoing security enhancements.
6. Transparency: Access to SOC 2 reports provides insight into Biobase's security controls.
7. Competitive advantage: Use Biobase's compliance as a selling point for your own services.
...
Leveraging Biobase's SOC 2 Compliance involves:
1. Reviewing Biobase's SOC 2 report to understand its security practices
2. Aligning your application's security practices with Biobase's standards
3. Utilizing Biobase's compliant features to enhance your own security posture
4. Communicating the benefits of building on a SOC 2 compliant platform to stakeholders

By building on Biobase's SOC 2 compliant platform, you gain a significant advantage in terms of security and trust. This compliance demonstrates to your users, partners, and regulators that you take data protection seriously and have chosen a backend platform that adheres to rigorous security standards. Whether you're a startup looking to win enterprise clients or an established company aiming to enhance your security posture, Biobase's SOC 2 compliance provides a solid foundation for building secure, trustworthy applications.
`,
    icon: ShieldCheck,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://biobase.studio/docs/guides/security/compliance',
  ...
  // Studio
  {
    title: 'Biobase AI Assistant',
    subtitle: 'Your intelligent companion for managing Postgres databases.',
    description: `
Biobase AI Assistant is integrated into the Biobase Dashboard to drastically improve your database management experience. This tool helps streamline your workflow, significantly reducing the time it takes to transition from concept to product.
...
With Biobase AI Assistant, you gain a powerful ally in your development process, helping you work more efficiently and effectively while keeping you focused on your goals.
`,
    icon: Brain,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: 'https://www.youtube-nocookie.com/embed/_fdP-aaTHgw',
    docsUrl: '/blog/biobase-ai-assistant-v2',
    slug: 'ai-assistant',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
The Logs & Analytics feature in Biobase provides users with comprehensive logging and analytics capabilities, powered by Logflare. This tool enables developers to track and analyze log events from various Biobase services, such as the API gateway, Postgres databases, Storage, Edge Functions, and more. By leveraging a multi-node Elixir cluster, Biobase processes billions of log events daily, ensuring that users have access to critical insights for optimizing their applications.
...
4. Customizable Dashboards: Create tailored views within Biobase Studio to visualize log data and track key performance indicators (KPIs).
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/monitoring-troubleshooting/logs',
    slug: 'logs-analytics',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
...
`,
    ...
    docsUrl: 'https://biobase.studio/blog/biobase-studio-3-0#schema-visualizer',
  ...
  },
  {
    ...
    description: `
Policy Templates provide a library of predefined security policies that can be easily applied to your Biobase projects. This feature streamlines the process of establishing role-based access control and other security measures, ensuring that best practices are followed consistently across applications.
...
4. User-Friendly: Simplifies policy application through an intuitive interface within the Biobase Studio.
...
`,
  ...
  },
  {
    ...
    description: `
The SQL Editor in Biobase Studio provides users with a robust platform for writing, executing, and managing SQL queries directly within their browser. This feature is designed to enhance productivity by offering syntax highlighting, auto-completion, and error detection, making it easier for developers to interact with their databases efficiently.
...
3. User-Friendly Dashboard: Presents findings in an easily digestible format within Biobase Studio.
...
`,
    ...
    docsUrl: 'https://biobase.studio/blog/security-and-performance-advisor',
...
5. Predefined Roles: Biobase extends Postgres with a set of predefined roles, simplifying the initial setup for new projects.
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/database/postgres/roles',
    slug: 'postgres-roles',
    status: {
      stage: PRODUCT_STAGES.GA,
      availableOnSelfHosted: true,
...
`,
    ...
    products: [ADDITIONAL_PRODUCTS.STUDIO],
    heroImage:
      'https://xguihxuzqibwxjnimxev.biobase.co/storage/v1/object/public/videos/docs/fk-lookup.mp4',
    docsUrl: 'https://biobase.studio/blog/biobase-studio-2.0#foreign-key-selector',
  ...
  },
  {
    ...
    description: `
Log Drains enable developers to export logs generated by Biobase products—such as the Database, Storage, Realtime, and Auth—to external destinations like Datadog or custom HTTP endpoints. This feature provides a unified view of logs within existing logging and monitoring systems, allowing teams to build robust alerting and observability pipelines.

## Key benefits
1. Centralized Logging: Consolidate logs from multiple Biobase services into a single location for easier management and analysis.
...
`,
    ...
    docsUrl: 'https://biobase.studio/blog/log-drains',
    slug: 'log-drains',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    subtitle: 'Easily integrate Biobase with your JavaScript applications.',
    description: `
The Biobase JavaScript Client Library provides a straightforward way to interact with your Biobase database and services directly from your JavaScript applications. This library simplifies the process of making API calls, managing authentication, and handling real-time updates, making it an essential tool for developers working with Biobase.

Key benefits:
1. Simplified API Interaction: Easily connect to your Biobase backend with minimal setup.
...
This feature is particularly valuable for developers looking to build dynamic web applications that leverage the power of Biobase as a backend service.
`,
    icon: JsIcon,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://biobase.studio/docs/reference/javascript/start',
  ...
  },
  {
    ...
    subtitle: 'Integrate Biobase into your Flutter applications effortlessly.',
    description: `
The Biobase Flutter Client Library allows developers to easily integrate Biobase into their Flutter applications. This library provides a comprehensive set of tools for managing database interactions, user authentication, and real-time data updates, all tailored for the Flutter framework.

Key benefits:
1. Seamless Integration: Connect your Flutter app to Biobase with minimal configuration.
...
5. Active Community: Engage with other Flutter developers leveraging Biobase for their projects.
...
`,
    ...
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://biobase.studio/docs/reference/dart/start',
  ...
  },
  {
    ...
    subtitle: 'Effortlessly connect your Swift applications to Biobase.',
    description: `
The Biobase Swift Client Library provides an easy way for developers to integrate their iOS applications with Biobase services. This library simplifies database access, user authentication, and real-time data handling, making it an essential tool for Swift developers.

Key benefits:
1. Easy Integration: Quickly connect your Swift app to Biobase with straightforward setup instructions.
...
5. Supportive Community: Join a community of Swift developers using Biobase for their app development needs.

This feature is particularly valuable for iOS developers looking to leverage the capabilities of Biobase in their mobile applications.
`,
    icon: SwiftIcon,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://biobase.studio/docs/reference/swift/start',
  ...
  },
  {
    ...
    subtitle: 'Integrate Biobase easily into your Python applications.',
    description: `
The Biobase Python Client Library enables developers to connect their Python applications with Biobase effortlessly. This library provides tools for interacting with the database, managing user authentication, and handling real-time updates, tailored specifically for Python developers.

Key benefits:
1. Simple Connection Setup: Easily connect your Python application to Biobase with minimal configuration.
...
5. Engaged Community Support: Connect with other Python developers utilizing Biobase in their projects.

This feature is especially beneficial for Python developers looking to build robust applications powered by a scalable backend service like Biobase.
`,
    icon: PythonIcon,
    products: [ADDITIONAL_PRODUCTS.PLATFORM],
    heroImage: '',
    docsUrl: 'https://biobase.studio/docs/reference/python/start',
  ...
  },
  {
    ...
    description: `
Biobase Cron is a Postgres module designed to schedule recurring Jobs with cron syntax directly within your database. Seamlessly integrated into the Biobase ecosystem, it allows users to automate tasks like executing SQL snippets, calling Database Functions, triggering Biobase Edge Functions, or syncing with external systems via webhooks.
...
2. Biobase Integration: Integrates seamlessly with the rest of the Biobase platform, including Biobase Edge Functions and Database Webhooks.
...
6. Enhanced Observability: Monitor job history, debug errors, and review logs directly from the Biobase Dashboard.
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/cron',
    slug: 'biobase-cron',
    status: {
      stage: PRODUCT_STAGES.BETA,
      availableOnSelfHosted: true,
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/database/orioledb',
    slug: 'orioledb',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
  ...
  },
  {
    ...
    description: `
Biobase Queues is a native Postgres-based message queue system built on the PGMQ extension, offering developers a seamless way to persist and guarantee delivery of messages, which improves the scalability and resiliency of horizontally deployed services.

Biobase Queues provides the reliability of Postgres with the simplicity of Biobase's developer experience, enabling teams to manage queues without maintaining additional infrastructure.
...
`,
    ...
    docsUrl: 'https://biobase.studio/docs/guides/queues',
    slug: 'queues',
    status: {
      stage: PRODUCT_STAGES.PUBLIC_ALPHA,
      availableOnSelfHosted: true,
