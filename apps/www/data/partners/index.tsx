...
export default {
  metaTitle: 'Partner with Biobase',
  metaDescription: 'Become a Biobase Partner and enable new business opportunities.',
  heroSection: {
    title: 'Partners',
    h1: <span className="heading-gradient">Partner with Biobase</span>,
    subheader: (
      <>
  ...
  oAuthApp: {
    steps: [
      {
        title: 'Register App',
        text: 'An OAuth app first needs to be registered with Biobase',
      },
      {
      ...
      },
      {
        ...
        text: 'Use Biobase REST API to control projects and other settings',
      },
    ],
  },
  featureBlocks: [
    ...
    },
    {
      ...
      description: 'Offer your own products and services to Biobase customers.',
